...
public class Main {
    ...
    public static DataGenerator createStandardGenerator(Path path, Collection<Path> collection, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5, WorldVersion worldVersion, boolean bl6) {
        ...
        TagsProvider tagsProvider2 = packGenerator3.addProvider(Main.bindRegistries(UpdateOneTwentyBlockTagsProvider::new, completableFuture2));
        packGenerator3.addProvider(packOutput -> new UpdateOneTwentyItemTagsProvider(packOutput, completableFuture2, tagsProvider2));
        packGenerator3.addProvider(Main.bindRegistries(UpdateOneTwentyBiomeTagsProvider::new, completableFuture2));
        packGenerator3.addProvider(UpdateOneTwentyLootTableProvider::create);
        packGenerator3.addProvider(Main.bindRegistries(UpdateOneTwentyVanillaAdvancementProvider::create, completableFuture2));
