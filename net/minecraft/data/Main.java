...
public class Main {
    ...
    public static DataGenerator createStandardGenerator(Path path, Collection<Path> collection, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5, WorldVersion worldVersion, boolean bl6) {
        ...
        TagsProvider tagsProvider2 = packGenerator3.addProvider(packOutput -> new VanillaItemTagsProvider(packOutput, completableFuture, tagsProvider.contentsGetter()));
        packGenerator3.addProvider(Main.bindRegistries(BannerPatternTagsProvider::new, completableFuture));
        packGenerator3.addProvider(Main.bindRegistries(BiomeTagsProvider::new, completableFuture));
        ...
        packGenerator3.addProvider(Main.bindRegistries(StructureTagsProvider::new, completableFuture));
        ...
        packGenerator3.addProvider(Main.bindRegistries(BiomeParametersDumpReport::new, completableFuture));
        packGenerator3.addProvider(BlockListReport::new);
        packGenerator3.addProvider(Main.bindRegistries(CommandsReport::new, completableFuture));
        ...
        packGenerator3.addProvider(packOutput -> PackMetadataGenerator.forFeaturePack(packOutput, Component.translatable("dataPack.bundle.description"), FeatureFlagSet.of(FeatureFlags.BUNDLE)));
        CompletableFuture<HolderLookup.Provider> completableFuture2 = UpdateOneTwentyRegistries.createLookup(completableFuture);
        DataGenerator.PackGenerator packGenerator4 = dataGenerator.getBuiltinDatapack(bl2, "update_1_20");
        packGenerator4.addProvider(UpdateOneTwentyRecipeProvider::new);
        TagsProvider tagsProvider3 = packGenerator4.addProvider(packOutput -> new UpdateOneTwentyBlockTagsProvider(packOutput, completableFuture2, tagsProvider.contentsGetter()));
        packGenerator4.addProvider(packOutput -> new UpdateOneTwentyItemTagsProvider(packOutput, completableFuture2, tagsProvider2.contentsGetter(), tagsProvider3.contentsGetter()));
        packGenerator4.addProvider(Main.bindRegistries(UpdateOneTwentyBiomeTagsProvider::new, completableFuture2));
        packGenerator4.addProvider(UpdateOneTwentyLootTableProvider::create);
        packGenerator4.addProvider(Main.bindRegistries(UpdateOneTwentyVanillaAdvancementProvider::create, completableFuture2));
        packGenerator4.addProvider(Main.bindRegistries(RegistriesDatapackGenerator::new, completableFuture2));
        packGenerator4.addProvider(packOutput -> PackMetadataGenerator.forFeaturePack(packOutput, Component.translatable("dataPack.update_1_20.description"), FeatureFlagSet.of(FeatureFlags.UPDATE_1_20)));
