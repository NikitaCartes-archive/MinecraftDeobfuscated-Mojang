...
implements DataProvider {
    ...
    public void run(CachedOutput cachedOutput) throws IOException {
        ...
        CommandDispatcher<CommandSourceStack> commandDispatcher = new Commands(Commands.CommandSelection.ALL, new CommandBuildContext(BuiltinRegistries.createAccess(), FeatureFlags.REGISTRY.allFlags())).getDispatcher();
