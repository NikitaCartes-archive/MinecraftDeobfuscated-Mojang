...
implements DataProvider {
    ...
    public void run(HashCache hashCache) throws IOException {
        ...
        Registry.REGISTRY.keySet().forEach(resourceLocation -> jsonObject.add(resourceLocation.toString(), RegistryDumpReport.dumpRegistry((WritableRegistry)Registry.REGISTRY.get((ResourceLocation)resourceLocation))));
    ...
    private static <T> JsonElement dumpRegistry(WritableRegistry<T> writableRegistry) {
        ...
        for (ResourceLocation resourceLocation2 : writableRegistry.keySet()) {
            Object object = writableRegistry.get(resourceLocation2);
