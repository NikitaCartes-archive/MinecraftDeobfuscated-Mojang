...
public class BlockFamilies {
    ...
    public static final BlockFamily POLISHED_BLACKSTONE_BRICKS = BlockFamilies.familyBuilder(Blocks.POLISHED_BLACKSTONE_BRICKS).wall(Blocks.POLISHED_BLACKSTONE_BRICK_WALL).stairs(Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS).slab(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB).getFamily();
    ...
    public static final BlockFamily WAXED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_EXPOSED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    public static final BlockFamily OXIDIZED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).getFamily();
    ...
    public static final BlockFamily NETHER_BRICKS = BlockFamilies.familyBuilder(Blocks.NETHER_BRICKS).fence(Blocks.NETHER_BRICK_FENCE).wall(Blocks.NETHER_BRICK_WALL).stairs(Blocks.NETHER_BRICK_STAIRS).slab(Blocks.NETHER_BRICK_SLAB).chiseled(Blocks.CHISELED_NETHER_BRICKS).getFamily();
    ...
    public static final BlockFamily SANDSTONE = BlockFamilies.familyBuilder(Blocks.SANDSTONE).wall(Blocks.SANDSTONE_WALL).stairs(Blocks.SANDSTONE_STAIRS).slab(Blocks.SANDSTONE_SLAB).chiseled(Blocks.CHISELED_SANDSTONE).dontGenerateRecipe().getFamily();
    ...
    public static final BlockFamily RED_SANDSTONE = BlockFamilies.familyBuilder(Blocks.RED_SANDSTONE).wall(Blocks.RED_SANDSTONE_WALL).stairs(Blocks.RED_SANDSTONE_STAIRS).slab(Blocks.RED_SANDSTONE_SLAB).chiseled(Blocks.CHISELED_RED_SANDSTONE).dontGenerateRecipe().getFamily();
    ...
    public static final BlockFamily COBBLED_DEEPSLATE = BlockFamilies.familyBuilder(Blocks.COBBLED_DEEPSLATE).slab(Blocks.COBBLED_DEEPSLATE_SLAB).stairs(Blocks.COBBLED_DEEPSLATE_STAIRS).chiseled(Blocks.CHISELED_DEEPSLATE).polished(Blocks.POLISHED_DEEPSLATE).wall(Blocks.COBBLED_DEEPSLATE_WALL).getFamily();
    ...
    public static final BlockFamily DEEPSLATE_TILES = BlockFamilies.familyBuilder(Blocks.DEEPSLATE_TILES).slab(Blocks.DEEPSLATE_TILE_SLAB).stairs(Blocks.DEEPSLATE_TILE_STAIRS).wall(Blocks.DEEPSLATE_TILE_WALL).getFamily();
    public static final BlockFamily DEEPSLATE_BRICKS = BlockFamilies.familyBuilder(Blocks.DEEPSLATE_BRICKS).slab(Blocks.DEEPSLATE_BRICK_SLAB).stairs(Blocks.DEEPSLATE_BRICK_STAIRS).wall(Blocks.DEEPSLATE_BRICK_WALL).getFamily();
