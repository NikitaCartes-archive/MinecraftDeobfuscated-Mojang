...
public class BlockFamilies {
    ...
    public static final BlockFamily LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.LIGHTLY_WEATHERED_CUT_COPPER).slab(Blocks.LIGHTLY_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.LIGHTLY_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    public static final BlockFamily WAXED_LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    public static final BlockFamily SEMI_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.SEMI_WEATHERED_CUT_COPPER).slab(Blocks.SEMI_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.SEMI_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    public static final BlockFamily WAXED_SEMI_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
    public static final BlockFamily WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).getFamily();
