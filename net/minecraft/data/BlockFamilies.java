...
public class BlockFamilies {
    ...
    public static final BlockFamily WAXED_OXIDIZED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
