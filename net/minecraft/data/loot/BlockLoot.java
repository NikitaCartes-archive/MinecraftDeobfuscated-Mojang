...
implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    private static <T extends Comparable<T>> LootTable.Builder createSinglePropConditionTable(Block block, Property<T> property, T comparable) {
        return LootTable.lootTable().withPool(BlockLoot.applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(block).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(property, comparable)))));
    }
    ...
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
        ...
        this.add(Blocks.ACACIA_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.BIRCH_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.DARK_OAK_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.IRON_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.JUNGLE_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.OAK_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.SPRUCE_DOOR, (Block block) -> BlockLoot.createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        ...
        this.add(Blocks.TNT, (Block block) -> BlockLoot.createSinglePropConditionTable(block, TntBlock.UNSTABLE, false));
        ...
        this.add(Blocks.SEA_PICKLE, (Block block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder)BlockLoot.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(block).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantIntValue.exactly(2)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, 2)))).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantIntValue.exactly(3)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, 3)))).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantIntValue.exactly(4)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, 4)))))));
        this.add(Blocks.COMPOSTER, (Block block) -> LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)BlockLoot.applyExplosionDecay(block, LootItem.lootTableItem(Items.COMPOSTER)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BONE_MEAL)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(ComposterBlock.LEVEL, 8))));
        ...
        LootItemBlockStatePropertyCondition.Builder builder = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.BEETROOTS).withProperty(BeetrootBlock.AGE, 3);
        this.add(Blocks.BEETROOTS, (Block block) -> BlockLoot.createCropDrops(block, Items.BEETROOT, Items.BEETROOT_SEEDS, builder));
        LootItemBlockStatePropertyCondition.Builder builder2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.WHEAT).withProperty(CropBlock.AGE, 7);
        this.add(Blocks.WHEAT, (Block block) -> BlockLoot.createCropDrops(block, Items.WHEAT, Items.WHEAT_SEEDS, builder2));
        LootItemBlockStatePropertyCondition.Builder builder3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.CARROTS).withProperty(CarrotBlock.AGE, 7);
        this.add(Blocks.CARROTS, (Block block) -> BlockLoot.applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CARROT))).withPool(LootPool.lootPool().when(builder3).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286f, 3))))));
        LootItemBlockStatePropertyCondition.Builder builder4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.POTATOES).withProperty(PotatoBlock.AGE, 7);
        this.add(Blocks.POTATOES, (Block block) -> BlockLoot.applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(LootPool.lootPool().when(builder4).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286f, 3)))).withPool(LootPool.lootPool().when(builder4).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02f))))));
        this.add(Blocks.SWEET_BERRY_BUSH, (Block block) -> BlockLoot.applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).withProperty(SweetBerryBushBlock.AGE, 3)).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0f, 3.0f))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).withProperty(SweetBerryBushBlock.AGE, 2)).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0f, 2.0f))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)))));
        ...
        this.add(Blocks.NETHER_WART, (Block block) -> LootTable.lootTable().withPool(BlockLoot.applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder<?>)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.NETHER_WART).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(RandomValueBounds.between(2.0f, 4.0f)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(NetherWartBlock.AGE, 3)))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(NetherWartBlock.AGE, 3)))))));
        this.add(Blocks.SNOW, (Block block) -> LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS)).add(AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 1)), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 2))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 3))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 4))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(4))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 5))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(5))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 6))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(6))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 7))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(7))), LootItem.lootTableItem(Items.SNOWBALL).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(8)))}).when(HAS_NO_SILK_TOUCH), AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{LootItem.lootTableItem(block).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 1)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 2)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 3)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(4)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 4)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(5)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 5)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(6)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 6)), ((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(7)))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, 7)), LootItem.lootTableItem(Blocks.SNOW_BLOCK)})}))));
        ...
        this.add(Blocks.ATTACHED_PUMPKIN_STEM, BlockLoot.noDrop());
        this.add(Blocks.ATTACHED_MELON_STEM, BlockLoot.noDrop());
