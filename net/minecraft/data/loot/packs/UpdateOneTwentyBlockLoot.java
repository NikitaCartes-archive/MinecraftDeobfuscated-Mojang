...
extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.DECORATED_POT, UpdateOneTwentyBlockLoot.noDrop());
        this.dropSelf(Blocks.PIGLIN_HEAD);
        this.dropSelf(Blocks.TORCHFLOWER);
        this.dropPottedContents(Blocks.POTTED_TORCHFLOWER);
        LootItemBlockStatePropertyCondition.Builder builder = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TORCHFLOWER_CROP).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(TorchflowerCropBlock.AGE, 2));
        this.add(Blocks.TORCHFLOWER_CROP, this.applyExplosionDecay(Blocks.TORCHFLOWER_CROP, LootTable.lootTable().withPool(LootPool.lootPool().add(((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.TORCHFLOWER).when(builder)).otherwise(LootItem.lootTableItem(Items.TORCHFLOWER_SEEDS))))));
        ...
        this.add(Blocks.CHERRY_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        this.add(Blocks.CHERRY_DOOR, (Block block) -> this.createDoorTable((Block)block));
        ...
        this.add(Blocks.SUSPICIOUS_SAND, UpdateOneTwentyBlockLoot.noDrop());
    }
}
