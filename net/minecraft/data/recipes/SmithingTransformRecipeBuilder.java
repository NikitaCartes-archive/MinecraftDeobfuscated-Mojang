...
public class SmithingTransformRecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation resourceLocation) {
        ...
        consumer.accept(new Result(resourceLocation, this.type, this.template, this.base, this.addition, this.result, this.advancement, resourceLocation.withPrefix("recipes/" + this.category.getFolderName() + "/")));
    }
