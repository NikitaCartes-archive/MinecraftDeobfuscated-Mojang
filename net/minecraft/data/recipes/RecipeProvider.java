...
implements DataProvider {
    ...
    private static void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_SLAB, Blocks.GRIMSTONE, 2);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_STAIRS, Blocks.GRIMSTONE);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_WALL, Blocks.GRIMSTONE);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.CHISELED_GRIMSTONE, Blocks.GRIMSTONE);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_SLAB, Blocks.POLISHED_GRIMSTONE, 2);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_STAIRS, Blocks.POLISHED_GRIMSTONE);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_WALL, Blocks.POLISHED_GRIMSTONE);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_SLAB, Blocks.GRIMSTONE_TILES, 2);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_STAIRS, Blocks.GRIMSTONE_TILES);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_WALL, Blocks.GRIMSTONE_TILES);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_SLAB, Blocks.GRIMSTONE_BRICKS, 2);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_STAIRS, Blocks.GRIMSTONE_BRICKS);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_WALL, Blocks.GRIMSTONE_BRICKS);
