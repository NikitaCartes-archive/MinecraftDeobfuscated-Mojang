...
implements DataProvider {
    ...
    private static void buildShapelessRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(Blocks.BREWING_STAND).define(Character.valueOf('B'), Items.BLAZE_ROD).define(Character.valueOf('#'), Blocks.COBBLESTONE).pattern(" B ").pattern("###").unlockedBy("has_blaze_rod", RecipeProvider.has(Items.BLAZE_ROD)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Blocks.FURNACE).define(Character.valueOf('#'), Blocks.COBBLESTONE).pattern("###").pattern("# #").pattern("###").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_SWORD).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_SWORD).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_SHOVEL).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_SHOVEL).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_PICKAXE).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_PICKAXE).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_AXE).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_AXE).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_HOE).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_HOE).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_HELMET).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_HELMET).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_CHESTPLATE).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_CHESTPLATE).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_LEGGINGS).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_LEGGINGS).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Items.NETHERITE_BOOTS).requires(Items.NETHERITE_INGOT).requires(Items.DIAMOND_BOOTS).unlockedBy("has_netherite_ingot", RecipeProvider.has(Items.NETHERITE_INGOT)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Items.STONE_AXE).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Items.STONE_HOE).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ShapedRecipeBuilder.shaped(Items.STONE_PICKAXE).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Items.STONE_SHOVEL).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("X").pattern("#").pattern("#").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Items.STONE_SWORD).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("X").pattern("X").pattern("#").unlockedBy("has_cobblestone", RecipeProvider.has(Blocks.COBBLESTONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Blocks.SOUL_FIRE_TORCH, 4).define(Character.valueOf('X'), Ingredient.of(Items.COAL, Items.CHARCOAL)).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('S'), Items.SOUL_SOIL).pattern("X").pattern("#").pattern("S").unlockedBy("has_soul_soil", RecipeProvider.has(Items.SOUL_SOIL)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Blocks.SOUL_FIRE_LANTERN).define(Character.valueOf('#'), Items.SOUL_FIRE_TORCH).define(Character.valueOf('X'), Items.IRON_NUGGET).pattern("XXX").pattern("X#X").pattern("XXX").unlockedBy("has_soul_fire_torch", RecipeProvider.has(Items.SOUL_FIRE_TORCH)).save(consumer);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ItemTags.LOGS), Items.CHARCOAL, 0.15f, 200).unlockedBy("has_log", RecipeProvider.has(ItemTags.LOGS)).save(consumer);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.GOLD_ORE.asItem()), Items.GOLD_INGOT, 1.0f, 200).unlockedBy("has_gold_ore", RecipeProvider.has(Blocks.GOLD_ORE)).save(consumer);
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.GOLD_ORE.asItem()), Items.GOLD_INGOT, 1.0f, 100).unlockedBy("has_gold_ore", RecipeProvider.has(Blocks.GOLD_ORE)).save(consumer, "gold_ingot_from_blasting");
