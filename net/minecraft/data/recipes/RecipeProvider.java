...
implements DataProvider {
    ...
    private static void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RecipeProvider.planksFromLogs(consumer, Blocks.MANGROVE_PLANKS, ItemTags.MANGROVE_LOGS);
        ...
        RecipeProvider.woodFromLogs(consumer, Blocks.MANGROVE_WOOD, Blocks.MANGROVE_LOG);
        ...
        RecipeProvider.woodFromLogs(consumer, Blocks.STRIPPED_MANGROVE_WOOD, Blocks.STRIPPED_MANGROVE_LOG);
        ...
        RecipeProvider.woodenBoat(consumer, Items.MANGROVE_BOAT, Blocks.MANGROVE_PLANKS);
        ...
        ShapelessRecipeBuilder.shapeless(Blocks.PACKED_MUD, 1).requires(Blocks.MUD).requires(Items.WHEAT).unlockedBy("has_mud", RecipeProvider.has(Blocks.MUD)).save(consumer);
        ShapedRecipeBuilder.shaped(Blocks.MUD_BRICKS, 4).define(Character.valueOf('#'), Blocks.PACKED_MUD).pattern("##").pattern("##").unlockedBy("has_packed_mud", RecipeProvider.has(Blocks.PACKED_MUD)).save(consumer);
        ShapelessRecipeBuilder.shapeless(Blocks.MUDDY_MANGROVE_ROOTS, 1).requires(Blocks.MUD).requires(Items.MANGROVE_ROOTS).unlockedBy("has_mangrove_roots", RecipeProvider.has(Blocks.MANGROVE_ROOTS)).save(consumer);
        ...
        RecipeProvider.nineBlockStorageRecipesRecipesWithCustomUnpacking(consumer, Items.COPPER_INGOT, Items.COPPER_BLOCK, RecipeProvider.getSimpleRecipeName(Items.COPPER_INGOT), RecipeProvider.getItemName(Items.COPPER_INGOT));
        ...
        RecipeProvider.oreSmelting(consumer, LAPIS_SMELTABLES, Items.LAPIS_LAZULI, 0.2f, 200, "lapis_lazuli");
        ...
        RecipeProvider.oreBlasting(consumer, LAPIS_SMELTABLES, Items.LAPIS_LAZULI, 0.2f, 100, "lapis_lazuli");
        ...
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.MUD_BRICK_SLAB, Blocks.MUD_BRICKS, 2);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.MUD_BRICK_STAIRS, Blocks.MUD_BRICKS);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.MUD_BRICK_WALL, Blocks.MUD_BRICKS);
        ...
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.CUT_COPPER, Blocks.COPPER_BLOCK, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.CUT_COPPER_STAIRS, Blocks.COPPER_BLOCK, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.CUT_COPPER_SLAB, Blocks.COPPER_BLOCK, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER, Blocks.EXPOSED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER_STAIRS, Blocks.EXPOSED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER_SLAB, Blocks.EXPOSED_COPPER, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER, Blocks.WEATHERED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER_STAIRS, Blocks.WEATHERED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER_SLAB, Blocks.WEATHERED_COPPER, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER, Blocks.OXIDIZED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER_STAIRS, Blocks.OXIDIZED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER_SLAB, Blocks.OXIDIZED_COPPER, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER, Blocks.WAXED_COPPER_BLOCK, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER_STAIRS, Blocks.WAXED_COPPER_BLOCK, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER_SLAB, Blocks.WAXED_COPPER_BLOCK, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER, Blocks.WAXED_EXPOSED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS, Blocks.WAXED_EXPOSED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, Blocks.WAXED_EXPOSED_COPPER, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_WEATHERED_CUT_COPPER, Blocks.WAXED_WEATHERED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS, Blocks.WAXED_WEATHERED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, Blocks.WAXED_WEATHERED_COPPER, 8);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_OXIDIZED_CUT_COPPER, Blocks.WAXED_OXIDIZED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS, Blocks.WAXED_OXIDIZED_COPPER, 4);
        RecipeProvider.stonecutterResultFromBase(consumer, Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, Blocks.WAXED_OXIDIZED_COPPER, 8);
