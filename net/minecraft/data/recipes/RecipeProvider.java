...
implements DataProvider {
    ...
    private static void buildShapelessRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(Blocks.FURNACE).define(Character.valueOf('#'), ItemTags.FURNACE_MATERIALS).pattern("###").pattern("# #").pattern("###").unlockedBy("has_cobblestone", RecipeProvider.has(ItemTags.FURNACE_MATERIALS)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Blocks.SOUL_FIRE_TORCH, 4).define(Character.valueOf('X'), Ingredient.of(Items.COAL, Items.CHARCOAL)).define(Character.valueOf('#'), Items.STICK).define(Character.valueOf('S'), ItemTags.SOUL_FIRE_BASE_BLOCKS).pattern("X").pattern("#").pattern("S").unlockedBy("has_soul_sand", RecipeProvider.has(ItemTags.SOUL_FIRE_BASE_BLOCKS)).save(consumer);
