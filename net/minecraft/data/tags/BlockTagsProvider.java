...
extends TagsProvider<Block> {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.WALL_POST_OVERRIDE).add((Block[])new Block[]{Blocks.TORCH, Blocks.SOUL_FIRE_TORCH, Blocks.REDSTONE_TORCH, Blocks.TRIPWIRE}).addTag(BlockTags.SIGNS);
        ...
        this.tag(BlockTags.PIGLIN_REPELLENTS).add(Blocks.SOUL_FIRE).add(Blocks.SOUL_FIRE_TORCH).add(Blocks.SOUL_FIRE_LANTERN).add(Blocks.SOUL_FIRE_WALL_TORCH).add(Blocks.SOUL_CAMPFIRE);
