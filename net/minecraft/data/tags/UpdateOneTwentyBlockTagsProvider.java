...
extends TagsProvider<Block> {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.WOODEN_STAIRS).add((Block[])new Block[]{Blocks.BAMBOO_STAIRS, Blocks.BAMBOO_MOSAIC_STAIRS});
        this.tag(BlockTags.WOODEN_SLABS).add((Block[])new Block[]{Blocks.BAMBOO_SLAB, Blocks.BAMBOO_MOSAIC_SLAB});
