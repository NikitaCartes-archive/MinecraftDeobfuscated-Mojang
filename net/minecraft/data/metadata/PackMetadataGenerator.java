...
implements DataProvider {
    ...
    public void run(CachedOutput cachedOutput) throws IOException {
        ...
        this.elements.forEach((string, supplier) -> jsonObject.add((String)string, (JsonElement)supplier.get()));
    ...
    public static PackMetadataGenerator forFeaturePack(PackOutput packOutput, String string, Component component, FeatureFlagSet featureFlagSet) {
        return new PackMetadataGenerator(packOutput, "Pack metadata for " + string).add(PackMetadataSection.TYPE, new PackMetadataSection(component, DetectedVersion.BUILT_IN.getPackVersion(PackType.DATA))).add(FeatureFlagsMetadataSection.TYPE, new FeatureFlagsMetadataSection(featureFlagSet));
    }
}
