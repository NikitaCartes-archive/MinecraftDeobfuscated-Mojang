...
public class BastionBridgePools {
    public static void bootstrap(BootstapContext<StructureTemplatePool> bootstapContext) {
        ...
        Pools.register(bootstapContext, "bastion/bridge/legs", new StructureTemplatePool(holder5, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/bridge/legs/leg_0", holder2), 1), Pair.of(StructurePoolElement.single("bastion/bridge/legs/leg_1", holder2), 1)), StructureTemplatePool.Projection.RIGID));
        Pools.register(bootstapContext, "bastion/bridge/walls", new StructureTemplatePool(holder5, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/bridge/walls/wall_base_0", holder4), 1), Pair.of(StructurePoolElement.single("bastion/bridge/walls/wall_base_1", holder4), 1)), StructureTemplatePool.Projection.RIGID));
        Pools.register(bootstapContext, "bastion/bridge/ramparts", new StructureTemplatePool(holder5, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/bridge/ramparts/rampart_0", holder4), 1), Pair.of(StructurePoolElement.single("bastion/bridge/ramparts/rampart_1", holder4), 1)), StructureTemplatePool.Projection.RIGID));
        Pools.register(bootstapContext, "bastion/bridge/rampart_plates", new StructureTemplatePool(holder5, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/bridge/rampart_plates/plate_0", holder4), 1)), StructureTemplatePool.Projection.RIGID));
        Pools.register(bootstapContext, "bastion/bridge/connectors", new StructureTemplatePool(holder5, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/bridge/connectors/back_bridge_top", holder2), 1), Pair.of(StructurePoolElement.single("bastion/bridge/connectors/back_bridge_bottom", holder2), 1)), StructureTemplatePool.Projection.RIGID));
    }
}
