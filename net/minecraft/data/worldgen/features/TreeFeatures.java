...
public class TreeFeatures {
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> OAK = FeatureUtils.register("oak", Feature.TREE, TreeFeatures.createOak().build());
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> JUNGLE_TREE = FeatureUtils.register("jungle_tree", Feature.TREE, TreeFeatures.createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2f), TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25f))).ignoreVines().build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_OAK = FeatureUtils.register("fancy_oak", Feature.TREE, TreeFeatures.createFancyOak().build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> JUNGLE_TREE_NO_VINE = FeatureUtils.register("jungle_tree_no_vine", Feature.TREE, TreeFeatures.createJungleTree().ignoreVines().build());
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SUPER_BIRCH_BEES_0002 = FeatureUtils.register("super_birch_bees_0002", Feature.TREE, TreeFeatures.createSuperBirch().decorators(ImmutableList.of(BEEHIVE_0002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SUPER_BIRCH_BEES = FeatureUtils.register("super_birch_bees", Feature.TREE, TreeFeatures.createSuperBirch().decorators(ImmutableList.of(BEEHIVE)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SWAMP_OAK = FeatureUtils.register("swamp_oak", Feature.TREE, TreeFeatures.createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new LeaveVineDecorator(0.25f))).build());
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MANGROVE = FeatureUtils.register("mangrove", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5f, UniformInt.of(0, 1), Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, UniformInt.of(1, 3), 0.2f)), new TwoLayersFeatureSize(1, 0, 2)).decorators(List.of(new LeaveVineDecorator(0.125f), new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), BEEHIVE_005)).ignoreVines().build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> TALL_MANGROVE = FeatureUtils.register("tall_mangrove", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5f, UniformInt.of(0, 1), Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, UniformInt.of(3, 7), 0.2f)), new TwoLayersFeatureSize(1, 0, 3)).decorators(List.of(new LeaveVineDecorator(0.125f), new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), BEEHIVE_005)).ignoreVines().build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> OAK_BEES_0002 = FeatureUtils.register("oak_bees_0002", Feature.TREE, TreeFeatures.createOak().decorators(List.of(BEEHIVE_0002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> OAK_BEES_002 = FeatureUtils.register("oak_bees_002", Feature.TREE, TreeFeatures.createOak().decorators(List.of(BEEHIVE_002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> OAK_BEES_005 = FeatureUtils.register("oak_bees_005", Feature.TREE, TreeFeatures.createOak().decorators(List.of(BEEHIVE_005)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> BIRCH_BEES_0002 = FeatureUtils.register("birch_bees_0002", Feature.TREE, TreeFeatures.createBirch().decorators(List.of(BEEHIVE_0002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> BIRCH_BEES_002 = FeatureUtils.register("birch_bees_002", Feature.TREE, TreeFeatures.createBirch().decorators(List.of(BEEHIVE_002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> BIRCH_BEES_005 = FeatureUtils.register("birch_bees_005", Feature.TREE, TreeFeatures.createBirch().decorators(List.of(BEEHIVE_005)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_OAK_BEES_0002 = FeatureUtils.register("fancy_oak_bees_0002", Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_0002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_OAK_BEES_002 = FeatureUtils.register("fancy_oak_bees_002", Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_002)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_OAK_BEES_005 = FeatureUtils.register("fancy_oak_bees_005", Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_005)).build());
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_OAK_BEES = FeatureUtils.register("fancy_oak_bees", Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE)).build());
