...
public class TreeFeatures {
    public static final ConfiguredFeature<HugeFungusConfiguration, ?> CRIMSON_FUNGUS = FeatureUtils.register("crimson_fungus", Feature.HUGE_FUNGUS.configured(new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), false)));
    public static final ConfiguredFeature<HugeFungusConfiguration, ?> CRIMSON_FUNGUS_PLANTED = FeatureUtils.register("crimson_fungus_planted", Feature.HUGE_FUNGUS.configured(new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), true)));
    public static final ConfiguredFeature<HugeFungusConfiguration, ?> WARPED_FUNGUS = FeatureUtils.register("warped_fungus", Feature.HUGE_FUNGUS.configured(new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), false)));
    public static final ConfiguredFeature<HugeFungusConfiguration, ?> WARPED_FUNGUS_PLANTED = FeatureUtils.register("warped_fungus_planted", Feature.HUGE_FUNGUS.configured(new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), true)));
    public static final ConfiguredFeature<?, ?> HUGE_BROWN_MUSHROOM = FeatureUtils.register("huge_brown_mushroom", Feature.HUGE_BROWN_MUSHROOM.configured(new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState)((BlockState)Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, true)).setValue(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)), 3)));
    public static final ConfiguredFeature<?, ?> HUGE_RED_MUSHROOM = FeatureUtils.register("huge_red_mushroom", Feature.HUGE_RED_MUSHROOM.configured(new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState)Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)), 2)));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> OAK = FeatureUtils.register("oak", Feature.TREE.configured(TreeFeatures.createOak().build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> BIRCH = FeatureUtils.register("birch", Feature.TREE.configured(TreeFeatures.createBirch().build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> JUNGLE_TREE = FeatureUtils.register("jungle_tree", Feature.TREE.configured(TreeFeatures.createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2f), TrunkVineDecorator.INSTANCE, LeaveVineDecorator.INSTANCE)).ignoreVines().build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> FANCY_OAK = FeatureUtils.register("fancy_oak", Feature.TREE.configured(TreeFeatures.createFancyOak().build()));
    public static final ConfiguredFeature<?, ?> JUNGLE_TREE_NO_VINE = FeatureUtils.register("jungle_tree_no_vine", Feature.TREE.configured(TreeFeatures.createJungleTree().ignoreVines().build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> SUPER_BIRCH_BEES_0002 = FeatureUtils.register("super_birch_bees_0002", Feature.TREE.configured(TreeFeatures.createSuperBirch().decorators(ImmutableList.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> SUPER_BIRCH_BEES = FeatureUtils.register("super_birch_bees", Feature.TREE.configured(TreeFeatures.createSuperBirch().decorators(ImmutableList.of(BEEHIVE)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> SWAMP_OAK = FeatureUtils.register("swamp_oak", Feature.TREE.configured(TreeFeatures.createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(LeaveVineDecorator.INSTANCE)).build()));
    ...
    public static final ConfiguredFeature<?, ?> AZALEA_TREE = FeatureUtils.register("azalea_tree", Feature.TREE.configured(new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.OAK_LOG), new BendingTrunkPlacer(4, 2, 0, 3, UniformInt.of(1, 2)), new WeightedStateProvider(SimpleWeightedRandomList.builder().add(Blocks.AZALEA_LEAVES.defaultBlockState(), 3).add(Blocks.FLOWERING_AZALEA_LEAVES.defaultBlockState(), 1)), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 50), new TwoLayersFeatureSize(1, 0, 1)).dirt(BlockStateProvider.simple(Blocks.ROOTED_DIRT)).forceDirt().build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> OAK_BEES_0002 = FeatureUtils.register("oak_bees_0002", Feature.TREE.configured(TreeFeatures.createOak().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> OAK_BEES_002 = FeatureUtils.register("oak_bees_002", Feature.TREE.configured(TreeFeatures.createOak().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> OAK_BEES_005 = FeatureUtils.register("oak_bees_005", Feature.TREE.configured(TreeFeatures.createOak().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> BIRCH_BEES_0002 = FeatureUtils.register("birch_bees_0002", Feature.TREE.configured(TreeFeatures.createBirch().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> BIRCH_BEES_002 = FeatureUtils.register("birch_bees_002", Feature.TREE.configured(TreeFeatures.createBirch().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> BIRCH_BEES_005 = FeatureUtils.register("birch_bees_005", Feature.TREE.configured(TreeFeatures.createBirch().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> FANCY_OAK_BEES_0002 = FeatureUtils.register("fancy_oak_bees_0002", Feature.TREE.configured(TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> FANCY_OAK_BEES_002 = FeatureUtils.register("fancy_oak_bees_002", Feature.TREE.configured(TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> FANCY_OAK_BEES_005 = FeatureUtils.register("fancy_oak_bees_005", Feature.TREE.configured(TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> FANCY_OAK_BEES = FeatureUtils.register("fancy_oak_bees", Feature.TREE.configured(TreeFeatures.createFancyOak().decorators(List.of(BEEHIVE)).build()));
