...
public class EndFeatures {
    public static final Holder<ConfiguredFeature<SpikeConfiguration, ?>> END_SPIKE = FeatureUtils.register("end_spike", Feature.END_SPIKE, new SpikeConfiguration(false, (List<SpikeFeature.EndSpike>)ImmutableList.of(), null));
