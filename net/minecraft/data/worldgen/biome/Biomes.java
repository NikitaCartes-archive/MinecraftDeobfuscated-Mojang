...
public abstract class Biomes {
    public static void bootstrap(BootstapContext<Biome> bootstapContext) {
        ...
        HolderGetter<ConfiguredWorldCarver<?>> holderGetter2 = bootstapContext.lookup(Registry.CONFIGURED_CARVER_REGISTRY);
        ...
        bootstapContext.register(net.minecraft.world.level.biome.Biomes.OLD_GROWTH_BIRCH_FOREST, OverworldBiomes.forest(holderGetter, holderGetter2, true, true, false));
