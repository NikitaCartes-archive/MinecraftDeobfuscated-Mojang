...
public abstract class Biomes {
    ...
    static {
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.MOUNTAINS, VanillaBiomes.mountainBiome(SurfaceBuilders.MOUNTAIN, false));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.SNOWY_TUNDRA, VanillaBiomes.tundraBiome(false));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.JUNGLE_EDGE, VanillaBiomes.jungleEdgeBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.DEEP_OCEAN, VanillaBiomes.oceanBiome(true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.STONE_SHORE, VanillaBiomes.beachBiome(0.2f, 0.3f, 4159204, false, true));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.GIANT_TREE_TAIGA, VanillaBiomes.giantTreeTaiga(0.3f, false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.WOODED_MOUNTAINS, VanillaBiomes.mountainBiome(SurfaceBuilders.GRASS, true));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.WOODED_BADLANDS_PLATEAU, VanillaBiomes.woodedBadlandsPlateauBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.BADLANDS_PLATEAU, VanillaBiomes.badlandsBiome());
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.GRAVELLY_MOUNTAINS, VanillaBiomes.mountainBiome(SurfaceBuilders.GRAVELLY_MOUNTAIN, false));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.TALL_BIRCH_FOREST, VanillaBiomes.birchForestBiome(true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.GIANT_SPRUCE_TAIGA, VanillaBiomes.giantTreeTaiga(0.25f, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.SHATTERED_SAVANNA, VanillaBiomes.savannaBiome(1.1f, true));
        ...
        Biomes.register(net.minecraft.world.level.biome.Biomes.SNOWCAPPED_PEAKS, VanillaBiomes.snowcappedPeaksBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.LOFTY_PEAKS, VanillaBiomes.loftyPeaksBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.STONY_PEAKS, VanillaBiomes.stonyPeaksBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.SNOWY_MOUNTAINS, VanillaBiomes.tundraBiome(false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.MUSHROOM_FIELD_SHORE, VanillaBiomes.mushroomFieldsBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.DESERT_HILLS, VanillaBiomes.desertBiome(false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.WOODED_HILLS, VanillaBiomes.forestBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.TAIGA_HILLS, VanillaBiomes.taigaBiome(false, false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.MOUNTAIN_EDGE, VanillaBiomes.mountainBiome(SurfaceBuilders.GRASS, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.JUNGLE_HILLS, VanillaBiomes.jungleHillsBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.BIRCH_FOREST_HILLS, VanillaBiomes.birchForestBiome(false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.SNOWY_TAIGA_HILLS, VanillaBiomes.taigaBiome(true, false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.GIANT_TREE_TAIGA_HILLS, VanillaBiomes.giantTreeTaiga(0.3f, false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.BADLANDS, VanillaBiomes.badlandsBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.DESERT_LAKES, VanillaBiomes.desertBiome(false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.TAIGA_MOUNTAINS, VanillaBiomes.taigaBiome(false, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.SWAMP_HILLS, VanillaBiomes.swampBiome(true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.MODIFIED_JUNGLE, VanillaBiomes.modifiedJungleBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.MODIFIED_JUNGLE_EDGE, VanillaBiomes.modifiedJungleEdgeBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.TALL_BIRCH_HILLS, VanillaBiomes.birchForestBiome(true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.DARK_FOREST_HILLS, VanillaBiomes.darkForestBiome(true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.SNOWY_TAIGA_MOUNTAINS, VanillaBiomes.taigaBiome(true, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.GIANT_SPRUCE_TAIGA_HILLS, VanillaBiomes.giantTreeTaiga(0.25f, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.MODIFIED_GRAVELLY_MOUNTAINS, VanillaBiomes.mountainBiome(SurfaceBuilders.GRAVELLY_MOUNTAIN, false));
        Biomes.register(net.minecraft.world.level.biome.Biomes.SHATTERED_SAVANNA_PLATEAU, VanillaBiomes.savannaBiome(1.0f, true));
        Biomes.register(net.minecraft.world.level.biome.Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU, VanillaBiomes.woodedBadlandsPlateauBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.MODIFIED_BADLANDS_PLATEAU, VanillaBiomes.badlandsBiome());
        Biomes.register(net.minecraft.world.level.biome.Biomes.BAMBOO_JUNGLE_HILLS, VanillaBiomes.bambooJungleHillsBiome());
    }
}
