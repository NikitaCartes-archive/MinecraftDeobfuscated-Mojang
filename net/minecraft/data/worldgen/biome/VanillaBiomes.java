...
public class VanillaBiomes {
    ...
    public static Biome jungleEdgeBiome() {
        return VanillaBiomes.baseJungleBiome(null, 0.1f, 0.2f, 0.8f, false, true, false);
    }

    public static Biome modifiedJungleEdgeBiome() {
        return VanillaBiomes.baseJungleBiome("jungle_edge", 0.2f, 0.4f, 0.8f, false, true, true);
    }

    public static Biome modifiedJungleBiome() {
        Biome biome = VanillaBiomes.baseJungleBiome("jungle", 0.2f, 0.4f, 0.9f, false, false, true);
    ...
    private static Biome jungleBiome(float f, float g, int i, int j, int k) {
        Biome biome = VanillaBiomes.baseJungleBiome(null, f, g, 0.9f, false, false, false);
    ...
    private static Biome bambooJungleBiome(float f, float g, int i, int j) {
        Biome biome = VanillaBiomes.baseJungleBiome(null, f, g, 0.9f, true, false, false);
        biome.addSpawn(MobCategory.CREATURE, new Biome.SpawnerData(EntityType.PARROT, i, 1, j));
    ...
    public static Biome theEndBiome() {
        Biome biome = VanillaBiomes.endBarrensBiome();
    ...
    public static Biome endHighlandsBiome() {
        Biome biome = VanillaBiomes.endMidlandsBiome();
    ...
    public static Biome savanaPlateauBiome() {
        Biome biome = VanillaBiomes.savannaBiome(null, 1.5f, 0.025f, 1.0f, true, false);
    ...
    public static Biome coldOceanBiome(boolean bl) {
        Biome biome = VanillaBiomes.baseOceanBiome(SurfaceBuilders.GRASS, 4020182, 329011, bl, false, !bl);
    ...
    public static Biome oceanBiome(boolean bl) {
        Biome biome = VanillaBiomes.baseOceanBiome(SurfaceBuilders.GRASS, 4159204, 329011, bl, false, true);
    ...
    public static Biome lukeWarmOceanBiome(boolean bl) {
        Biome biome = VanillaBiomes.baseOceanBiome(SurfaceBuilders.OCEAN_SAND, 4566514, 267827, bl, true, false);
    ...
    public static Biome warmOceanBiome() {
        Biome biome = VanillaBiomes.baseOceanBiome(SurfaceBuilders.FULL_SAND, 4445678, 270131, false, true, false);
    ...
    public static Biome deepWarmOceanBiome() {
        Biome biome = VanillaBiomes.baseOceanBiome(SurfaceBuilders.FULL_SAND, 4445678, 270131, true, true, false);
    ...
    public static Biome forestBiome(float f, float g) {
        Biome biome = VanillaBiomes.baseForestBiome(null, f, g, false);
        biome.addSpawn(MobCategory.CREATURE, new Biome.SpawnerData(EntityType.WOLF, 5, 4, 4));
        return biome;
    }

    public static Biome flowerForestBiome() {
        Biome biome = VanillaBiomes.baseForestBiome("forest", 0.1f, 0.4f, true);
        biome.addSpawn(MobCategory.CREATURE, new Biome.SpawnerData(EntityType.RABBIT, 4, 2, 3));
        return biome;
    }
