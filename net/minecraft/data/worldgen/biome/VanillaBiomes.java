...
public class VanillaBiomes {
    ...
    public static Biome modifiedJungleBiome() {
        ...
        return VanillaBiomes.baseJungleBiome(0.9f, false, false, false, builder);
    }

    public static Biome jungleHillsBiome() {
        return VanillaBiomes.jungleBiome(10, 1, 1);
    }

    public static Biome bambooJungleBiome() {
        return VanillaBiomes.bambooJungleBiome(40, 2);
    }

    public static Biome bambooJungleHillsBiome() {
        return VanillaBiomes.bambooJungleBiome(10, 1);
    }

    private static Biome jungleBiome(int i, int j, int k) {
        MobSpawnSettings.Builder builder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.baseJungleSpawns(builder);
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PARROT, i, 1, j)).addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.OCELOT, 2, 1, k)).addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PANDA, 1, 1, 2));
        builder.setPlayerCanSpawn();
        return VanillaBiomes.baseJungleBiome(0.9f, false, false, true, builder);
    }

    private static Biome bambooJungleBiome(int i, int j) {
        MobSpawnSettings.Builder builder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.baseJungleSpawns(builder);
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PARROT, i, 1, j)).addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PANDA, 80, 1, 2)).addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.OCELOT, 2, 1, 1));
        return VanillaBiomes.baseJungleBiome(0.9f, true, false, true, builder);
    }
    ...
    private static Biome baseEndBiome(BiomeGenerationSettings.Builder builder) {
        ...
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.THEEND).temperature(0.5f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(0xA080A0).skyColor(0).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome endHighlandsBiome() {
        BiomeGenerationSettings.Builder builder = new BiomeGenerationSettings.Builder().surfaceBuilder(SurfaceBuilders.END).addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Features.END_GATEWAY).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.CHORUS_PLANT);
        return VanillaBiomes.baseEndBiome(builder);
    }
    ...
    public static Biome mushroomFieldsBiome() {
        ...
        BiomeDefaultFeatures.addDefaultSprings(builder2);
        BiomeDefaultFeatures.addSurfaceFreezing(builder2);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.MUSHROOM).temperature(0.9f).downfall(1.0f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.9f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }

    private static Biome baseSavannaBiome(float f, boolean bl, MobSpawnSettings.Builder builder) {
        BiomeGenerationSettings.Builder builder2 = new BiomeGenerationSettings.Builder().surfaceBuilder(bl ? SurfaceBuilders.SHATTERED_SAVANNA : SurfaceBuilders.GRASS);
        BiomeDefaultFeatures.addDefaultCarvers(builder2);
        BiomeDefaultFeatures.addLavaLakes(builder2);
        BiomeDefaultFeatures.addDefaultCrystalFormations(builder2);
        BiomeDefaultFeatures.addDefaultMonsterRoom(builder2);
        ...
        BiomeDefaultFeatures.addDefaultExtraVegetation(builder2);
        BiomeDefaultFeatures.addDefaultSprings(builder2);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.SAVANNA).temperature(f).downfall(0.0f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }

    public static Biome savannaBiome(float f, boolean bl) {
        MobSpawnSettings.Builder builder = VanillaBiomes.savannaMobs();
        return VanillaBiomes.baseSavannaBiome(f, bl, builder);
    }
    ...
    public static Biome savanaPlateauBiome() {
        ...
        return VanillaBiomes.baseSavannaBiome(1.0f, false, builder);
    }
    ...
    public static Biome badlandsBiome() {
        return VanillaBiomes.baseBadlandsBiome(SurfaceBuilders.BADLANDS, false);
    }

    public static Biome woodedBadlandsPlateauBiome() {
        return VanillaBiomes.baseBadlandsBiome(SurfaceBuilders.WOODED_BADLANDS, true);
    }

    public static Biome erodedBadlandsBiome() {
        return VanillaBiomes.baseBadlandsBiome(SurfaceBuilders.ERODED_BADLANDS, false);
    }
    ...
    private static Biome baseOceanBiome(MobSpawnSettings.Builder builder, int i, int j, BiomeGenerationSettings.Builder builder2) {
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.OCEAN).temperature(0.5f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(i).waterFogColor(j).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.5f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }
    ...
    public static Biome coldOceanBiome(boolean bl) {
        ...
        boolean bl2 = !bl;
        BiomeGenerationSettings.Builder builder2 = VanillaBiomes.baseOceanGeneration(SurfaceBuilders.GRASS);
        ...
        BiomeDefaultFeatures.addSurfaceFreezing(builder2);
        return VanillaBiomes.baseOceanBiome(builder, 4020182, 329011, builder2);
    }
    ...
    public static Biome oceanBiome(boolean bl) {
        ...
        BiomeDefaultFeatures.addColdOceanExtraVegetation(builder2);
        BiomeDefaultFeatures.addSurfaceFreezing(builder2);
        return VanillaBiomes.baseOceanBiome(builder, 4159204, 329011, builder2);
    }
    ...
    public static Biome lukeWarmOceanBiome(boolean bl) {
        ...
        BiomeGenerationSettings.Builder builder2 = VanillaBiomes.baseOceanGeneration(SurfaceBuilders.OCEAN_SAND);
        ...
        BiomeDefaultFeatures.addSurfaceFreezing(builder2);
        return VanillaBiomes.baseOceanBiome(builder, 4566514, 267827, builder2);
    }
    ...
    public static Biome warmOceanBiome() {
        ...
        BiomeGenerationSettings.Builder builder2 = VanillaBiomes.baseOceanGeneration(SurfaceBuilders.FULL_SAND).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.WARM_OCEAN_VEGETATION).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SEAGRASS_WARM).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SEA_PICKLE);
        return VanillaBiomes.baseOceanBiome(builder, 4445678, 270131, builder2);
    }

    public static Biome deepWarmOceanBiome() {
        MobSpawnSettings.Builder builder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.warmOceanSpawns(builder, 5, 1);
        BiomeGenerationSettings.Builder builder2 = VanillaBiomes.baseOceanGeneration(SurfaceBuilders.FULL_SAND).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SEAGRASS_DEEP_WARM);
        BiomeDefaultFeatures.addDefaultSeagrass(builder2);
        return VanillaBiomes.baseOceanBiome(builder, 4445678, 270131, builder2);
    }
    ...
    public static Biome forestBiome() {
        ...
        return VanillaBiomes.baseForestBiome(false, builder);
    }
    ...
    public static Biome flowerForestBiome() {
        ...
        return VanillaBiomes.baseForestBiome(true, builder);
    }
    ...
    public static Biome riverBiome(float f, int i, boolean bl) {
        ...
        BiomeDefaultFeatures.addSurfaceFreezing(builder2);
        return new Biome.BiomeBuilder().precipitation(bl ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.RIVER).temperature(f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(i).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }
    ...
    public static Biome netherWastesBiome() {
        ...
        BiomeGenerationSettings.Builder builder = new BiomeGenerationSettings.Builder().surfaceBuilder(SurfaceBuilders.NETHER).addCarver(GenerationStep.Carving.AIR, Carvers.NETHER_CAVE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
        BiomeDefaultFeatures.addDefaultMushrooms(builder);
    ...
    public static Biome soulSandValleyBiome() {
        ...
        BiomeGenerationSettings.Builder builder = new BiomeGenerationSettings.Builder().surfaceBuilder(SurfaceBuilders.SOUL_SAND_VALLEY).addCarver(GenerationStep.Carving.AIR, Carvers.NETHER_CAVE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA).addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Features.BASALT_PILLAR).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.SPRING_OPEN).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.PATCH_FIRE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.PATCH_SOUL_FIRE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.GLOWSTONE_EXTRA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.GLOWSTONE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.PATCH_CRIMSON_ROOTS).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.ORE_MAGMA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.SPRING_CLOSED).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.ORE_SOUL_SAND);
        BiomeDefaultFeatures.addNetherDefaultOres(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.NETHER).temperature(2.0f).downfall(0.0f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(1787717).skyColor(VanillaBiomes.calculateSkyColor(2.0f)).ambientParticle(new AmbientParticleSettings(ParticleTypes.ASH, 0.00625f)).ambientLoopSound(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_LOOP).ambientMoodSound(new AmbientMoodSettings(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_MOOD, 6000, 8, 2.0)).ambientAdditionsSound(new AmbientAdditionsSettings(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_ADDITIONS, 0.0111)).backgroundMusic(Musics.createGameMusic(SoundEvents.MUSIC_BIOME_SOUL_SAND_VALLEY)).build()).mobSpawnSettings(mobSpawnSettings).generationSettings(builder.build()).build();
    }
    ...
    public static Biome crimsonForestBiome() {
        ...
        BiomeGenerationSettings.Builder builder = new BiomeGenerationSettings.Builder().surfaceBuilder(SurfaceBuilders.CRIMSON_FOREST).addCarver(GenerationStep.Carving.AIR, Carvers.NETHER_CAVE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
        BiomeDefaultFeatures.addDefaultMushrooms(builder);
        ...
        BiomeDefaultFeatures.addNetherDefaultOres(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.NETHER).temperature(2.0f).downfall(0.0f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(0x330303).skyColor(VanillaBiomes.calculateSkyColor(2.0f)).ambientParticle(new AmbientParticleSettings(ParticleTypes.CRIMSON_SPORE, 0.025f)).ambientLoopSound(SoundEvents.AMBIENT_CRIMSON_FOREST_LOOP).ambientMoodSound(new AmbientMoodSettings(SoundEvents.AMBIENT_CRIMSON_FOREST_MOOD, 6000, 8, 2.0)).ambientAdditionsSound(new AmbientAdditionsSettings(SoundEvents.AMBIENT_CRIMSON_FOREST_ADDITIONS, 0.0111)).backgroundMusic(Musics.createGameMusic(SoundEvents.MUSIC_BIOME_CRIMSON_FOREST)).build()).mobSpawnSettings(mobSpawnSettings).generationSettings(builder.build()).build();
    }
    ...
    public static Biome warpedForestBiome() {
        ...
        BiomeGenerationSettings.Builder builder = new BiomeGenerationSettings.Builder().surfaceBuilder(SurfaceBuilders.WARPED_FOREST).addCarver(GenerationStep.Carving.AIR, Carvers.NETHER_CAVE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
        BiomeDefaultFeatures.addDefaultMushrooms(builder);
    ...
    public static Biome meadowBiome() {
        ...
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.MOUNTAIN).temperature(0.5f).downfall(0.8f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(937679).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.7f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome snowcappedPeaksBiome() {
        ...
        BiomeDefaultFeatures.addInfestedStone(builder);
        BiomeDefaultFeatures.addSurfaceFreezing(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.MOUNTAIN).temperature(-0.7f).downfall(0.9f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.7f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome stonyPeaksBiome() {
        ...
        BiomeDefaultFeatures.addExtraEmeralds(builder);
        BiomeDefaultFeatures.addInfestedStone(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.MOUNTAIN).temperature(1.0f).downfall(0.3f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.2f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome snowySlopesBiome() {
        ...
        BiomeDefaultFeatures.addInfestedStone(builder);
        BiomeDefaultFeatures.addSurfaceFreezing(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.MOUNTAIN).temperature(-0.3f).downfall(0.9f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.7f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome groveBiome() {
        ...
        BiomeDefaultFeatures.addInfestedStone(builder);
        BiomeDefaultFeatures.addSurfaceFreezing(builder);
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.FOREST).temperature(-0.2f).downfall(0.8f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.7f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder2.build()).generationSettings(builder.build()).build();
    }
    ...
    public static Biome lushCaves() {
        ...
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.UNDERGROUND).temperature(0.5f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.5f)).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }
    ...
    public static Biome dripstoneCaves() {
        ...
        return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.UNDERGROUND).temperature(0.8f).downfall(0.4f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(VanillaBiomes.calculateSkyColor(0.8f)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(builder.build()).generationSettings(builder2.build()).build();
    }
}
