...
extends Biome {
    public IceSpikesBiome() {
        super(new Biome.BiomeBuilder().surfaceBuilder(SurfaceBuilders.ICE_SPIKES).precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.ICY).depth(0.425f).scale(0.45000002f).temperature(0.0f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).parent("snowy_tundra"));
