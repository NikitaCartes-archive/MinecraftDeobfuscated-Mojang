...
extends Biome {
    public DeepLukeWarmOceanBiome() {
        super(new Biome.BiomeBuilder().surfaceBuilder(SurfaceBuilders.OCEAN_SAND).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.OCEAN).depth(-1.8f).scale(0.1f).temperature(0.5f).downfall(0.5f).specialEffects(new BiomeSpecialEffects.Builder().waterColor(4566514).waterFogColor(267827).fogColor(12638463).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).parent(null));
