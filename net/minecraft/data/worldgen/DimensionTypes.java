...
public class DimensionTypes {
    public static Holder<DimensionType> bootstrap(Registry<DimensionType> registry) {
        ...
        return BuiltinRegistries.register(registry, BuiltinDimensionTypes.OVERWORLD_CAVES, new DimensionType(OptionalLong.empty(), true, true, false, true, 1.0, false, true, false, true, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, BuiltinDimensionTypes.OVERWORLD_EFFECTS, 0.0f));
    }
}
