...
public class TreePlacements {
    ...
    public static final Holder<PlacedFeature> TALL_MANGROVE_CHECKED = PlacementUtils.register("tall_mangrove_checked", TreeFeatures.TALL_MANGROVE, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
