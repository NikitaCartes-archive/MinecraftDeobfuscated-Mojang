...
public class CavePlacements {
    ...
    public static final Holder<PlacedFeature> SCULK_PATCH_DEEP_DARK = PlacementUtils.register("sculk_patch_deep_dark", CaveFeatures.SCULK_PATCH_DEEP_DARK, CountPlacement.of(ConstantInt.of(256)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
    public static final Holder<PlacedFeature> SCULK_PATCH_ANCIENT_CITY = PlacementUtils.register("sculk_patch_ancient_city", CaveFeatures.SCULK_PATCH_ANCIENT_CITY, new PlacementModifier[0]);
