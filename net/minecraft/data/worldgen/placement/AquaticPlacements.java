...
public class AquaticPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> bootstapContext) {
        ...
        PlacementUtils.register(bootstapContext, SEAGRASS_WARM, reference, AquaticPlacements.seagrassPlacement(80));
        PlacementUtils.register(bootstapContext, SEAGRASS_NORMAL, reference, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstapContext, SEAGRASS_COLD, reference, AquaticPlacements.seagrassPlacement(32));
        PlacementUtils.register(bootstapContext, SEAGRASS_RIVER, reference2, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstapContext, SEAGRASS_SWAMP, reference3, AquaticPlacements.seagrassPlacement(64));
        PlacementUtils.register(bootstapContext, SEAGRASS_DEEP_WARM, reference4, AquaticPlacements.seagrassPlacement(80));
        PlacementUtils.register(bootstapContext, SEAGRASS_DEEP, reference4, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstapContext, SEAGRASS_DEEP_COLD, reference4, AquaticPlacements.seagrassPlacement(40));
        PlacementUtils.register(bootstapContext, SEAGRASS_SIMPLE, reference5, CarvingMaskPlacement.forStep(GenerationStep.Carving.LIQUID), RarityFilter.onAverageOnceEvery(10), BlockPredicateFilter.forPredicate(BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getNormal(), Blocks.STONE), BlockPredicate.matchesBlocks((Vec3i)BlockPos.ZERO, Blocks.WATER), BlockPredicate.matchesBlocks(Direction.UP.getNormal(), Blocks.WATER))), BiomeFilter.biome());
        PlacementUtils.register(bootstapContext, SEA_PICKLE, reference6, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstapContext, KELP_COLD, reference7, NoiseBasedCountPlacement.of(120, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstapContext, KELP_WARM, reference7, NoiseBasedCountPlacement.of(80, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstapContext, WARM_OCEAN_VEGETATION, reference8, NoiseBasedCountPlacement.of(20, 400.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
    }
}
