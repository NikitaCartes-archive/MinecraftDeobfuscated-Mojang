...
public class Carvers {
    public static final ConfiguredWorldCarver<CarverConfiguration> CAVE = Carvers.register("cave", WorldCarver.CAVE.configured(new CarverConfiguration(0.25f, CarverDebugSettings.of(false, Blocks.CRIMSON_BUTTON.defaultBlockState()))));
    ...
    public static final ConfiguredWorldCarver<CarverConfiguration> OCEAN_CAVE = Carvers.register("ocean_cave", WorldCarver.CAVE.configured(new CarverConfiguration(0.125f, CarverDebugSettings.of(false, Blocks.CRIMSON_BUTTON.defaultBlockState()))));
    ...
    public static final ConfiguredWorldCarver<CanyonCarverConfiguration> CRACK = Carvers.register("crack", WorldCarver.CANYON.configured(new CanyonCarverConfiguration(0.005f, CarverDebugSettings.of(false, Blocks.OAK_BUTTON.defaultBlockState()), VerticalAnchor.absolute(40), VerticalAnchor.absolute(80), UniformInt.of(6, 2), UniformFloat.of(0.5f, 0.5f), UniformFloat.of(-0.125f, 0.25f), UniformFloat.of(0.0f, 1.0f), 6, UniformFloat.of(0.25f, 0.75f), 0.0f, 5.0f)));
