...
public class StructureFeatures {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> FORTRESS = StructureFeatures.register(BuiltinStructures.FORTRESS, StructureFeature.FORTRESS.configured(NoneFeatureConfiguration.INSTANCE, BiomeTags.HAS_NETHER_FORTRESS, Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, NetherFortressFeature.FORTRESS_ENEMIES))));
