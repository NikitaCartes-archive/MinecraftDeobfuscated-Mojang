...
public class StructureFeatures {
    ...
    public static void registerStructures(BiConsumer<ConfiguredStructureFeature<?, ?>, ResourceKey<Biome>> biConsumer) {
        ...
        ImmutableCollection set5 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.MEADOW)).add(Biomes.SNOWCAPPED_PEAKS)).add(Biomes.LOFTY_PEAKS)).add(Biomes.STONY_PEAKS)).add(Biomes.SNOWY_SLOPES)).build();
        ImmutableCollection set6 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.BADLANDS_PLATEAU)).add(Biomes.ERODED_BADLANDS)).add(Biomes.WOODED_BADLANDS_PLATEAU)).build();
        ImmutableCollection set7 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.MOUNTAINS)).add(Biomes.WOODED_MOUNTAINS)).add(Biomes.GRAVELLY_MOUNTAINS)).build();
        ImmutableCollection set8 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.TAIGA)).add(Biomes.SNOWY_TAIGA)).add(Biomes.GIANT_TREE_TAIGA)).add(Biomes.GIANT_SPRUCE_TAIGA)).build();
        ImmutableCollection set9 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.BAMBOO_JUNGLE)).add(Biomes.JUNGLE)).add(Biomes.JUNGLE_EDGE)).build();
        ImmutableCollection set10 = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Biomes.FOREST)).add(Biomes.FLOWER_FOREST)).add(Biomes.BIRCH_FOREST)).add(Biomes.TALL_BIRCH_FOREST)).add(Biomes.DARK_FOREST)).add(Biomes.GROVE)).build();
        ...
        StructureFeatures.register(biConsumer, IGLOO, Biomes.SNOWY_TUNDRA);
        ...
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.STONE_SHORE);
        ...
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SHATTERED_SAVANNA);
        ...
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SNOWY_TUNDRA);
        ...
        StructureFeatures.register(biConsumer, PILLAGER_OUTPOST, Biomes.SNOWY_TUNDRA);
        ...
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.SHATTERED_SAVANNA);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.STONE_SHORE);
        ...
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.SNOWY_TUNDRA);
        ...
        StructureFeatures.register(biConsumer, VILLAGE_SNOWY, Biomes.SNOWY_TUNDRA);
        ...
        StructureFeatures.register(biConsumer, DESERT_PYRAMID, Biomes.DESERT_HILLS);
        StructureFeatures.register(biConsumer, JUNGLE_TEMPLE, Biomes.BAMBOO_JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, JUNGLE_TEMPLE, Biomes.JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.BAMBOO_JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.BIRCH_FOREST_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.DARK_FOREST_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.DESERT_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.DESERT_LAKES);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.GIANT_SPRUCE_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.GIANT_TREE_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.MODIFIED_GRAVELLY_MOUNTAINS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.MODIFIED_JUNGLE);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.MODIFIED_JUNGLE_EDGE);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.MOUNTAIN_EDGE);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.MUSHROOM_FIELD_SHORE);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SHATTERED_SAVANNA_PLATEAU);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SNOWY_MOUNTAINS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SNOWY_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SNOWY_TAIGA_MOUNTAINS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.SWAMP_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.TAIGA_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.TAIGA_MOUNTAINS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.TALL_BIRCH_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT, Biomes.WOODED_HILLS);
        StructureFeatures.register(biConsumer, MINESHAFT_MESA, Biomes.BADLANDS);
        StructureFeatures.register(biConsumer, MINESHAFT_MESA, Biomes.MODIFIED_BADLANDS_PLATEAU);
        StructureFeatures.register(biConsumer, MINESHAFT_MESA, Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_DESERT, Biomes.DESERT_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_DESERT, Biomes.DESERT_LAKES);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_JUNGLE, Biomes.BAMBOO_JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_JUNGLE, Biomes.JUNGLE_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_JUNGLE, Biomes.MODIFIED_JUNGLE);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_JUNGLE, Biomes.MODIFIED_JUNGLE_EDGE);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.MODIFIED_BADLANDS_PLATEAU);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.MODIFIED_GRAVELLY_MOUNTAINS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.MOUNTAIN_EDGE);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.SHATTERED_SAVANNA_PLATEAU);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.SNOWY_MOUNTAINS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.SNOWY_TAIGA_MOUNTAINS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.BADLANDS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.BIRCH_FOREST_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.DARK_FOREST_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.GIANT_SPRUCE_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.GIANT_TREE_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.MUSHROOM_FIELD_SHORE);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.SNOWY_TAIGA_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.TAIGA_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_MOUNTAIN, Biomes.TAIGA_MOUNTAINS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.TALL_BIRCH_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_STANDARD, Biomes.WOODED_HILLS);
        StructureFeatures.register(biConsumer, RUINED_PORTAL_SWAMP, Biomes.SWAMP_HILLS);
        StructureFeatures.register(biConsumer, WOODLAND_MANSION, Biomes.DARK_FOREST_HILLS);
