...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement5 = Advancement.Builder.advancement().parent(advancement3).display(Blocks.PURPUR_BLOCK, (Component)new TranslatableComponent("advancements.end.find_end_city.title"), (Component)new TranslatableComponent("advancements.end.find_end_city.description"), null, FrameType.TASK, true, true, false).addCriterion("in_city", LocationTrigger.TriggerInstance.located(LocationPredicate.inFeature(Feature.END_CITY))).save(consumer, "end/find_end_city");
        Advancement advancement6 = Advancement.Builder.advancement().parent(advancement2).display(Items.DRAGON_BREATH, (Component)new TranslatableComponent("advancements.end.dragon_breath.title"), (Component)new TranslatableComponent("advancements.end.dragon_breath.description"), null, FrameType.GOAL, true, true, false).addCriterion("dragon_breath", InventoryChangeTrigger.TriggerInstance.hasItem(Items.DRAGON_BREATH)).save(consumer, "end/dragon_breath");
        ...
        Advancement advancement8 = Advancement.Builder.advancement().parent(advancement5).display(Items.ELYTRA, (Component)new TranslatableComponent("advancements.end.elytra.title"), (Component)new TranslatableComponent("advancements.end.elytra.description"), null, FrameType.GOAL, true, true, false).addCriterion("elytra", InventoryChangeTrigger.TriggerInstance.hasItem(Items.ELYTRA)).save(consumer, "end/elytra");
        Advancement advancement9 = Advancement.Builder.advancement().parent(advancement2).display(Blocks.DRAGON_EGG, (Component)new TranslatableComponent("advancements.end.dragon_egg.title"), (Component)new TranslatableComponent("advancements.end.dragon_egg.description"), null, FrameType.GOAL, true, true, false).addCriterion("dragon_egg", InventoryChangeTrigger.TriggerInstance.hasItem(Blocks.DRAGON_EGG)).save(consumer, "end/dragon_egg");
    }
