...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement2 = Advancement.Builder.advancement().parent(advancement).display(Blocks.RED_BED, (Component)new TranslatableComponent("advancements.adventure.sleep_in_bed.title"), (Component)new TranslatableComponent("advancements.adventure.sleep_in_bed.description"), null, FrameType.TASK, true, true, false).addCriterion("slept_in_bed", PlayerTrigger.TriggerInstance.sleptInBed()).save(consumer, "adventure/sleep_in_bed");
        ...
        Advancement.Builder.advancement().parent(advancement2).display(Items.LEATHER_BOOTS, (Component)new TranslatableComponent("advancements.adventure.walk_on_powder_snow_with_leather_boots.title"), (Component)new TranslatableComponent("advancements.adventure.walk_on_powder_snow_with_leather_boots.description"), null, FrameType.TASK, true, true, false).addCriterion("walk_on_powder_snow_with_leather_boots", PlayerTrigger.TriggerInstance.walkOnBlockWithEquipment(Blocks.POWDER_SNOW, Items.LEATHER_BOOTS)).save(consumer, "adventure/walk_on_powder_snow_with_leather_boots");
        ...
        Advancement.Builder.advancement().parent(advancement).display(Blocks.SCULK_CATALYST, (Component)new TranslatableComponent("advancements.adventure.kill_mob_near_sculk_catalyst.title"), (Component)new TranslatableComponent("advancements.adventure.kill_mob_near_sculk_catalyst.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("kill_mob_near_sculk_catalyst", KilledTrigger.TriggerInstance.playerKilledEntityNearSculkCatalyst()).save(consumer, "adventure/kill_mob_near_sculk_catalyst");
        Advancement.Builder.advancement().parent(advancement).display(Blocks.SCULK_SENSOR, (Component)new TranslatableComponent("advancements.adventure.avoid_vibration.title"), (Component)new TranslatableComponent("advancements.adventure.avoid_vibration.description"), null, FrameType.TASK, true, true, false).addCriterion("avoid_vibration", PlayerTrigger.TriggerInstance.avoidVibration()).save(consumer, "adventure/avoid_vibration");
    }
