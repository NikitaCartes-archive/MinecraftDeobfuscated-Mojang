...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement4 = Advancement.Builder.advancement().parent(advancement).display(Items.EMERALD, (Component)new TranslatableComponent("advancements.adventure.trade.title"), (Component)new TranslatableComponent("advancements.adventure.trade.description"), null, FrameType.TASK, true, true, false).addCriterion("traded", TradeTrigger.TriggerInstance.tradedWithVillager()).save(consumer, "adventure/trade");
        ...
        Advancement advancement7 = Advancement.Builder.advancement().parent(advancement5).display(Items.BOW, (Component)new TranslatableComponent("advancements.adventure.shoot_arrow.title"), (Component)new TranslatableComponent("advancements.adventure.shoot_arrow.description"), null, FrameType.TASK, true, true, false).addCriterion("shot_arrow", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(DamagePredicate.Builder.damageInstance().type(DamageSourcePredicate.Builder.damageType().isProjectile(true).direct(EntityPredicate.Builder.entity().of(EntityTypeTags.ARROWS))))).save(consumer, "adventure/shoot_arrow");
        ...
        Advancement advancement9 = Advancement.Builder.advancement().parent(advancement8).display(Items.TRIDENT, (Component)new TranslatableComponent("advancements.adventure.very_very_frightening.title"), (Component)new TranslatableComponent("advancements.adventure.very_very_frightening.description"), null, FrameType.TASK, true, true, false).addCriterion("struck_villager", ChanneledLightningTrigger.TriggerInstance.channeledLightning(EntityPredicate.Builder.entity().of(EntityType.VILLAGER).build())).save(consumer, "adventure/very_very_frightening");
        Advancement advancement10 = Advancement.Builder.advancement().parent(advancement4).display(Blocks.CARVED_PUMPKIN, (Component)new TranslatableComponent("advancements.adventure.summon_iron_golem.title"), (Component)new TranslatableComponent("advancements.adventure.summon_iron_golem.description"), null, FrameType.GOAL, true, true, false).addCriterion("summoned_golem", SummonedEntityTrigger.TriggerInstance.summonedEntity(EntityPredicate.Builder.entity().of(EntityType.IRON_GOLEM))).save(consumer, "adventure/summon_iron_golem");
        Advancement advancement11 = Advancement.Builder.advancement().parent(advancement7).display(Items.ARROW, (Component)new TranslatableComponent("advancements.adventure.sniper_duel.title"), (Component)new TranslatableComponent("advancements.adventure.sniper_duel.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).addCriterion("killed_skeleton", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(EntityType.SKELETON).distance(DistancePredicate.horizontal(MinMaxBounds.Floats.atLeast(50.0f))), DamageSourcePredicate.Builder.damageType().isProjectile(true))).save(consumer, "adventure/sniper_duel");
        Advancement advancement12 = Advancement.Builder.advancement().parent(advancement5).display(Items.TOTEM_OF_UNDYING, (Component)new TranslatableComponent("advancements.adventure.totem_of_undying.title"), (Component)new TranslatableComponent("advancements.adventure.totem_of_undying.description"), null, FrameType.GOAL, true, true, false).addCriterion("used_totem", UsedTotemTrigger.TriggerInstance.usedTotem(Items.TOTEM_OF_UNDYING)).save(consumer, "adventure/totem_of_undying");
        ...
        Advancement advancement14 = Advancement.Builder.advancement().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.whos_the_pillager_now.title"), (Component)new TranslatableComponent("advancements.adventure.whos_the_pillager_now.description"), null, FrameType.TASK, true, true, false).addCriterion("kill_pillager", KilledByCrossbowTrigger.TriggerInstance.crossbowKilled(EntityPredicate.Builder.entity().of(EntityType.PILLAGER))).save(consumer, "adventure/whos_the_pillager_now");
        Advancement advancement15 = Advancement.Builder.advancement().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.two_birds_one_arrow.title"), (Component)new TranslatableComponent("advancements.adventure.two_birds_one_arrow.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(65)).addCriterion("two_birds", KilledByCrossbowTrigger.TriggerInstance.crossbowKilled(EntityPredicate.Builder.entity().of(EntityType.PHANTOM), EntityPredicate.Builder.entity().of(EntityType.PHANTOM))).save(consumer, "adventure/two_birds_one_arrow");
        Advancement advancement16 = Advancement.Builder.advancement().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.arbalistic.title"), (Component)new TranslatableComponent("advancements.adventure.arbalistic.description"), null, FrameType.CHALLENGE, true, true, true).rewards(AdvancementRewards.Builder.experience(85)).addCriterion("arbalistic", KilledByCrossbowTrigger.TriggerInstance.crossbowKilled(MinMaxBounds.Ints.exactly(5))).save(consumer, "adventure/arbalistic");
        ...
        Advancement advancement20 = Advancement.Builder.advancement().parent(advancement7).display(Blocks.TARGET.asItem(), (Component)new TranslatableComponent("advancements.adventure.bullseye.title"), (Component)new TranslatableComponent("advancements.adventure.bullseye.description"), null, FrameType.TASK, true, true, false).addCriterion("bullseye", TargetBlockTrigger.TriggerInstance.targetHit(MinMaxBounds.Ints.exactly(15))).save(consumer, "adventure/bullseye");
    }
