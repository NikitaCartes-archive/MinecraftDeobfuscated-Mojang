...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement4 = Advancement.Builder.advancement().parent(advancement).display(Items.MAP, (Component)new TranslatableComponent("advancements.nether.fast_travel.title"), (Component)new TranslatableComponent("advancements.nether.fast_travel.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("travelled", NetherTravelTrigger.TriggerInstance.travelledThroughNether(DistancePredicate.horizontal(MinMaxBounds.Floats.atLeast(7000.0f)))).save(consumer, "nether/fast_travel");
        Advancement advancement5 = Advancement.Builder.advancement().parent(advancement2).display(Items.GHAST_TEAR, (Component)new TranslatableComponent("advancements.nether.uneasy_alliance.title"), (Component)new TranslatableComponent("advancements.nether.uneasy_alliance.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("killed_ghast", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(EntityType.GHAST).located(LocationPredicate.inDimension(DimensionType.OVERWORLD)))).save(consumer, "nether/uneasy_alliance");
        Advancement advancement6 = Advancement.Builder.advancement().parent(advancement3).display(Blocks.WITHER_SKELETON_SKULL, (Component)new TranslatableComponent("advancements.nether.get_wither_skull.title"), (Component)new TranslatableComponent("advancements.nether.get_wither_skull.description"), null, FrameType.TASK, true, true, false).addCriterion("wither_skull", InventoryChangeTrigger.TriggerInstance.hasItem(Blocks.WITHER_SKELETON_SKULL)).save(consumer, "nether/get_wither_skull");
        Advancement advancement7 = Advancement.Builder.advancement().parent(advancement6).display(Items.NETHER_STAR, (Component)new TranslatableComponent("advancements.nether.summon_wither.title"), (Component)new TranslatableComponent("advancements.nether.summon_wither.description"), null, FrameType.TASK, true, true, false).addCriterion("summoned", SummonedEntityTrigger.TriggerInstance.summonedEntity(EntityPredicate.Builder.entity().of(EntityType.WITHER))).save(consumer, "nether/summon_wither");
        Advancement advancement8 = Advancement.Builder.advancement().parent(advancement3).display(Items.BLAZE_ROD, (Component)new TranslatableComponent("advancements.nether.obtain_blaze_rod.title"), (Component)new TranslatableComponent("advancements.nether.obtain_blaze_rod.description"), null, FrameType.TASK, true, true, false).addCriterion("blaze_rod", InventoryChangeTrigger.TriggerInstance.hasItem(Items.BLAZE_ROD)).save(consumer, "nether/obtain_blaze_rod");
        Advancement advancement9 = Advancement.Builder.advancement().parent(advancement7).display(Blocks.BEACON, (Component)new TranslatableComponent("advancements.nether.create_beacon.title"), (Component)new TranslatableComponent("advancements.nether.create_beacon.description"), null, FrameType.TASK, true, true, false).addCriterion("beacon", ConstructBeaconTrigger.TriggerInstance.constructedBeacon(MinMaxBounds.Ints.atLeast(1))).save(consumer, "nether/create_beacon");
        Advancement advancement10 = Advancement.Builder.advancement().parent(advancement9).display(Blocks.BEACON, (Component)new TranslatableComponent("advancements.nether.create_full_beacon.title"), (Component)new TranslatableComponent("advancements.nether.create_full_beacon.description"), null, FrameType.GOAL, true, true, false).addCriterion("beacon", ConstructBeaconTrigger.TriggerInstance.constructedBeacon(MinMaxBounds.Ints.exactly(4))).save(consumer, "nether/create_full_beacon");
        Advancement advancement11 = Advancement.Builder.advancement().parent(advancement8).display(Items.POTION, (Component)new TranslatableComponent("advancements.nether.brew_potion.title"), (Component)new TranslatableComponent("advancements.nether.brew_potion.description"), null, FrameType.TASK, true, true, false).addCriterion("potion", BrewedPotionTrigger.TriggerInstance.brewedPotion()).save(consumer, "nether/brew_potion");
