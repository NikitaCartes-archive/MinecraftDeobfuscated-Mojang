...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement7 = Advancement.Builder.advancement().parent(advancement6).requirements(RequirementsStrategy.OR).addCriterion(Registry.ITEM.getKey(Items.AXOLOTL_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, (Component)new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.title"), (Component)new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/axolotl_in_a_bucket");
        Advancement.Builder.advancement().parent(advancement7).addCriterion("kill_axolotl_target", EffectsChangedTrigger.TriggerInstance.gotEffectsFrom(EntityPredicate.Builder.entity().of(EntityType.AXOLOTL).build())).display(Items.TROPICAL_FISH_BUCKET, (Component)new TranslatableComponent("advancements.husbandry.kill_axolotl_target.title"), (Component)new TranslatableComponent("advancements.husbandry.kill_axolotl_target.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/kill_axolotl_target");
        ...
        Advancement advancement9 = Advancement.Builder.advancement().parent(advancement8).display(Items.HONEYCOMB, (Component)new TranslatableComponent("advancements.husbandry.wax_on.title"), (Component)new TranslatableComponent("advancements.husbandry.wax_on.description"), null, FrameType.TASK, true, true, false).addCriterion("wax_on", ItemInteractWithBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(HoneycombItem.WAXABLES.get().keySet()).build()), ItemPredicate.Builder.item().of(Items.HONEYCOMB))).save(consumer, "husbandry/wax_on");
        Advancement.Builder.advancement().parent(advancement9).display(Items.STONE_AXE, (Component)new TranslatableComponent("advancements.husbandry.wax_off.title"), (Component)new TranslatableComponent("advancements.husbandry.wax_off.description"), null, FrameType.TASK, true, true, false).addCriterion("wax_off", ItemInteractWithBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(HoneycombItem.WAX_OFF_BY_BLOCK.get().keySet()).build()), ItemPredicate.Builder.item().of(WAX_SCRAPING_TOOLS))).save(consumer, "husbandry/wax_off");
        Advancement advancement10 = Advancement.Builder.advancement().parent(advancement).addCriterion(Registry.ITEM.getKey(Items.TADPOLE_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(Items.TADPOLE_BUCKET).build())).display(Items.TADPOLE_BUCKET, (Component)new TranslatableComponent("advancements.husbandry.tadpole_in_a_bucket.title"), (Component)new TranslatableComponent("advancements.husbandry.tadpole_in_a_bucket.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/tadpole_in_a_bucket");
        Advancement.Builder.advancement().parent(advancement10).display(Items.VERDANT_FROGLIGHT, (Component)new TranslatableComponent("advancements.husbandry.froglights.title"), (Component)new TranslatableComponent("advancements.husbandry.froglights.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("froglights", InventoryChangeTrigger.TriggerInstance.hasItems(Items.OCHRE_FROGLIGHT, Items.PEARLESCENT_FROGLIGHT, Items.VERDANT_FROGLIGHT)).save(consumer, "husbandry/froglights");
        ...
        Advancement.Builder.advancement().parent(advancement).display(Items.OAK_BOAT, (Component)new TranslatableComponent("advancements.husbandry.ride_a_boat_with_a_goat.title"), (Component)new TranslatableComponent("advancements.husbandry.ride_a_boat_with_a_goat.description"), null, FrameType.TASK, true, true, false).addCriterion("ride_a_boat_with_a_goat", StartRidingTrigger.TriggerInstance.playerStartsRiding(EntityPredicate.Builder.entity().vehicle(EntityPredicate.Builder.entity().of(EntityType.BOAT).passenger(EntityPredicate.Builder.entity().of(EntityType.GOAT).build()).build()))).save(consumer, "husbandry/ride_a_boat_with_a_goat");
        Advancement.Builder.advancement().parent(advancement).display(Items.GLOW_INK_SAC, (Component)new TranslatableComponent("advancements.husbandry.make_a_sign_glow.title"), (Component)new TranslatableComponent("advancements.husbandry.make_a_sign_glow.description"), null, FrameType.TASK, true, true, false).addCriterion("make_a_sign_glow", ItemInteractWithBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(BlockTags.SIGNS).build()), ItemPredicate.Builder.item().of(Items.GLOW_INK_SAC))).save(consumer, "husbandry/make_a_sign_glow");
        Advancement advancement11 = Advancement.Builder.advancement().parent(advancement).display(Items.COOKIE, (Component)new TranslatableComponent("advancements.husbandry.allay_deliver_item_to_player.title"), (Component)new TranslatableComponent("advancements.husbandry.allay_deliver_item_to_player.description"), null, FrameType.TASK, true, true, true).addCriterion("allay_deliver_item_to_player", PlayerTrigger.TriggerInstance.itemDeliveredToPlayer()).save(consumer, "husbandry/allay_deliver_item_to_player");
        Advancement.Builder.advancement().parent(advancement11).display(Items.NOTE_BLOCK, (Component)new TranslatableComponent("advancements.husbandry.allay_deliver_cake_to_noteblock.title"), (Component)new TranslatableComponent("advancements.husbandry.allay_deliver_cake_to_noteblock.description"), null, FrameType.CHALLENGE, true, true, true).addCriterion("allay_deliver_cake_to_noteblock", ItemInteractWithBlockTrigger.TriggerInstance.allayDropItemOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(Blocks.NOTE_BLOCK).build()), ItemPredicate.Builder.item().of(Items.CAKE))).save(consumer, "husbandry/allay_deliver_cake_to_noteblock");
    }
