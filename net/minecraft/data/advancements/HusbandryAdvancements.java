...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        Advancement advancement = Advancement.Builder.advancement().display(Blocks.HAY_BLOCK, (Component)new TranslatableComponent("advancements.husbandry.root.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.root.description", new Object[0]), new ResourceLocation("textures/gui/advancements/backgrounds/husbandry.png"), FrameType.TASK, false, false, false).addCriterion("consumed_item", ConsumeItemTrigger.TriggerInstance.usedItem()).save(consumer, "husbandry/root");
        Advancement advancement2 = Advancement.Builder.advancement().parent(advancement).display(Items.WHEAT, (Component)new TranslatableComponent("advancements.husbandry.plant_seed.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.plant_seed.description", new Object[0]), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).addCriterion("wheat", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.WHEAT)).addCriterion("pumpkin_stem", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.PUMPKIN_STEM)).addCriterion("melon_stem", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.MELON_STEM)).addCriterion("beetroots", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.BEETROOTS)).addCriterion("nether_wart", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.NETHER_WART)).save(consumer, "husbandry/plant_seed");
        Advancement advancement3 = Advancement.Builder.advancement().parent(advancement).display(Items.WHEAT, (Component)new TranslatableComponent("advancements.husbandry.breed_an_animal.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.breed_an_animal.description", new Object[0]), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).addCriterion("bred", BredAnimalsTrigger.TriggerInstance.bredAnimals()).save(consumer, "husbandry/breed_an_animal");
        Advancement advancement4 = this.addFood(Advancement.Builder.advancement()).parent(advancement2).display(Items.APPLE, (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.description", new Object[0]), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(consumer, "husbandry/balanced_diet");
        Advancement advancement5 = Advancement.Builder.advancement().parent(advancement2).display(Items.DIAMOND_HOE, (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.description", new Object[0]), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("broke_hoe", ItemDurabilityTrigger.TriggerInstance.changedDurability(ItemPredicate.Builder.item().of(Items.DIAMOND_HOE).build(), MinMaxBounds.Ints.exactly(0))).save(consumer, "husbandry/break_diamond_hoe");
        Advancement advancement6 = Advancement.Builder.advancement().parent(advancement).display(Items.LEAD, (Component)new TranslatableComponent("advancements.husbandry.tame_an_animal.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.tame_an_animal.description", new Object[0]), null, FrameType.TASK, true, true, false).addCriterion("tamed_animal", TameAnimalTrigger.TriggerInstance.tamedAnimal()).save(consumer, "husbandry/tame_an_animal");
        Advancement advancement7 = this.addBreedable(Advancement.Builder.advancement()).parent(advancement3).display(Items.GOLDEN_CARROT, (Component)new TranslatableComponent("advancements.husbandry.breed_all_animals.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.breed_all_animals.description", new Object[0]), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(consumer, "husbandry/bred_all_animals");
    ...
    private Advancement.Builder addCatVariants(Advancement.Builder builder) {
        Cat.TEXTURE_BY_TYPE.forEach((integer, resourceLocation) -> builder.addCriterion(resourceLocation.getPath(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().of((ResourceLocation)resourceLocation).build())));
        return builder;
    }
