...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement4 = this.addFood(Advancement.Builder.advancement()).parent(advancement2).display(Items.APPLE, (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.title"), (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(consumer, "husbandry/balanced_diet");
        Advancement advancement5 = Advancement.Builder.advancement().parent(advancement2).display(Items.DIAMOND_HOE, (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.title"), (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("broke_hoe", ItemDurabilityTrigger.TriggerInstance.changedDurability(ItemPredicate.Builder.item().of(Items.DIAMOND_HOE).build(), MinMaxBounds.Ints.exactly(0))).save(consumer, "husbandry/break_diamond_hoe");
        ...
        Advancement advancement9 = this.addFishBuckets(Advancement.Builder.advancement()).parent(advancement8).requirements(RequirementsStrategy.OR).display(Items.PUFFERFISH_BUCKET, (Component)new TranslatableComponent("advancements.husbandry.tactical_fishing.title"), (Component)new TranslatableComponent("advancements.husbandry.tactical_fishing.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/tactical_fishing");
        Advancement advancement10 = this.addCatVariants(Advancement.Builder.advancement()).parent(advancement6).display(Items.COD, (Component)new TranslatableComponent("advancements.husbandry.complete_catalogue.title"), (Component)new TranslatableComponent("advancements.husbandry.complete_catalogue.description"), null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(consumer, "husbandry/complete_catalogue");
        Advancement advancement11 = Advancement.Builder.advancement().parent(advancement).addCriterion("safely_harvest_honey", ItemUsedOnBlockTrigger.TriggerInstance.safelyHarvestedHoney(BlockPredicate.Builder.block().of(BlockTags.BEEHIVES), ItemPredicate.Builder.item().of(Items.GLASS_BOTTLE))).display(Items.HONEY_BOTTLE, (Component)new TranslatableComponent("advancements.husbandry.safely_harvest_honey.title"), (Component)new TranslatableComponent("advancements.husbandry.safely_harvest_honey.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/safely_harvest_honey");
