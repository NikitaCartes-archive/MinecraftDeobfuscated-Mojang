...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement9 = Advancement.Builder.advancement().parent(advancement8).display(Items.HONEYCOMB, (Component)new TranslatableComponent("advancements.husbandry.wax_on.title"), (Component)new TranslatableComponent("advancements.husbandry.wax_on.description"), null, FrameType.TASK, true, true, false).addCriterion("wax_on", ItemUsedOnBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(HoneycombItem.WAXABLES.get().keySet()).build()), ItemPredicate.Builder.item().of(Items.HONEYCOMB))).save(consumer, "husbandry/wax_on");
        Advancement.Builder.advancement().parent(advancement9).display(Items.STONE_AXE, (Component)new TranslatableComponent("advancements.husbandry.wax_off.title"), (Component)new TranslatableComponent("advancements.husbandry.wax_off.description"), null, FrameType.TASK, true, true, false).addCriterion("wax_off", ItemUsedOnBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(HoneycombItem.WAX_OFF_BY_BLOCK.get().keySet()).build()), ItemPredicate.Builder.item().of(WAX_SCRAPING_TOOLS))).save(consumer, "husbandry/wax_off");
