...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement11 = this.addLeashedFrogVariants(Advancement.Builder.advancement()).parent(advancement10).display(Items.LEAD, (Component)new TranslatableComponent("advancements.husbandry.leash_all_frog_variants.title"), (Component)new TranslatableComponent("advancements.husbandry.leash_all_frog_variants.description"), null, FrameType.TASK, true, true, false).save(consumer, "husbandry/leash_all_frog_variants");
