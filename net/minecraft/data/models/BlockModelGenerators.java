...
public class BlockModelGenerators {
    ...
    private static BlockStateGenerator createNorthWestMirroredCubeGenerator(Block block, ResourceLocation resourceLocation, TextureMapping textureMapping, BiConsumer<ResourceLocation, Supplier<JsonElement>> biConsumer) {
        ...
        return BlockModelGenerators.createSimpleBlock(block, resourceLocation2);
    }
    ...
    private void createSuspiciousSandBlock() {
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SUSPICIOUS_SAND).with(PropertyDispatch.property(BlockStateProperties.DUSTED).generate(integer -> {
            String string = "_" + integer;
            ResourceLocation resourceLocation = TextureMapping.getBlockTexture(Blocks.SUSPICIOUS_SAND, string);
            return Variant.variant().with(VariantProperties.MODEL, ModelTemplates.CUBE_ALL.createWithSuffix(Blocks.SUSPICIOUS_SAND, string, new TextureMapping().put(TextureSlot.ALL, resourceLocation), this.modelOutput));
        })));
    ...
    static BlockStateGenerator createCustomFence(Block block, ResourceLocation resourceLocation, ResourceLocation resourceLocation2, ResourceLocation resourceLocation3, ResourceLocation resourceLocation4, ResourceLocation resourceLocation5) {
        return MultiPartGenerator.multiPart(block).with(Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with((Condition)Condition.condition().term(BlockStateProperties.NORTH, true), Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.UV_LOCK, false)).with((Condition)Condition.condition().term(BlockStateProperties.EAST, true), Variant.variant().with(VariantProperties.MODEL, resourceLocation3).with(VariantProperties.UV_LOCK, false)).with((Condition)Condition.condition().term(BlockStateProperties.SOUTH, true), Variant.variant().with(VariantProperties.MODEL, resourceLocation4).with(VariantProperties.UV_LOCK, false)).with((Condition)Condition.condition().term(BlockStateProperties.WEST, true), Variant.variant().with(VariantProperties.MODEL, resourceLocation5).with(VariantProperties.UV_LOCK, false));
    }
    ...
    public void createHangingSign(Block block, Block block2, Block block3) {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(block3, resourceLocation));
    ...
    void createDoor(Block block) {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createDoor(block, resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4, resourceLocation5, resourceLocation6, resourceLocation7, resourceLocation8));
    }
    ...
    private void createBigDripLeafBlock() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.BIG_DRIPLEAF).with(BlockModelGenerators.createHorizontalFacingDispatch()).with(PropertyDispatch.property(BlockStateProperties.TILT).select(Tilt.NONE, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(Tilt.UNSTABLE, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(Tilt.PARTIAL, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(Tilt.FULL, Variant.variant().with(VariantProperties.MODEL, resourceLocation3))));
    }
    ...
    private void createCrossBlock(Block block, TintState tintState, Property<Integer> property, int ... is) {
    ...
    private void createFlowerBed(Block block) {
        ...
        this.blockStateOutput.accept(MultiPartGenerator.multiPart(block).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(1), new Integer[]{2, 3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(1), new Integer[]{2, 3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST), Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(1), new Integer[]{2, 3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(1), new Integer[]{2, 3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(2), new Integer[]{3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(2), new Integer[]{3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST), Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(2), new Integer[]{3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(2), new Integer[]{3, 4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(3), new Integer[]{4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation3)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(3), new Integer[]{4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST), Variant.variant().with(VariantProperties.MODEL, resourceLocation3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(3), new Integer[]{4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(3), new Integer[]{4}).term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), Variant.variant().with(VariantProperties.MODEL, resourceLocation3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, 4).term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation4)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, 4).term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST), Variant.variant().with(VariantProperties.MODEL, resourceLocation4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, 4).term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH), Variant.variant().with(VariantProperties.MODEL, resourceLocation4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).with((Condition)Condition.condition().term(BlockStateProperties.FLOWER_AMOUNT, 4).term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), Variant.variant().with(VariantProperties.MODEL, resourceLocation4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)));
    }
    ...
    private void createMuddyMangroveRoots() {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createAxisAlignedPillarBlock(Blocks.MUDDY_MANGROVE_ROOTS, resourceLocation));
    }
    ...
    private void createMangrovePropagule() {
        ...
        for (int i = 0; i <= 4; ++i) {
            ...
            c2.select((Boolean)true, (Integer)i, Variant.variant().with(VariantProperties.MODEL, resourceLocation2));
            c2.select((Boolean)false, (Integer)i, Variant.variant().with(VariantProperties.MODEL, resourceLocation));
        }
    ...
    private void createFrogspawnBlock() {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(Blocks.FROGSPAWN, ModelLocationUtils.getModelLocation(Blocks.FROGSPAWN)));
    }
    ...
    private void createMultiface(Block block) {
        ...
        Condition.TerminalCondition terminalCondition2 = Util.make(Condition.condition(), terminalCondition -> MULTIFACE_GENERATOR.stream().map(Pair::getFirst).forEach(booleanProperty -> {
        ...
        for (Pair<BooleanProperty, Function<ResourceLocation, Variant>> pair : MULTIFACE_GENERATOR) {
            ...
            multiPartGenerator.with((Condition)Condition.condition().term(booleanProperty, true), function.apply(resourceLocation));
            multiPartGenerator.with((Condition)terminalCondition2, function.apply(resourceLocation));
        }
    ...
    private void createSculkCatalyst() {
        ...
        TextureMapping textureMapping2 = new TextureMapping().put(TextureSlot.BOTTOM, resourceLocation).put(TextureSlot.TOP, TextureMapping.getBlockTexture(Blocks.SCULK_CATALYST, "_top_bloom")).put(TextureSlot.SIDE, TextureMapping.getBlockTexture(Blocks.SCULK_CATALYST, "_side_bloom"));
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SCULK_CATALYST).with(PropertyDispatch.property(BlockStateProperties.BLOOM).generate(boolean_ -> Variant.variant().with(VariantProperties.MODEL, boolean_ != false ? resourceLocation3 : resourceLocation2))));
    ...
    private void addSlotStateAndRotationVariants(MultiPartGenerator multiPartGenerator, Condition.TerminalCondition terminalCondition, VariantProperties.Rotation rotation) {
        Map.of(BlockStateProperties.CHISELED_BOOKSHELF_SLOT_0_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_TOP_LEFT, BlockStateProperties.CHISELED_BOOKSHELF_SLOT_1_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_TOP_MID, BlockStateProperties.CHISELED_BOOKSHELF_SLOT_2_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_TOP_RIGHT, BlockStateProperties.CHISELED_BOOKSHELF_SLOT_3_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_BOTTOM_LEFT, BlockStateProperties.CHISELED_BOOKSHELF_SLOT_4_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_BOTTOM_MID, BlockStateProperties.CHISELED_BOOKSHELF_SLOT_5_OCCUPIED, ModelTemplates.CHISELED_BOOKSHELF_SLOT_BOTTOM_RIGHT).forEach((booleanProperty, modelTemplate) -> {
            this.addBookSlotModel(multiPartGenerator, terminalCondition, rotation, (BooleanProperty)booleanProperty, (ModelTemplate)modelTemplate, true);
            this.addBookSlotModel(multiPartGenerator, terminalCondition, rotation, (BooleanProperty)booleanProperty, (ModelTemplate)modelTemplate, false);
        });
    }

    private void addBookSlotModel(MultiPartGenerator multiPartGenerator, Condition.TerminalCondition terminalCondition, VariantProperties.Rotation rotation, BooleanProperty booleanProperty, ModelTemplate modelTemplate, boolean bl) {
        ...
        ResourceLocation resourceLocation = CHISELED_BOOKSHELF_SLOT_MODEL_CACHE.computeIfAbsent(bookSlotModelCacheKey2, bookSlotModelCacheKey -> modelTemplate.createWithSuffix(Blocks.CHISELED_BOOKSHELF, string, textureMapping, this.modelOutput));
    ...
    private void createInfestedDeepslate() {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createRotatedVariant(Blocks.INFESTED_DEEPSLATE, resourceLocation, resourceLocation2).with(BlockModelGenerators.createRotatedPillar()));
    ...
    private void createPetrifiedOakSlab() {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createSlab(block2, resourceLocation2, resourceLocation3, resourceLocation));
    }
    ...
    public void run() {
        ...
        this.createCrossBlock(Blocks.TORCHFLOWER_CROP, TintState.NOT_TINTED, BlockStateProperties.AGE_2, 0, 1, 2);
        ...
        this.createPlant(Blocks.TORCHFLOWER, Blocks.POTTED_TORCHFLOWER, TintState.NOT_TINTED);
        ...
        this.createPlant(Blocks.CHERRY_SAPLING, Blocks.POTTED_CHERRY_SAPLING, TintState.NOT_TINTED);
    ...
    class BlockFamilyProvider {
        ...
        public BlockFamilyProvider customFence(Block block) {
            ...
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createCustomFence(block, resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4, resourceLocation5));
        ...
        public BlockFamilyProvider customFenceGate(Block block) {
            ...
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(block, resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4, false));
            return this;
        }
        ...
        public BlockFamilyProvider fenceGate(Block block) {
            ...
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(block, resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4, true));
            return this;
        }
        ...
        private ResourceLocation getOrCreateModel(ModelTemplate modelTemplate2, Block block) {
