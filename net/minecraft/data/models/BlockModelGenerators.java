...
public class BlockModelGenerators {
    ...
    public void run() {
        ...
        this.family(Blocks.LIGHTLY_WEATHERED_CUT_COPPER).generateFor(BlockFamilies.LIGHTLY_WEATHERED_CUT_COPPER).fullBlockCopies(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER).generateFor(BlockFamilies.WAXED_LIGHTLY_WEATHERED_CUT_COPPER);
        this.family(Blocks.SEMI_WEATHERED_CUT_COPPER).generateFor(BlockFamilies.SEMI_WEATHERED_CUT_COPPER).fullBlockCopies(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER).generateFor(BlockFamilies.WAXED_SEMI_WEATHERED_CUT_COPPER);
    ...
    class BlockFamilyProvider {
        ...
        public BlockFamilyProvider fullBlock(Block block, ModelTemplate modelTemplate) {
            ...
            if (BlockModelGenerators.this.mirroredFullBlocks.contains(block)) {
                ResourceLocation resourceLocation = ModelTemplates.CUBE_MIRRORED_ALL.create(block, this.mapping, (BiConsumer<ResourceLocation, Supplier<JsonElement>>)BlockModelGenerators.this.modelOutput);
        ...
        private ResourceLocation getOrCreateModel(ModelTemplate modelTemplate2, Block block) {
            return this.models.computeIfAbsent(modelTemplate2, modelTemplate -> modelTemplate.create(block, this.mapping, (BiConsumer<ResourceLocation, Supplier<JsonElement>>)BlockModelGenerators.this.modelOutput));
        }
