...
public abstract class PropertyDispatch {
    ...
    extends PropertyDispatch {
        ...
        public C5<T1, T2, T3, T4, T5> select(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, T5 comparable5, List<Variant> list) {
            Selector selector = Selector.of(this.property1.value(comparable), this.property2.value(comparable2), this.property3.value(comparable3), this.property4.value(comparable4), this.property5.value(comparable5));
            this.putValue(selector, list);
            return this;
        }

        public C5<T1, T2, T3, T4, T5> select(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, T5 comparable5, Variant variant) {
    ...
    extends PropertyDispatch {
        ...
        public C4<T1, T2, T3, T4> select(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, List<Variant> list) {
            Selector selector = Selector.of(this.property1.value(comparable), this.property2.value(comparable2), this.property3.value(comparable3), this.property4.value(comparable4));
            this.putValue(selector, list);
            return this;
        }

        public C4<T1, T2, T3, T4> select(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, Variant variant) {
    ...
    extends PropertyDispatch {
        ...
        public C3<T1, T2, T3> select(T1 comparable, T2 comparable2, T3 comparable3, List<Variant> list) {
        ...
        public C3<T1, T2, T3> select(T1 comparable, T2 comparable2, T3 comparable3, Variant variant) {
        ...
        public PropertyDispatch generateList(TriFunction<T1, T2, T3, List<Variant>> triFunction) {
            this.property1.getPossibleValues().forEach(comparable -> this.property2.getPossibleValues().forEach(comparable2 -> this.property3.getPossibleValues().forEach(comparable3 -> this.select(comparable, comparable2, comparable3, (List)triFunction.apply(comparable, comparable2, comparable3)))));
            return this;
        }
    }
    ...
    extends PropertyDispatch {
        ...
        public C2<T1, T2> select(T1 comparable, T2 comparable2, List<Variant> list) {
            Selector selector = Selector.of(this.property1.value(comparable), this.property2.value(comparable2));
            this.putValue(selector, list);
            return this;
        }

        public C2<T1, T2> select(T1 comparable, T2 comparable2, Variant variant) {
    ...
    extends PropertyDispatch {
        ...
        public C1<T1> select(T1 comparable, List<Variant> list) {
            Selector selector = Selector.of(this.property1.value(comparable));
            this.putValue(selector, list);
            return this;
        }

        public C1<T1> select(T1 comparable, Variant variant) {
        ...
        public PropertyDispatch generateList(Function<T1, List<Variant>> function) {
            this.property1.getPossibleValues().forEach(comparable -> this.select(comparable, (List)function.apply(comparable)));
            return this;
        }
    }
}
