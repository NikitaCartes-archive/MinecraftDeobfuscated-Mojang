...
public class CriteriaTriggers {
    ...
    public static final PickedUpItemTrigger THROWN_ITEM_PICKED_UP_BY_ENTITY = CriteriaTriggers.register(new PickedUpItemTrigger(new ResourceLocation("thrown_item_picked_up_by_entity")));
    public static final PickedUpItemTrigger THROWN_ITEM_PICKED_UP_BY_PLAYER = CriteriaTriggers.register(new PickedUpItemTrigger(new ResourceLocation("thrown_item_picked_up_by_player")));
    ...
    public static final PlayerTrigger AVOID_VIBRATION = CriteriaTriggers.register(new PlayerTrigger(new ResourceLocation("avoid_vibration")));
