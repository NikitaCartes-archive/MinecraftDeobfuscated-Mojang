...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    extends AbstractCriterionTriggerInstance {
        ...
        public static TriggerInstance lookingAt(EntityPredicate.Builder builder, ItemPredicate.Builder builder2) {
            return new TriggerInstance(EntityPredicate.Composite.wrap(builder.build()), builder2.build());
        }
