...
public class LocationPredicate {
    ...
    public LocationPredicate(MinMaxBounds.Floats floats, MinMaxBounds.Floats floats2, MinMaxBounds.Floats floats3, @Nullable Biome biome, @Nullable StructureFeature<?> structureFeature, @Nullable DimensionType dimensionType, @Nullable Boolean boolean_, LightPredicate lightPredicate, BlockPredicate blockPredicate, FluidPredicate fluidPredicate) {
        this.x = floats;
        this.y = floats2;
        this.z = floats3;
        this.biome = biome;
    ...
    public static LocationPredicate inDimension(DimensionType dimensionType) {
        return new LocationPredicate(MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, null, null, dimensionType, null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }
    ...
    public boolean matches(ServerLevel serverLevel, float f, float g, float h) {
        ...
        if (this.dimension != null && this.dimension != serverLevel.dimensionType()) {
            return false;
        }
