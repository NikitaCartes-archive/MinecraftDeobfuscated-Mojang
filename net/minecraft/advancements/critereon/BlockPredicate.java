    ...
    public static BlockPredicate fromJson(@Nullable JsonElement jsonElement) {
        ...
        if (jsonArray != null) {
            ...
            for (JsonElement jsonElement2 : jsonArray) {
                ...
                builder.add((Block)BuiltInRegistries.BLOCK.getOptional(resourceLocation).orElseThrow(() -> new JsonSyntaxException("Unknown block id '" + resourceLocation + "'")));
            }
            set = builder.build();
        }
        ...
        if (jsonObject.has("tag")) {
            ...
            tagKey = TagKey.create(Registries.BLOCK, resourceLocation2);
        }
