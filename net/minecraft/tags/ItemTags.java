...
public final class ItemTags {
    ...
    public static final Tag.Named<Item> IGNORED_BY_PIGLIN_BABIES = ItemTags.bind("ignored_by_piglin_babies");
    ...
    public static final Tag.Named<Item> COAL_ORES = ItemTags.bind("coal_ores");
    public static final Tag.Named<Item> EMERALD_ORES = ItemTags.bind("emerald_ores");
    public static final Tag.Named<Item> COPPER_ORES = ItemTags.bind("copper_ores");
    ...
    public static final Tag.Named<Item> FREEZE_IMMUNE_WEARABLES = ItemTags.bind("freeze_immune_wearables");
    public static final Tag.Named<Item> AXOLOTL_TEMPT_ITEMS = ItemTags.bind("axolotl_tempt_items");
