...
public class ItemTags {
    ...
    static {
        ...
        LOGS_THAT_BURN = ItemTags.bind("logs_that_burn");
        ...
        PIGLIN_REPELLENTS = ItemTags.bind("piglin_repellents");
        GOLD_ORES = ItemTags.bind("gold_ores");
        NON_FLAMMABLE_WOOD = ItemTags.bind("non_flammable_wood");
