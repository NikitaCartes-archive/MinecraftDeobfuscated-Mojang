...
public class SerializationTags {
    private static volatile SerializationTags instance = new SerializationTags(BlockTags.getAllTags(), ItemTags.getAllTags(), FluidTags.getAllTags(), EntityTypeTags.getAllTags());
    ...
    private SerializationTags(TagCollection<Block> tagCollection, TagCollection<Item> tagCollection2, TagCollection<Fluid> tagCollection3, TagCollection<EntityType<?>> tagCollection4) {
    ...
    public static void bind(TagCollection<Block> tagCollection, TagCollection<Item> tagCollection2, TagCollection<Fluid> tagCollection3, TagCollection<EntityType<?>> tagCollection4) {
