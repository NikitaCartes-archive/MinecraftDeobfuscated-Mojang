...
public class AssetIndex {
    ...
    public Collection<ResourceLocation> getFiles(String string, String string2, Predicate<ResourceLocation> predicate) {
        return this.namespacedFiles.keySet().stream().filter(resourceLocation -> {
            ...
            return resourceLocation.getNamespace().equals(string2) && !string3.endsWith(".mcmeta") && string3.startsWith(string + "/") && predicate.test((ResourceLocation)resourceLocation);
