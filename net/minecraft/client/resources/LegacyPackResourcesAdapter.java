...
public class LegacyPackResourcesAdapter
implements PackResources {
    ...
    public static final Map<ResourceLocation, ResourceLocation> V3 = Util.make(() -> {
        ...
        BiConsumer<String, String> biConsumer = (string, string2) -> {
            ResourceLocation resourceLocation = new ResourceLocation((String)string);
            ResourceLocation resourceLocation2 = new ResourceLocation((String)string2);
            builder.put(resourceLocation, resourceLocation2);
            builder.put(LegacyPackResourcesAdapter.toMetaLocation(resourceLocation), LegacyPackResourcesAdapter.toMetaLocation(resourceLocation2));
        };
    ...
    private ResourceLocation map(ResourceLocation resourceLocation) {
        return this.patches.getOrDefault(resourceLocation, resourceLocation);
    }
