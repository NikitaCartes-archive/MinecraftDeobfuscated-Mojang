...
extends Option {
    ...
    public ProgressOption(String string, double d, double e, float f, Function<Options, Double> function, BiConsumer<Options, Double> biConsumer, BiFunction<Options, ProgressOption, Component> biFunction, Function<Minecraft, Option.TooltipSupplier<Double>> function2) {
        super(string);
        this.minValue = d;
        this.maxValue = e;
        this.steps = f;
    ...
    public AbstractWidget createButton(Options options, int i, int j, int k) {
        Option.TooltipSupplier<Double> tooltipSupplier = this.tooltipSupplier.apply(Minecraft.getInstance());
