...
extends RaftModel {
    ...
    public static LayerDefinition createBodyModel() {
        ...
        partDefinition.addOrReplaceChild(CHEST_BOTTOM, CubeListBuilder.create().texOffs(0, 76).addBox(0.0f, 0.0f, 0.0f, 12.0f, 8.0f, 12.0f), PartPose.offsetAndRotation(-2.0f, -11.0f, -6.0f, 0.0f, -1.5707964f, 0.0f));
        partDefinition.addOrReplaceChild(CHEST_LID, CubeListBuilder.create().texOffs(0, 59).addBox(0.0f, 0.0f, 0.0f, 12.0f, 4.0f, 12.0f), PartPose.offsetAndRotation(-2.0f, -15.0f, -6.0f, 0.0f, -1.5707964f, 0.0f));
        partDefinition.addOrReplaceChild(CHEST_LOCK, CubeListBuilder.create().texOffs(0, 59).addBox(0.0f, 0.0f, 0.0f, 2.0f, 4.0f, 1.0f), PartPose.offsetAndRotation(-1.0f, -12.0f, -1.0f, 0.0f, -1.5707964f, 0.0f));
