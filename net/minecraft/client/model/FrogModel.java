...
extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partDefinition6.addOrReplaceChild("tongue_r1", CubeListBuilder.create().texOffs(24, 13).addBox(-2.0f, -7.0f, 0.1f, 4.0f, 7.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 0.0f, 0.0f, 1.5708f, 0.0f, 0.0f));
        ...
        partDefinition7.addOrReplaceChild("left_hand", CubeListBuilder.create().texOffs(18, 40).addBox(-4.0f, 0.0f, -4.0f, 8.0f, 0.0f, 8.0f), PartPose.offset(0.0f, 3.0f, -1.0f));
        ...
        partDefinition8.addOrReplaceChild("right_hand", CubeListBuilder.create().texOffs(2, 40).addBox(-4.0f, 3.0f, -5.0f, 8.0f, 0.0f, 8.0f), PartPose.offset(0.0f, 0.0f, 0.0f));
        ...
        partDefinition9.addOrReplaceChild("left_foot", CubeListBuilder.create().texOffs(2, 32).addBox(-4.0f, 0.0f, -4.0f, 8.0f, 0.0f, 8.0f), PartPose.offset(2.0f, 3.0f, 0.0f));
        ...
        partDefinition10.addOrReplaceChild("right_foot", CubeListBuilder.create().texOffs(18, 32).addBox(-4.0f, 0.0f, -4.0f, 8.0f, 0.0f, 8.0f), PartPose.offset(-2.0f, 3.0f, 0.0f));
    ...
    public void setupAnim(T frog, float f, float g, float h, float i, float j) {
        ...
        this.animate(((Frog)frog).jumpAnimationState, FrogAnimation.FROG_JUMP, l);
        this.animate(((Frog)frog).croakAnimationState, FrogAnimation.FROG_CROAK, l);
        this.animate(((Frog)frog).tongueAnimationState, FrogAnimation.FROG_TONGUE, l);
        this.animate(((Frog)frog).walkAnimationState, FrogAnimation.FROG_WALK, l);
        this.animate(((Frog)frog).swimAnimationState, FrogAnimation.FROG_SWIM, l);
        this.animate(((Frog)frog).swimIdleAnimationState, FrogAnimation.FROG_IDLE_WATER, l);
    }

    private void animate(AnimationState animationState2, AnimationDefinition animationDefinition, long l) {
