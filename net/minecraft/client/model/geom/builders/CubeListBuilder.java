...
public class CubeListBuilder {
    ...
    public CubeListBuilder addBox(String string, float f, float g, float h, int i, int j, int k, CubeDeformation cubeDeformation, int l, int m) {
        this.texOffs(l, m);
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, cubeDeformation, this.mirror, 1.0f, 1.0f));
        return this;
    }

    public CubeListBuilder addBox(String string, float f, float g, float h, int i, int j, int k, int l, int m) {
        this.texOffs(l, m);
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, CubeDeformation.NONE, this.mirror, 1.0f, 1.0f));
        return this;
    }

    public CubeListBuilder addBox(float f, float g, float h, float i, float j, float k) {
        this.cubes.add(new CubeDefinition(null, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, CubeDeformation.NONE, this.mirror, 1.0f, 1.0f));
        return this;
    }
    ...
    public CubeListBuilder addBox(float f, float g, float h, float i, float j, float k, boolean bl) {
        this.cubes.add(new CubeDefinition(null, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, CubeDeformation.NONE, bl, 1.0f, 1.0f));
        return this;
    }
    ...
    public CubeListBuilder addBox(float f, float g, float h, float i, float j, float k, CubeDeformation cubeDeformation, float l, float m) {
        this.cubes.add(new CubeDefinition(null, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, cubeDeformation, this.mirror, l, m));
        return this;
    }

    public CubeListBuilder addBox(float f, float g, float h, float i, float j, float k, CubeDeformation cubeDeformation) {
        this.cubes.add(new CubeDefinition(null, this.xTexOffs, this.yTexOffs, f, g, h, i, j, k, cubeDeformation, this.mirror, 1.0f, 1.0f));
        return this;
    }
