...
public class Cube {
    ...
    public Cube(ModelPart modelPart, int i, int j, float f, float g, float h, int k, int l, int m, float n, boolean bl) {
        ...
        this.polygons[0] = new Polygon(new Vertex[]{vertex6, vertex2, vertex3, vertex7}, i + m + k, j + m, i + m + k + m, j + m + l, modelPart.xTexSize, modelPart.yTexSize);
        ...
        this.polygons[5] = new Polygon(new Vertex[]{vertex5, vertex6, vertex7, vertex8}, i + m + k + m, j + m, i + m + k + m + k, j + m + l, modelPart.xTexSize, modelPart.yTexSize);
        if (bl) {
