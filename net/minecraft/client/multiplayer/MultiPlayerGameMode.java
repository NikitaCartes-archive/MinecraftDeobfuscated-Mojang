...
public class MultiPlayerGameMode {
    ...
    private boolean sameDestroyTarget(BlockPos blockPos) {
        ...
        if (!this.destroyingItem.isEmpty() && !itemStack.isEmpty()) {
            bl = itemStack.is(this.destroyingItem.getItem()) && ItemStack.tagMatches(itemStack, this.destroyingItem) && (itemStack.isDamageableItem() || itemStack.getDamageValue() == this.destroyingItem.getDamageValue());
        }
    ...
    public InteractionResult useItemOn(LocalPlayer localPlayer, InteractionHand interactionHand, BlockHitResult blockHitResult) {
        ...
        return (InteractionResult)((Object)mutableObject.getValue());
    }
