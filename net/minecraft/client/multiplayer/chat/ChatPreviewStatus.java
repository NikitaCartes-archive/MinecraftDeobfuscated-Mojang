...
public enum ChatPreviewStatus implements OptionEnum
{
    ...
    private static final ChatPreviewStatus[] BY_ID;
    ...
    static {
        BY_ID = (ChatPreviewStatus[])Arrays.stream(ChatPreviewStatus.values()).sorted(Comparator.comparingInt(ChatPreviewStatus::getId)).toArray(ChatPreviewStatus[]::new);
    }
}
