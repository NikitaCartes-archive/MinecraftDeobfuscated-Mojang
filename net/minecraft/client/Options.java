...
public class Options {
    ...
    private final OptionInstance<Double> entityDistanceScaling = new OptionInstance<Double>("options.entityDistanceScaling", OptionInstance.noTooltip(), Options::percentValueLabel, new OptionInstance.IntRange(2, 20).xmap(i -> (double)i / 4.0, double_ -> (int)(double_ * 4.0)), Codec.doubleRange(0.5, 5.0), 1.0, double_ -> {});
    ...
    private final OptionInstance<Double> glintSpeed = new OptionInstance<Double>("options.glintSpeed", OptionInstance.cachedConstantTooltip(ACCESSIBILITY_TOOLTIP_GLINT_SPEED), (component, double_) -> {
        if (double_ == 0.0) {
            return Options.genericValueLabel(component, CommonComponents.OPTION_OFF);
        }
        return Options.percentValueLabel(component, double_);
    ...
    private final OptionInstance<Double> glintStrength = new OptionInstance<Double>("options.glintStrength", OptionInstance.cachedConstantTooltip(ACCESSIBILITY_TOOLTIP_GLINT_STRENGTH), (component, double_) -> {
        if (double_ == 0.0) {
            return Options.genericValueLabel(component, CommonComponents.OPTION_OFF);
        }
        return Options.percentValueLabel(component, double_);
    ...
    private OptionInstance<Double> createSoundSliderOptionInstance(String string, SoundSource soundSource) {
        return new OptionInstance<Double>(string, OptionInstance.noTooltip(), (component, double_) -> {
            if (double_ == 0.0) {
                return Options.genericValueLabel(component, CommonComponents.OPTION_OFF);
            }
            return Options.percentValueLabel(component, double_);
        }, OptionInstance.UnitDouble.INSTANCE, 1.0, double_ -> Minecraft.getInstance().getSoundManager().updateSourceVolume(soundSource, double_.floatValue()));
    }
