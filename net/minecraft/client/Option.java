...
public abstract class Option {
    ...
    public static final ProgressOption FOV_EFFECTS_SCALE = new ProgressOption("options.fovEffectScale", 0.0, 1.0, 0.0f, options -> Math.pow(options.fovEffectScale, 2.0), (options, double_) -> {
        ...
        return progressOption.percentValueLabel(d);
    }, minecraft -> double_ -> minecraft.font.split(ACCESSIBILITY_TOOLTIP_FOV_EFFECT, 200));
    ...
    public static final ProgressOption SCREEN_EFFECTS_SCALE = new ProgressOption("options.screenEffectScale", 0.0, 1.0, 0.0f, options -> options.screenEffectScale, (options, double_) -> {
        ...
        return progressOption.percentValueLabel(d);
    }, minecraft -> double_ -> minecraft.font.split(ACCESSIBILITY_TOOLTIP_SCREEN_EFFECT, 200));
    ...
    public static final ProgressOption RENDER_DISTANCE = new ProgressOption("options.renderDistance", 2.0, 16.0, 1.0f, options -> options.renderDistance, (options, double_) -> {
        options.renderDistance = double_.intValue();
    ...
    public static final ProgressOption ENTITY_DISTANCE_SCALING = new ProgressOption("options.entityDistanceScaling", 0.5, 5.0, 0.25f, options -> options.entityDistanceScaling, (options, double_) -> {
        options.entityDistanceScaling = (float)double_.doubleValue();
    }, (options, progressOption) -> {
        double d = progressOption.get((Options)options);
        return progressOption.percentValueLabel(d);
    });
    ...
    public static final CycleOption<Boolean> AUTO_JUMP = CycleOption.createOnOff("options.autoJump", options -> options.autoJump, (options, option, boolean_) -> {
        options.autoJump = boolean_;
    });
    public static final CycleOption<Boolean> AUTO_SUGGESTIONS = CycleOption.createOnOff("options.autoSuggestCommands", options -> options.autoSuggestions, (options, option, boolean_) -> {
        options.autoSuggestions = boolean_;
    });
    public static final CycleOption<Boolean> CHAT_COLOR = CycleOption.createOnOff("options.chat.color", options -> options.chatColors, (options, option, boolean_) -> {
        options.chatColors = boolean_;
    });
    public static final CycleOption<Boolean> HIDE_MATCHED_NAMES = CycleOption.createOnOff("options.hideMatchedNames", CHAT_TOOLTIP_HIDE_MATCHED_NAMES, options -> options.hideMatchedNames, (options, option, boolean_) -> {
        options.hideMatchedNames = boolean_;
    });
    public static final CycleOption<Boolean> CHAT_LINKS = CycleOption.createOnOff("options.chat.links", options -> options.chatLinks, (options, option, boolean_) -> {
        options.chatLinks = boolean_;
    });
    public static final CycleOption<Boolean> CHAT_LINKS_PROMPT = CycleOption.createOnOff("options.chat.links.prompt", options -> options.chatLinksPrompt, (options, option, boolean_) -> {
        options.chatLinksPrompt = boolean_;
    });
    public static final CycleOption<Boolean> DISCRETE_MOUSE_SCROLL = CycleOption.createOnOff("options.discrete_mouse_scroll", options -> options.discreteMouseScroll, (options, option, boolean_) -> {
        options.discreteMouseScroll = boolean_;
    });
    public static final CycleOption<Boolean> ENABLE_VSYNC = CycleOption.createOnOff("options.vsync", options -> options.enableVsync, (options, option, boolean_) -> {
        options.enableVsync = boolean_;
        if (Minecraft.getInstance().getWindow() != null) {
            Minecraft.getInstance().getWindow().updateVsync(options.enableVsync);
        }
    });
    public static final CycleOption<Boolean> ENTITY_SHADOWS = CycleOption.createOnOff("options.entityShadows", options -> options.entityShadows, (options, option, boolean_) -> {
        options.entityShadows = boolean_;
    });
    public static final CycleOption<Boolean> FORCE_UNICODE_FONT = CycleOption.createOnOff("options.forceUnicodeFont", options -> options.forceUnicodeFont, (options, option, boolean_) -> {
    ...
    public static final CycleOption<Boolean> SHOW_SUBTITLES = CycleOption.createOnOff("options.showSubtitles", options -> options.showSubtitles, (options, option, boolean_) -> {
    ...
    public static final CycleOption<Boolean> DIRECTIONAL_AUDIO = CycleOption.createOnOff("options.directionalAudio", options -> options.directionalAudio, (options, option, boolean_) -> {
        options.directionalAudio = boolean_;
        SoundManager soundManager = Minecraft.getInstance().getSoundManager();
        soundManager.reload();
        soundManager.play(SimpleSoundInstance.forUI(SoundEvents.UI_BUTTON_CLICK, 1.0f));
    }).setTooltip(minecraft -> boolean_ -> boolean_ != false ? minecraft.font.split(DIRECTIONAL_AUDIO_TOOLTIP_ON, 200) : minecraft.font.split(DIRECTIONAL_AUDIO_TOOLTIP_OFF, 200));
    ...
    public static final CycleOption<Boolean> TOGGLE_CROUCH = CycleOption.createBinaryOption("key.sneak", MOVEMENT_TOGGLE, MOVEMENT_HOLD, options -> options.toggleCrouch, (options, option, boolean_) -> {
        options.toggleCrouch = boolean_;
    });
    public static final CycleOption<Boolean> TOGGLE_SPRINT = CycleOption.createBinaryOption("key.sprint", MOVEMENT_TOGGLE, MOVEMENT_HOLD, options -> options.toggleSprint, (options, option, boolean_) -> {
        options.toggleSprint = boolean_;
    });
    public static final CycleOption<Boolean> TOUCHSCREEN = CycleOption.createOnOff("options.touchscreen", options -> options.touchscreen, (options, option, boolean_) -> {
        options.touchscreen = boolean_;
    });
    public static final CycleOption<Boolean> USE_FULLSCREEN = CycleOption.createOnOff("options.fullscreen", options -> options.fullscreen, (options, option, boolean_) -> {
