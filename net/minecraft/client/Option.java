...
public abstract class Option {
    ...
    public static final CycleOption GUI_SCALE = new CycleOption("options.guiScale", (options, integer) -> {
        options.guiScale = Integer.remainderUnsigned(options.guiScale + integer, Minecraft.getInstance().window.calculateScale(0, Minecraft.getInstance().isEnforceUnicode()) + 1);
