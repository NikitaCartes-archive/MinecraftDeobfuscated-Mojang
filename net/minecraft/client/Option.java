...
public abstract class Option {
    ...
    public static final CycleOption<Boolean> RAW_MOUSE_INPUT = CycleOption.createOnOff("options.rawMouseInput", options -> options.rawMouseInput, (options, option, boolean_) -> {
    ...
    }).setTooltip(minecraft -> prioritizeChunkUpdates -> switch (prioritizeChunkUpdates) {
