...
public class ItemColors {
    ...
    public static ItemColors createDefault(BlockColors blockColors) {
        ...
        itemColors.register((itemStack, i) -> i > 0 ? -1 : ((DyeableLeatherItem)((Object)itemStack.getItem())).getColor(itemStack), Items.LEATHER_HELMET, Items.LEATHER_CHESTPLATE, Items.LEATHER_LEGGINGS, Items.LEATHER_BOOTS, Items.LEATHER_HORSE_ARMOR);
