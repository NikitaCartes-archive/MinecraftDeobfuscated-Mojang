...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new OptionButton(this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), 150, 20, Option.MAIN_HAND, Option.MAIN_HAND.getMessage(this.minecraft.options), button -> {
    ...
    private String getMessage(PlayerModelPart playerModelPart) {
        String string = this.minecraft.options.getModelParts().contains((Object)playerModelPart) ? I18n.get("options.on", new Object[0]) : I18n.get("options.off", new Object[0]);
