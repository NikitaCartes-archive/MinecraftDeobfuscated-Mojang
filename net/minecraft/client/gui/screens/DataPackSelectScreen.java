...
extends PackSelectionScreen {
    ...
    public DataPackSelectScreen(Screen screen, PackRepository<Pack> packRepository, Consumer<PackRepository<Pack>> consumer, File file) {
        super(screen, new TranslatableComponent("dataPack.title"), (Runnable runnable) -> new PackSelectionModel<Pack>((Runnable)runnable, (pack, textureManager) -> textureManager.bind(DEFAULT_ICON), packRepository, consumer), file);
    }
}
