...
extends Screen {
    ...
    protected void init() {
        ...
        this.nameEdit = new EditBox(this.font, this.width / 2 - 152, 60, 300, 20, I18n.get("jigsaw_block.name", new Object[0]));
        ...
        this.targetEdit = new EditBox(this.font, this.width / 2 - 152, 100, 300, 20, I18n.get("jigsaw_block.target", new Object[0]));
        ...
        this.finalStateEdit = new EditBox(this.font, this.width / 2 - 152, 140, 300, 20, I18n.get("jigsaw_block.final_state", new Object[0]));
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawString(this.font, I18n.get("jigsaw_block.name", new Object[0]), this.width / 2 - 153, 50, 0xA0A0A0);
        this.nameEdit.render(i, j, f);
        this.drawString(this.font, I18n.get("jigsaw_block.target", new Object[0]), this.width / 2 - 153, 90, 0xA0A0A0);
        this.targetEdit.render(i, j, f);
        this.drawString(this.font, I18n.get("jigsaw_block.final_state", new Object[0]), this.width / 2 - 153, 130, 0xA0A0A0);
        this.finalStateEdit.render(i, j, f);
        if (JigsawBlock.getFrontFacing(this.jigsawEntity.getBlockState()).getAxis().isVertical()) {
            this.drawString(this.font, I18n.get("jigsaw_block.joint_label", new Object[0]), this.width / 2 - 153, 176, 0xFFFFFF);
        }
        super.render(i, j, f);
    }
}
