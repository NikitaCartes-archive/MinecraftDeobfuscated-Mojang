...
extends Screen {
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawString(this.font, I18n.get("jigsaw_block.target_pool", new Object[0]), this.width / 2 - 153, 30, 0xA0A0A0);
        this.targetPoolEdit.render(i, j, f);
        this.drawString(this.font, I18n.get("jigsaw_block.attachement_type", new Object[0]), this.width / 2 - 153, 70, 0xA0A0A0);
        this.attachementTypeEdit.render(i, j, f);
        this.drawString(this.font, I18n.get("jigsaw_block.final_state", new Object[0]), this.width / 2 - 153, 110, 0xA0A0A0);
