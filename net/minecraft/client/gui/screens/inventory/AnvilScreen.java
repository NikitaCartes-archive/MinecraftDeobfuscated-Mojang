...
extends ItemCombinerScreen<AnvilMenu> {
    ...
    protected void renderBg(PoseStack poseStack, float f, int i, int j) {
        ...
        AnvilScreen.blit(poseStack, this.leftPos + 59, this.topPos + 20, 0, this.imageHeight + (((AnvilMenu)this.menu).getSlot(0).hasItem() ? 0 : 16), 110, 16);
    }
    ...
    protected void renderErrorIcon(PoseStack poseStack, int i, int j) {
        if ((((AnvilMenu)this.menu).getSlot(0).hasItem() || ((AnvilMenu)this.menu).getSlot(1).hasItem()) && !((AnvilMenu)this.menu).getSlot(((AnvilMenu)this.menu).getResultSlot()).hasItem()) {
            AnvilScreen.blit(poseStack, i + 99, j + 45, this.imageWidth, 0, 28, 21);
        }
    }
