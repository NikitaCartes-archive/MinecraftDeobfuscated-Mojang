...
extends AbstractContainerScreen<EnchantmentMenu> {
    ...
    protected void renderLabels(PoseStack poseStack, int i, int j) {
        this.font.draw(poseStack, this.title, 12.0f, 5.0f, 0x404040);
    ...
    protected void renderBg(PoseStack poseStack, float f, int i, int j) {
        ...
        BOOK_MODEL.renderToBuffer(poseStack, vertexConsumer, 0xF000F0, OverlayTexture.NO_OVERLAY, 1.0f, 1.0f, 1.0f, 1.0f);
        ...
        for (int r = 0; r < 3; ++r) {
            ...
            MutableComponent component = EnchantmentNames.getInstance().getRandomName(this.font, v);
            int w = 6839882;
            if (!(q >= r + 1 && this.minecraft.player.experienceLevel >= u || this.minecraft.player.abilities.instabuild)) {
                ...
                this.font.drawWordWrap(component, t, l + 16 + 19 * r, v, (w & 0xFEFEFE) >> 1);
                w = 4226832;
            } else {
                int x = i - (k + 60);
                int y = j - (l + 14 + 19 * r);
