...
extends Screen {
    ...
    protected void init() {
        ...
        this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, I18n.get("gui.done", new Object[0]), button -> this.onDone()));
        this.cancelButton = this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, I18n.get("gui.cancel", new Object[0]), button -> this.onCancel()));
        this.saveButton = this.addButton(new Button(this.width / 2 + 4 + 100, 185, 50, 20, I18n.get("structure_block.button.save", new Object[0]), button -> {
            if (this.structure.getMode() == StructureMode.SAVE) {
                this.sendToServer(StructureBlockEntity.UpdateType.SAVE_AREA);
                this.minecraft.setScreen(null);
            }
        }));
        this.loadButton = this.addButton(new Button(this.width / 2 + 4 + 100, 185, 50, 20, I18n.get("structure_block.button.load", new Object[0]), button -> {
        ...
        this.detectButton = this.addButton(new Button(this.width / 2 + 4 + 100, 120, 50, 20, I18n.get("structure_block.button.detect_size", new Object[0]), button -> {
            if (this.structure.getMode() == StructureMode.SAVE) {
    ...
    private void updateEntitiesButton() {
        boolean bl;
        boolean bl2 = bl = !this.structure.isIgnoreEntities();
        if (bl) {
    ...
    public void render(int i, int j, float f) {
        ...
        if (structureMode != StructureMode.DATA) {
            this.drawString(this.font, I18n.get("structure_block.structure_name", new Object[0]), this.width / 2 - 153, 30, 0xA0A0A0);
            this.nameEdit.render(i, j, f);
        }
        if (structureMode == StructureMode.LOAD || structureMode == StructureMode.SAVE) {
            this.drawString(this.font, I18n.get("structure_block.position", new Object[0]), this.width / 2 - 153, 70, 0xA0A0A0);
            ...
            this.drawString(this.font, string, this.width / 2 + 154 - k, 150, 0xA0A0A0);
        }
        if (structureMode == StructureMode.SAVE) {
            this.drawString(this.font, I18n.get("structure_block.size", new Object[0]), this.width / 2 - 153, 110, 0xA0A0A0);
            ...
            k = this.font.width(string);
            this.drawString(this.font, string, this.width / 2 + 154 - k, 110, 0xA0A0A0);
            String string2 = I18n.get("structure_block.show_air", new Object[0]);
            int l = this.font.width(string2);
            this.drawString(this.font, string2, this.width / 2 + 154 - l, 70, 0xA0A0A0);
        }
        if (structureMode == StructureMode.LOAD) {
            this.drawString(this.font, I18n.get("structure_block.integrity", new Object[0]), this.width / 2 - 153, 110, 0xA0A0A0);
            this.integrityEdit.render(i, j, f);
            this.seedEdit.render(i, j, f);
            string = I18n.get("structure_block.show_boundingbox", new Object[0]);
            k = this.font.width(string);
            this.drawString(this.font, string, this.width / 2 + 154 - k, 70, 0xA0A0A0);
        }
        if (structureMode == StructureMode.DATA) {
            this.drawString(this.font, I18n.get("structure_block.custom_data", new Object[0]), this.width / 2 - 153, 110, 0xA0A0A0);
            this.dataEdit.render(i, j, f);
        }
        string = "structure_block.mode_info." + structureMode.getSerializedName();
        this.drawString(this.font, I18n.get(string, new Object[0]), this.width / 2 - 153, 174, 0xA0A0A0);
        super.render(i, j, f);
    }
