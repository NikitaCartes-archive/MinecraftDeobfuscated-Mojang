...
public class RecipeBookPage {
    ...
    public boolean mouseClicked(double d, double e, int i, int j, int k, int l, int m) {
        ...
        if (this.forwardButton.mouseClicked(d, e, i)) {
            ++this.currentPage;
            this.updateButtonsForPage();
            return true;
        }
        if (this.backButton.mouseClicked(d, e, i)) {
            --this.currentPage;
            this.updateButtonsForPage();
            return true;
        }
        for (RecipeButton recipeButton : this.buttons) {
            if (!recipeButton.mouseClicked(d, e, i)) continue;
            if (i == 0) {
                ...
                this.overlay.init(this.minecraft, recipeButton.getCollection(), recipeButton.getX(), recipeButton.getY(), j + l / 2, k + 13 + m / 2, recipeButton.getWidth());
            }
            return true;
        }
        return false;
