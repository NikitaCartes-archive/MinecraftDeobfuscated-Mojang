...
extends Screen {
    ...
    @Override
    protected void init() {
        this.addButton(new Button(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.toTitle", new Object[0]), button -> this.minecraft.setScreen(new TitleScreen())));
        this.addButton(new Button(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, I18n.get("menu.quit", new Object[0]), button -> this.minecraft.stop()));
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.font, this.title.getColoredString(), this.width / 2, this.height / 4 - 60 + 20, 0xFFFFFF);
