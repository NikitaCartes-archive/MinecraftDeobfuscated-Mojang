...
implements SoundEventListener {
    ...
    public void render(PoseStack poseStack) {
        ...
        for (Subtitle subtitle : this.subtitles) {
            ...
            int q = p << 16 | p << 8 | p;
            poseStack.pushPose();
            poseStack.translate((float)this.minecraft.getWindow().getGuiScaledWidth() - (float)l * 1.0f - 2.0f, (float)(this.minecraft.getWindow().getGuiScaledHeight() - 40) - (float)(i * (m + 1)) * 1.0f, 0.0);
