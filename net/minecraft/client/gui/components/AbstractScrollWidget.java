...
GuiEventListener {
    ...
    public boolean mouseClicked(double d, double e, int i) {
        ...
        boolean bl2 = this.scrollbarVisible() && d >= (double)(this.x + this.width) && d <= (double)(this.x + this.width + 8) && e >= (double)this.y && e < (double)(this.y + this.height);
    ...
    public void renderButton(PoseStack poseStack, int i, int j, float f) {
        ...
        AbstractScrollWidget.enableScissor(this.x + 1, this.y + 1, this.x + this.width - 1, this.y + this.height - 1);
        poseStack.pushPose();
    ...
    private void renderBackground(PoseStack poseStack) {
        ...
        AbstractScrollWidget.fill(poseStack, this.x, this.y, this.x + this.width, this.y + this.height, i);
        AbstractScrollWidget.fill(poseStack, this.x + 1, this.y + 1, this.x + this.width - 1, this.y + this.height - 1, -16777216);
    }
