...
extends AbstractWidget {
    ...
    public void renderWidget(PoseStack poseStack, int i, int j, float f) {
        ...
        TabButton.blitNineSliced(poseStack, this.getX(), this.getY(), this.width, this.height, 2, 2, 2, 0, 130, 24, 0, this.getTextureY());
    ...
    public void renderString(PoseStack poseStack, Font font, int i) {
        ...
        TabButton.renderScrollingString(poseStack, font, this.getMessage(), j, k, l, m, i);
    }
    ...
    private void renderFocusUnderline(PoseStack poseStack, Font font, int i) {
        ...
        TabButton.fill(poseStack, k, l, k + j, l + 1, i);
    }
