...
implements ContainerEventHandler {
    ...
    public boolean mouseScrolled(double d, double e, double f) {
        boolean bl = false;
        for (AbstractWidget abstractWidget : this.getContainedChildren()) {
            if (!abstractWidget.isMouseOver(d, e) || !abstractWidget.mouseScrolled(d, e, f)) continue;
            bl = true;
        }
    ...
    public void updateNarration(NarrationElementOutput narrationElementOutput) {
        ...
        if (guiEventListener != null) {
            if (guiEventListener instanceof NarrationSupplier) {
                NarrationSupplier narrationSupplier = (NarrationSupplier)((Object)guiEventListener);
                narrationSupplier.updateNarration(narrationElementOutput.nest());
            }
        } else {
            GuiEventListener guiEventListener2 = this.getFocused();
            if (guiEventListener2 != null && guiEventListener2 instanceof NarrationSupplier) {
                NarrationSupplier narrationSupplier2 = (NarrationSupplier)((Object)guiEventListener2);
