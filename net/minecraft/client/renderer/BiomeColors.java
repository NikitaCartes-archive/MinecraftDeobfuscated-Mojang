...
public class BiomeColors {
    private static final ColorResolver GRASS_COLOR_RESOLVER = Biome::getGrassColor;
    private static final ColorResolver FOLIAGE_COLOR_RESOLVER = Biome::getFoliageColor;
    private static final ColorResolver WATER_COLOR_RESOLVER = (biome, blockPos) -> biome.getWaterColor();
    private static final ColorResolver WATER_FOG_COLOR_RESOLVER = (biome, blockPos) -> biome.getWaterFogColor();

    private static int getAverageColor(BlockAndBiomeGetter blockAndBiomeGetter, BlockPos blockPos, ColorResolver colorResolver) {
        int i = 0;
        int j = 0;
        int k = 0;
    ...
    public static int getAverageGrassColor(BlockAndBiomeGetter blockAndBiomeGetter, BlockPos blockPos) {
        return BiomeColors.getAverageColor(blockAndBiomeGetter, blockPos, GRASS_COLOR_RESOLVER);
    }

    public static int getAverageFoliageColor(BlockAndBiomeGetter blockAndBiomeGetter, BlockPos blockPos) {
        return BiomeColors.getAverageColor(blockAndBiomeGetter, blockPos, FOLIAGE_COLOR_RESOLVER);
    }

    public static int getAverageWaterColor(BlockAndBiomeGetter blockAndBiomeGetter, BlockPos blockPos) {
        return BiomeColors.getAverageColor(blockAndBiomeGetter, blockPos, WATER_COLOR_RESOLVER);
    }
