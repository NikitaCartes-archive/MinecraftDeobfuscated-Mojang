...
public class FrustumData {
    ...
    public boolean cubeInFrustum(double d, double e, double f, double g, double h, double i) {
        for (int j = 0; j < 6; ++j) {
            ...
            if (this.discriminant(fs, d, e, f) > 0.0 || this.discriminant(fs, g, e, f) > 0.0 || this.discriminant(fs, d, h, f) > 0.0 || this.discriminant(fs, g, h, f) > 0.0 || this.discriminant(fs, d, e, i) > 0.0 || this.discriminant(fs, g, e, i) > 0.0 || this.discriminant(fs, d, h, i) > 0.0 || this.discriminant(fs, g, h, i) > 0.0) continue;
            return false;
        }
        return true;
    }
