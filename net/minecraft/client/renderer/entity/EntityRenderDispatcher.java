...
public class EntityRenderDispatcher {
    ...
    public boolean shouldRender(Entity entity, Culler culler, double d, double e, double f) {
        ...
        return entityRenderer != null && ((EntityRenderer)entityRenderer).shouldRender((Entity)entity, culler, d, e, f);
    }
        ...
        block9: {
            ...
            try {
                ...
                try {
                    ...
                    throw new ReportedException(CrashReport.forThrowable(throwable, "Post-rendering entity in world"));
                }
                if (!this.renderHitBoxes || entity.isInvisible() || bl || Minecraft.getInstance().showOnlyReducedInfo()) break block9;
                try {
                    this.renderHitbox(entity, d, e, f, g, h);
                } catch (Throwable throwable) {
                    throw new ReportedException(CrashReport.forThrowable(throwable, "Rendering entity hitbox in world"));
                }
            } catch (Throwable throwable) {
    ...
    public void renderSecondPass(Entity entity, float f) {
        ...
        if (entityRenderer != null && this.textureManager != null) {
            ((EntityRenderer)entityRenderer).renderSecondPass((Entity)entity, d - this.xOff, e - this.yOff, g - this.zOff, h, f);
        }
    }
