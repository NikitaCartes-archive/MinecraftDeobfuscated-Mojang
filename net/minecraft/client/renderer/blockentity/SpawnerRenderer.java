...
extends BlockEntityRenderer<SpawnerBlockEntity> {
    ...
    @Override
    public void render(SpawnerBlockEntity spawnerBlockEntity, double d, double e, double f, float g, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
        poseStack.pushPose();
