...
public class ParticleDescription {
    ...
    public static ParticleDescription fromJson(JsonObject jsonObject) {
        ...
        List list = Streams.stream(jsonArray).map(jsonElement -> GsonHelper.convertToString(jsonElement, "texture")).map(ResourceLocation::new).collect(ImmutableList.toImmutableList());
