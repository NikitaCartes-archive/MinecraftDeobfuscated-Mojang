    ...
    extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life == 0 && this.explosions != null) {
                ...
                SoundEvent soundEvent = bl2 ? (bl ? SoundEvents.FIREWORK_ROCKET_LARGE_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_LARGE_BLAST) : (bl ? SoundEvents.FIREWORK_ROCKET_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_BLAST);
            ...
            if (this.life % 2 == 0 && this.explosions != null && this.life / 2 < this.explosions.size()) {
                ...
                switch (shape) {
                    ...
                    case STAR: {
                        this.createParticleShape(0.5, new double[][]{{0.0, 1.0}, {0.3455, 0.309}, {0.9511, 0.309}, {0.3795918367346939, -0.12653061224489795}, {0.6122448979591837, -0.8040816326530612}, {0.0, -0.35918367346938773}}, is, js, bl3, bl4, false);
                        break;
                    }
                    case CREEPER: {
                        this.createParticleShape(0.5, new double[][]{{0.0, 0.2}, {0.2, 0.2}, {0.2, 0.6}, {0.6, 0.6}, {0.6, 0.2}, {0.2, 0.2}, {0.2, 0.0}, {0.4, 0.0}, {0.4, -0.6}, {0.2, -0.6}, {0.2, -0.4}, {0.0, -0.4}}, is, js, bl3, bl4, true);
                        break;
                    }
                    case BURST: {
