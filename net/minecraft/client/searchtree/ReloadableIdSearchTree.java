...
implements MutableSearchTree<T> {
    ...
    private final Object2IntMap<T> orderT = new Object2IntOpenHashMap<T>();
    ...
    public List<T> search(String string) {
        ...
        return Lists.newArrayList(new IntersectionIterator<T>(list.iterator(), list2.iterator(), this::comparePosition));
    }
