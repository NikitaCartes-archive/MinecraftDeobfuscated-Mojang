...
public class TestFunction {
    ...
    public TestFunction(String string, String string2, String string3, Rotation rotation, int i, long l, boolean bl, int j, int k, Consumer<GameTestHelper> consumer) {
