        ...
        new Thread("Realms-connect-task"){
            ...
            public void run() {
                ...
                try {
                    ...
                    RealmsConnect.this.connection.send(new ServerboundHelloPacket(string4, minecraft.getProfileKeyPairManager().profilePublicKeyData(), Optional.ofNullable(uUID)));
