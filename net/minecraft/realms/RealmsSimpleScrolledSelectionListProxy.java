...
public class RealmsSimpleScrolledSelectionListProxy
extends ScrolledSelectionList {
    ...
    public boolean mouseScrolled(double d, double e, double f) {
        if (this.realmsSimpleScrolledSelectionList.mouseScrolled(d, e, f)) {
            return true;
        }
    ...
    public boolean mouseClicked(double d, double e, int i) {
        if (this.realmsSimpleScrolledSelectionList.mouseClicked(d, e, i)) {
            return true;
        }
