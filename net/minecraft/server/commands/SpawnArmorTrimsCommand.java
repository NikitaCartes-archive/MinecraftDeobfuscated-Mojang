...
public class SpawnArmorTrimsCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawn_armor_trims").requires(commandSourceStack -> commandSourceStack.hasPermission(2) && commandSourceStack.getLevel().enabledFeatures().contains(FeatureFlags.UPDATE_1_20))).executes(commandContext -> SpawnArmorTrimsCommand.spawnArmorTrims((CommandSourceStack)commandContext.getSource(), ((CommandSourceStack)commandContext.getSource()).getPlayerOrException())));
    }
