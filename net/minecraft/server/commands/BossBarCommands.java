...
public class BossBarCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("bossbar").requires(commandSourceStack -> commandSourceStack.hasPermission(2))).then(Commands.literal("add").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("id", ResourceLocationArgument.id()).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("name", ComponentArgument.textComponent()).executes(commandContext -> BossBarCommands.createBar((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "id"), ComponentArgument.getComponent(commandContext, "name"))))))).then(Commands.literal("remove").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).executes(commandContext -> BossBarCommands.removeBar((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext)))))).then(Commands.literal("list").executes(commandContext -> BossBarCommands.listBars((CommandSourceStack)commandContext.getSource())))).then(Commands.literal("set").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("name").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("name", ComponentArgument.textComponent()).executes(commandContext -> BossBarCommands.setName((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), ComponentArgument.getComponent(commandContext, "name")))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("color").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("pink").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.PINK)))).then(Commands.literal("blue").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.BLUE)))).then(Commands.literal("red").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.RED)))).then(Commands.literal("green").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.GREEN)))).then(Commands.literal("yellow").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.YELLOW)))).then(Commands.literal("purple").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.PURPLE)))).then(Commands.literal("white").executes(commandContext -> BossBarCommands.setColor((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarColor.WHITE))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("style").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("progress").executes(commandContext -> BossBarCommands.setStyle((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarOverlay.PROGRESS)))).then(Commands.literal("notched_6").executes(commandContext -> BossBarCommands.setStyle((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarOverlay.NOTCHED_6)))).then(Commands.literal("notched_10").executes(commandContext -> BossBarCommands.setStyle((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarOverlay.NOTCHED_10)))).then(Commands.literal("notched_12").executes(commandContext -> BossBarCommands.setStyle((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarOverlay.NOTCHED_12)))).then(Commands.literal("notched_20").executes(commandContext -> BossBarCommands.setStyle((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BossEvent.BossBarOverlay.NOTCHED_20))))).then(Commands.literal("value").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("value", IntegerArgumentType.integer(0)).executes(commandContext -> BossBarCommands.setValue((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), IntegerArgumentType.getInteger(commandContext, "value")))))).then(Commands.literal("max").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("max", IntegerArgumentType.integer(1)).executes(commandContext -> BossBarCommands.setMax((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), IntegerArgumentType.getInteger(commandContext, "max")))))).then(Commands.literal("visible").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("visible", BoolArgumentType.bool()).executes(commandContext -> BossBarCommands.setVisible((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), BoolArgumentType.getBool(commandContext, "visible")))))).then(((LiteralArgumentBuilder)Commands.literal("players").executes(commandContext -> BossBarCommands.setPlayers((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), Collections.emptyList()))).then(Commands.argument("targets", EntityArgument.players()).executes(commandContext -> BossBarCommands.setPlayers((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext), EntityArgument.getOptionalPlayers(commandContext, "targets")))))))).then(Commands.literal("get").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("value").executes(commandContext -> BossBarCommands.getValue((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext))))).then(Commands.literal("max").executes(commandContext -> BossBarCommands.getMax((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext))))).then(Commands.literal("visible").executes(commandContext -> BossBarCommands.getVisible((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext))))).then(Commands.literal("players").executes(commandContext -> BossBarCommands.getPlayers((CommandSourceStack)commandContext.getSource(), BossBarCommands.getBossBar(commandContext)))))));
    }
