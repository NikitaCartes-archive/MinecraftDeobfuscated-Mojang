...
public class PlaceCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("place").requires(commandSourceStack -> commandSourceStack.hasPermission(2))).then(Commands.literal("feature").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("feature", ResourceKeyArgument.key(Registries.CONFIGURED_FEATURE)).executes(commandContext -> PlaceCommand.placeFeature((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getConfiguredFeature(commandContext, "feature"), new BlockPos(((CommandSourceStack)commandContext.getSource()).getPosition())))).then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(commandContext -> PlaceCommand.placeFeature((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getConfiguredFeature(commandContext, "feature"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"))))))).then(Commands.literal("jigsaw").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("pool", ResourceKeyArgument.key(Registries.TEMPLATE_POOL)).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("target", ResourceLocationArgument.id()).then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 7)).executes(commandContext -> PlaceCommand.placeJigsaw((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getStructureTemplatePool(commandContext, "pool"), ResourceLocationArgument.getId(commandContext, "target"), IntegerArgumentType.getInteger(commandContext, "max_depth"), new BlockPos(((CommandSourceStack)commandContext.getSource()).getPosition())))).then(Commands.argument("position", BlockPosArgument.blockPos()).executes(commandContext -> PlaceCommand.placeJigsaw((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getStructureTemplatePool(commandContext, "pool"), ResourceLocationArgument.getId(commandContext, "target"), IntegerArgumentType.getInteger(commandContext, "max_depth"), BlockPosArgument.getLoadedBlockPos(commandContext, "position"))))))))).then(Commands.literal("structure").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("structure", ResourceKeyArgument.key(Registries.STRUCTURE)).executes(commandContext -> PlaceCommand.placeStructure((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getStructure(commandContext, "structure"), new BlockPos(((CommandSourceStack)commandContext.getSource()).getPosition())))).then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(commandContext -> PlaceCommand.placeStructure((CommandSourceStack)commandContext.getSource(), ResourceKeyArgument.getStructure(commandContext, "structure"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"))))))).then(Commands.literal("template").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("template", ResourceLocationArgument.id()).suggests(SUGGEST_TEMPLATES).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), new BlockPos(((CommandSourceStack)commandContext.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0f, 0))).then(((RequiredArgumentBuilder)Commands.argument("pos", BlockPosArgument.blockPos()).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"), Rotation.NONE, Mirror.NONE, 1.0f, 0))).then(((RequiredArgumentBuilder)Commands.argument("rotation", TemplateRotationArgument.templateRotation()).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"), TemplateRotationArgument.getRotation(commandContext, "rotation"), Mirror.NONE, 1.0f, 0))).then(((RequiredArgumentBuilder)Commands.argument("mirror", TemplateMirrorArgument.templateMirror()).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"), TemplateRotationArgument.getRotation(commandContext, "rotation"), TemplateMirrorArgument.getMirror(commandContext, "mirror"), 1.0f, 0))).then(((RequiredArgumentBuilder)Commands.argument("integrity", FloatArgumentType.floatArg(0.0f, 1.0f)).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"), TemplateRotationArgument.getRotation(commandContext, "rotation"), TemplateMirrorArgument.getMirror(commandContext, "mirror"), FloatArgumentType.getFloat(commandContext, "integrity"), 0))).then(Commands.argument("seed", IntegerArgumentType.integer()).executes(commandContext -> PlaceCommand.placeTemplate((CommandSourceStack)commandContext.getSource(), ResourceLocationArgument.getId(commandContext, "template"), BlockPosArgument.getLoadedBlockPos(commandContext, "pos"), TemplateRotationArgument.getRotation(commandContext, "rotation"), TemplateMirrorArgument.getMirror(commandContext, "mirror"), FloatArgumentType.getFloat(commandContext, "integrity"), IntegerArgumentType.getInteger(commandContext, "seed")))))))))));
    }
