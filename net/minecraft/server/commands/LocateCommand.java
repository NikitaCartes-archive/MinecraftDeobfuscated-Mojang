...
public class LocateCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("locate").requires(commandSourceStack -> commandSourceStack.hasPermission(2))).then(Commands.literal("Pillager_Outpost").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Pillager_Outpost")))).then(Commands.literal("Mineshaft").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Mineshaft")))).then(Commands.literal("Mansion").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Mansion")))).then(Commands.literal("Igloo").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Igloo")))).then(Commands.literal("Desert_Pyramid").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Desert_Pyramid")))).then(Commands.literal("Jungle_Pyramid").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Jungle_Pyramid")))).then(Commands.literal("Swamp_Hut").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Swamp_Hut")))).then(Commands.literal("Stronghold").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Stronghold")))).then(Commands.literal("Monument").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Monument")))).then(Commands.literal("Fortress").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Fortress")))).then(Commands.literal("EndCity").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "EndCity")))).then(Commands.literal("Ocean_Ruin").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Ocean_Ruin")))).then(Commands.literal("Buried_Treasure").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Buried_Treasure")))).then(Commands.literal("Shipwreck").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Shipwreck")))).then(Commands.literal("Village").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Village")))).then(Commands.literal("Nether_Fossil").executes(commandContext -> LocateCommand.locate((CommandSourceStack)commandContext.getSource(), "Nether_Fossil"))));
    }
