...
public class BuiltInMetadata {
    ...
    public static <T1, T2> BuiltInMetadata of(MetadataSectionSerializer<T1> metadataSectionSerializer, T1 object, MetadataSectionSerializer<T2> metadataSectionSerializer2, T2 object2) {
