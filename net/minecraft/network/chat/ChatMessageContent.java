...
public record ChatMessageContent(String plain, Component decorated) {
    ...
    public static FilteredText<ChatMessageContent> fromFiltered(FilteredText<String> filteredText, FilteredText<Component> filteredText2) {
        return filteredText.map(string -> new ChatMessageContent((String)string, (Component)filteredText2.raw()), string -> filteredText2.filtered() != null ? new ChatMessageContent((String)string, (Component)filteredText2.filtered()) : null);
    }
