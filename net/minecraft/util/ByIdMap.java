...
public class ByIdMap {
    ...
    public static <T> IntFunction<T> sparse(ToIntFunction<T> toIntFunction, T[] objects, T object) {
        IntFunction intFunction = ByIdMap.createMap(toIntFunction, objects);
    ...
    private static <T> T[] createSortedArray(ToIntFunction<T> toIntFunction, T[] objects) {
        ...
        Object[] objects2 = (Object[])objects.clone();
    ...
    public static <T> IntFunction<T> continuous(ToIntFunction<T> toIntFunction, T[] objects, OutOfBoundsStrategy outOfBoundsStrategy) {
        Object[] objects2 = ByIdMap.createSortedArray(toIntFunction, objects);
        ...
        return switch (outOfBoundsStrategy) {
            ...
            case OutOfBoundsStrategy.WRAP -> j -> objects2[Mth.positiveModulo(j, i)];
            case OutOfBoundsStrategy.CLAMP -> j -> objects2[Mth.clamp(j, 0, i - 1)];
        };
    }
