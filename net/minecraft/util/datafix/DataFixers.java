...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema32, "totem item renamer", string -> Objects.equals(string, "minecraft:totem") ? "minecraft:totem_of_undying" : string));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema53, "Flowing fixer", string -> ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava").getOrDefault(string, (String)string)));
        Schema schema54 = dataFixerBuilder.addSchema(1480, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema54, "Rename coral blocks", string -> RenamedCoralFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema54, "Rename coral items", string -> RenamedCoralFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema56, "Rename pufferfish egg item", string -> EntityPufferfishRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        Schema schema57 = dataFixerBuilder.addSchema(1484, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema57, "Rename seagrass items", string -> ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema57, "Rename seagrass blocks", string -> ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema58, "Rename cod/salmon egg items", string -> EntityCodSalmonFix.RENAMED_EGG_IDS.getOrDefault(string, (String)string)));
        Schema schema59 = dataFixerBuilder.addSchema(1487, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", string -> ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema59, "Rename prismarine_brick(s)_* items", string -> ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, (String)string)));
        Schema schema60 = dataFixerBuilder.addSchema(1488, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema60, "Rename kelp/kelptop", string -> ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema60, "Rename kelptop", string -> Objects.equals(string, "minecraft:kelp_top") ? "minecraft:kelp" : string));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema61, "Rename melon_block", string -> Objects.equals(string, "minecraft:melon_block") ? "minecraft:melon" : string));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema61, "Rename melon_block/melon/speckled_melon", string -> ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema69, "Block renamening fix", string -> EntityTheRenameningFix.RENAMED_BLOCKS.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema69, "Item renamening fix", string -> EntityTheRenameningFix.RENAMED_ITEMS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema71, "Rename coral fan blocks", string -> RenamedCoralFansFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema73, "Rename dye items", string -> DyeItemRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema75, "Rename sign blocks & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema75, "Rename sign item & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema86, "Rename ravager egg item", string -> EntityRavagerRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(new RecipesRenameFix(schema95, false, "Rename sugar recipe", string -> "minecraft:sugar".equals(string) ? "sugar_from_sugar_cane" : string));
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema95, false, "Rename sugar recipe advancement", string -> "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema97, "Rename bee_hive item to beehive", string -> Objects.equals(string, "minecraft:bee_hive") ? "minecraft:beehive" : string));
        dataFixerBuilder.addFixer(new BeehivePoiRenameFix(schema97));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema97, "Rename bee_hive block to beehive", string -> ImmutableMap.of("minecraft:bee_hive", "minecraft:beehive").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema104, "Renamed fungi items to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema104, "Renamed fungi blocks to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema105, "Rename zombie pigman egg item", string -> EntityZombifiedPiglinRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema114, "Rename soul fire torch and soul fire lantern", string -> ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern").getOrDefault(string, (String)string)));
