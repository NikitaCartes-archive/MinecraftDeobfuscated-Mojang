...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema51, "Colorless shulker block fixer", string -> Objects.equals(NamespacedSchema.ensureNamespaced(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema51, "Colorless shulker item fixer", string -> Objects.equals(NamespacedSchema.ensureNamespaced(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        Schema schema52 = dataFixerBuilder.addSchema(1475, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema52, "Flowing fixer", DataFixers.createRenamer(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
        Schema schema53 = dataFixerBuilder.addSchema(1480, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema53, "Rename coral blocks", DataFixers.createRenamer(RenamedCoralFix.RENAMED_IDS)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema53, "Rename coral items", DataFixers.createRenamer(RenamedCoralFix.RENAMED_IDS)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema55, "Rename pufferfish egg item", DataFixers.createRenamer(EntityPufferfishRenameFix.RENAMED_IDS)));
        Schema schema56 = dataFixerBuilder.addSchema(1484, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema56, "Rename seagrass items", DataFixers.createRenamer(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema56, "Rename seagrass blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema57, "Rename cod/salmon egg items", DataFixers.createRenamer(EntityCodSalmonFix.RENAMED_EGG_IDS)));
        Schema schema58 = dataFixerBuilder.addSchema(1487, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema58, "Rename prismarine_brick(s)_* blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema58, "Rename prismarine_brick(s)_* items", DataFixers.createRenamer(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        Schema schema59 = dataFixerBuilder.addSchema(1488, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema59, "Rename kelp/kelptop", DataFixers.createRenamer(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema59, "Rename kelptop", DataFixers.createRenamer("minecraft:kelp_top", "minecraft:kelp")));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema60, "Rename melon_block", DataFixers.createRenamer("minecraft:melon_block", "minecraft:melon")));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema60, "Rename melon_block/melon/speckled_melon", DataFixers.createRenamer(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema68, "Block renamening fix", DataFixers.createRenamer(EntityTheRenameningFix.RENAMED_BLOCKS)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema68, "Item renamening fix", DataFixers.createRenamer(EntityTheRenameningFix.RENAMED_ITEMS)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema70, "Rename coral fan blocks", DataFixers.createRenamer(RenamedCoralFansFix.RENAMED_IDS)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema72, "Rename dye items", DataFixers.createRenamer(DyeItemRenameFix.RENAMED_IDS)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema74, "Rename sign blocks & stone slabs", DataFixers.createRenamer(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema74, "Rename sign item & stone slabs", DataFixers.createRenamer(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema86, "Rename ravager egg item", DataFixers.createRenamer(EntityRavagerRenameFix.RENAMED_IDS)));
        ...
        dataFixerBuilder.addFixer(new RecipesRenameFix(schema96, false, "Rename sugar recipe", DataFixers.createRenamer("minecraft:sugar", "sugar_from_sugar_cane")));
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema96, false, "Rename sugar recipe advancement", DataFixers.createRenamer("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema103, false, "Composter category change", DataFixers.createRenamer("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema105, "Renamed fungi items to fungus", DataFixers.createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema105, "Renamed fungi blocks to fungus", DataFixers.createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema106, "Rename zombie pigman egg item", DataFixers.createRenamer(EntityZombifiedPiglinRenameFix.RENAMED_IDS)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema115, "Rename soul fire torch and soul fire lantern", DataFixers.createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema115, "Rename soul fire torch and soul fire lantern", DataFixers.createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema128, "Renamed grass path item to dirt path", DataFixers.createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        dataFixerBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema128, "Renamed grass path block to dirt path", DataFixers.createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema132, "Renamed copper block items to new oxidized terms", DataFixers.createRenamer(immutableMap)));
        dataFixerBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema132, "Renamed copper blocks to new oxidized terms", DataFixers.createRenamer(immutableMap)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema133, "Rename copper item suffixes", DataFixers.createRenamer(immutableMap2)));
        dataFixerBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema133, "Rename copper blocks suffixes", DataFixers.createRenamer(immutableMap2)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema135, "Renamed grimstone block items to deepslate", DataFixers.createRenamer(immutableMap3)));
        dataFixerBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema135, "Renamed grimstone blocks to deepslate", DataFixers.createRenamer(immutableMap3)));
        Schema schema136 = dataFixerBuilder.addSchema(2700, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema136, "Renamed cave vines blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema142, "Rename azalea_leaves_flowers", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema142, "Rename azalea_leaves_flowers items", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        ...
        dataFixerBuilder.addFixer(new CriteriaRenameFix(schema162, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> immutableMap4.getOrDefault(string, (String)string)));
        Schema schema163 = dataFixerBuilder.addSchema(3087, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityVariantFix(schema163, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer(new CriteriaRenameFix(schema168, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(new PoiTypeRemoveFix(schema168, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
