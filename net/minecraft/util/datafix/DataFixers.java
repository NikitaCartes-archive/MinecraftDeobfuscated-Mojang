...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema98, "Rename bee_hive item to beehive", DataFixers.createRenamer("minecraft:bee_hive", "minecraft:beehive")));
        dataFixerBuilder.addFixer(new BeehivePoiRenameFix(schema98));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema98, "Rename bee_hive block to beehive", DataFixers.createRenamer("minecraft:bee_hive", "minecraft:beehive")));
