...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema70, "Block renamening fix", string -> EntityTheRenameningFix.RENAMED_BLOCKS.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema70, "Item renamening fix", string -> EntityTheRenameningFix.RENAMED_ITEMS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema72, "Rename coral fan blocks", string -> RenamedCoralFansFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema74, "Rename dye items", string -> DyeItemRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema76, "Rename sign blocks & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema76, "Rename sign item & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema87, "Rename ravager egg item", string -> EntityRavagerRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(new RecipesRenameFix(schema96, false, "Rename sugar recipe", string -> "minecraft:sugar".equals(string) ? "sugar_from_sugar_cane" : string));
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema96, false, "Rename sugar recipe advancement", string -> "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema105, "Renamed fungi items to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema105, "Renamed fungi blocks to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema106, "Rename zombie pigman egg item", string -> EntityZombifiedPiglinRenameFix.RENAMED_IDS.getOrDefault(string, (String)string)));
