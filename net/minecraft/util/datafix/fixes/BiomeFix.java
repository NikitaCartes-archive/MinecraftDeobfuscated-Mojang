...
extends DataFix {
    ...
    public BiomeFix(Schema schema, boolean bl) {
        super(schema, bl);
    }
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhere("Biomes fix", type, dynamicOps -> pair -> pair.mapSecond(string -> BIOMES.getOrDefault(string, (String)string)));
    }
}
