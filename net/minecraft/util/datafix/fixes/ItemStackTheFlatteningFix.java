...
extends DataFix {
    ...
    private static final Set<String> IDS = MAP.keySet().stream().map(string -> string.substring(0, string.indexOf(46))).collect(Collectors.toSet());
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, typed -> {
            ...
            String string = ItemStackTheFlatteningFix.updateItem((String)((Pair)optional.get()).getSecond(), i);
            if (string != null) {
                typed2 = typed2.set(opticFinder, Pair.of(References.ITEM_NAME.typeName(), string));
            }
            if (DAMAGE_IDS.contains(((Pair)optional.get()).getSecond())) {
                Typed<Dynamic<?>> typed3 = typed.getOrCreateTyped(opticFinder2);
            ...
            typed2 = typed2.set(DSL.remainderFinder(), dynamic.remove("Damage"));
            return typed2;
        });
    }
