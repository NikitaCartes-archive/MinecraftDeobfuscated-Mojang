...
extends DataFix {
    private static final Map<String, Integer> MAP = DataFixUtils.make(Maps.newHashMap(), hashMap -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Function<Typed, Typed> function = typed -> this.updateBlockToBlockState((Typed<?>)typed, "DisplayTile", "DisplayData", "DisplayState");
        Function<Typed, Typed> function2 = typed -> this.updateBlockToBlockState((Typed<?>)typed, "inTile", "inData", "inBlockState");
        Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> type = DSL.and(DSL.optional(DSL.field("inTile", DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())))), DSL.remainderType());
        Function<Typed, Typed> function3 = typed -> typed.update(type.finder(), DSL.remainderType(), Pair::getSecond);
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(References.ENTITY), schema2.getType(References.ENTITY), (Typed<?> typed2) -> {
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:falling_block", this::updateFallingBlock);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:enderman", typed -> this.updateBlockToBlockState((Typed<?>)typed, "carried", "carriedData", "carriedBlockState"));
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:arrow", (Function<Typed<?>, Typed<?>>)function2);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:spectral_arrow", (Function<Typed<?>, Typed<?>>)function2);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:egg", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:ender_pearl", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:fireball", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:potion", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:small_fireball", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:snowball", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:wither_skull", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:xp_bottle", (Function<Typed<?>, Typed<?>>)function3);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:commandblock_minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:chest_minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:furnace_minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:tnt_minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:hopper_minecart", (Function<Typed<?>, Typed<?>>)function);
            typed2 = this.updateEntity((Typed<?>)typed2, "minecraft:spawner_minecart", (Function<Typed<?>, Typed<?>>)function);
            return typed2;
        });
    }

    private Typed<?> updateFallingBlock(Typed<?> typed) {
        Type<Either<Pair<String, Either<Integer, String>>, Unit>> type = DSL.optional(DSL.field("Block", DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString()))));
        ...
        return typed.update(type.finder(), type2, either -> {
            int i = either.map(pair -> ((Either)pair.getSecond()).map(integer -> integer, EntityBlockStateFix::getBlockId), unit -> {
    ...
    private Typed<?> updateBlockToBlockState(Typed<?> typed, String string, String string2, String string3) {
        Tag.TagType<Pair<String, Either<Integer, String>>> type = DSL.field(string, DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())));
        Tag.TagType<Pair<String, Dynamic<?>>> type2 = DSL.field(string3, DSL.named(References.BLOCK_STATE.typeName(), DSL.remainderType()));
