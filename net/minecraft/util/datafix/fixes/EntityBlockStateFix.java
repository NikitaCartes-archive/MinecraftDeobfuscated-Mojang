...
extends DataFix {
    ...
    private Typed<?> updateBlockToBlockState(Typed<?> typed, String string, String string2, String string3) {
        Tag.TagType<Pair<String, Either<Integer, String>>> type = DSL.field(string, DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString())));
