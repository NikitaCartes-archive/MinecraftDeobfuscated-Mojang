...
implements ArgumentType<ResourceLocation> {
    ...
    public static final DynamicCommandExceptionType ERROR_UNKNOWN_ENTITY = new DynamicCommandExceptionType(object -> Component.translatable("entity.notFound", object));
    ...
    public static ResourceLocation getSummonableEntity(CommandContext<CommandSourceStack> commandContext, String string) throws CommandSyntaxException {
        return EntitySummonArgument.verifyCanSummon(commandContext.getArgument(string, ResourceLocation.class));
    }
