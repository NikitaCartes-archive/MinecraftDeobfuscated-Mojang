...
implements ArgumentType<MobEffect> {
    ...
    public static final DynamicCommandExceptionType ERROR_UNKNOWN_EFFECT = new DynamicCommandExceptionType(object -> Component.translatable("effect.effectNotFound", object));
    ...
    public MobEffect parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        return Registry.MOB_EFFECT.getOptional(resourceLocation).orElseThrow(() -> ERROR_UNKNOWN_EFFECT.create(resourceLocation));
    }
