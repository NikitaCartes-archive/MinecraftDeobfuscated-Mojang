...
implements ArgumentType<Enchantment> {
    ...
    public static final DynamicCommandExceptionType ERROR_UNKNOWN_ENCHANTMENT = new DynamicCommandExceptionType(object -> Component.translatable("enchantment.unknown", object));
    ...
    public Enchantment parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        return Registry.ENCHANTMENT.getOptional(resourceLocation).orElseThrow(() -> ERROR_UNKNOWN_ENCHANTMENT.create(resourceLocation));
    }
