...
public class SuggestionProviders {
    ...
    public static final SuggestionProvider<SharedSuggestionProvider> ASK_SERVER = SuggestionProviders.register(DEFAULT_NAME, (commandContext, suggestionsBuilder) -> ((SharedSuggestionProvider)commandContext.getSource()).customSuggestion(commandContext, suggestionsBuilder));
    ...
    public static final SuggestionProvider<CommandSourceStack> AVAILABLE_BIOMES = SuggestionProviders.register(new ResourceLocation("available_biomes"), (commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggestResource(((SharedSuggestionProvider)commandContext.getSource()).registryAccess().registryOrThrow(Registry.BIOME_REGISTRY).keySet(), suggestionsBuilder));
    public static final SuggestionProvider<CommandSourceStack> AVAILABLE_FEATURES = SuggestionProviders.register(new ResourceLocation("available_features"), (commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggestResource(((SharedSuggestionProvider)commandContext.getSource()).registryAccess().registryOrThrow(Registry.CONFIGURED_FEATURE_REGISTRY).keySet(), suggestionsBuilder));
    public static final SuggestionProvider<CommandSourceStack> AVAILABLE_STRUCTURES = SuggestionProviders.register(new ResourceLocation("available_structures"), (commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggestResource(((SharedSuggestionProvider)commandContext.getSource()).registryAccess().registryOrThrow(Registry.STRUCTURE_FEATURE_REGISTRY).keySet(), suggestionsBuilder));
