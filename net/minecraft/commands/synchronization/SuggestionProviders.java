...
public class SuggestionProviders {
    ...
    public static final SuggestionProvider<CommandSourceStack> AVAILABLE_BIOMES = SuggestionProviders.register(new ResourceLocation("available_biomes"), (commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggestResource(Registry.BIOME.keySet(), suggestionsBuilder));
    public static final SuggestionProvider<CommandSourceStack> SUMMONABLE_ENTITIES = SuggestionProviders.register(new ResourceLocation("summonable_entities"), (commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggestResource(Registry.ENTITY_TYPE.stream().filter(EntityType::canSummon), suggestionsBuilder, EntityType::getKey, entityType -> new TranslatableComponent(Util.makeDescriptionId("entity", EntityType.getKey(entityType)), new Object[0])));
