...
public class ArgumentTypeInfos {
    ...
    public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> registry) {
        ...
        ArgumentTypeInfos.register(registry, "particle", ParticleArgument.class, SingletonArgumentInfo.contextFree(ParticleArgument::particle));
        ...
        ArgumentTypeInfos.register(registry, "mob_effect", MobEffectArgument.class, SingletonArgumentInfo.contextFree(MobEffectArgument::effect));
        ...
        ArgumentTypeInfos.register(registry, "item_enchantment", ItemEnchantmentArgument.class, SingletonArgumentInfo.contextFree(ItemEnchantmentArgument::enchantment));
        ArgumentTypeInfos.register(registry, "entity_summon", EntitySummonArgument.class, SingletonArgumentInfo.contextFree(EntitySummonArgument::id));
