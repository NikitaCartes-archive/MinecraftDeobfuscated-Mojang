...
public class SharedConstants {
    ...
    @Deprecated
    public static final int WORLD_VERSION = 3211;
    @Deprecated
    public static final String SERIES = "main";
    @Deprecated
    public static final String VERSION_STRING = "1.19.3-pre1";
    @Deprecated
    public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 761;
    @Deprecated
    public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 109;
