...
public class SharedConstants {
    ...
    @Deprecated
    public static final int WORLD_VERSION = 3206;
    @Deprecated
    public static final String SERIES = "main";
    @Deprecated
    public static final String VERSION_STRING = "22w43a";
    @Deprecated
    public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 761;
    @Deprecated
    public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 105;
