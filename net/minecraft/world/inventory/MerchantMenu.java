...
extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int i) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (i == 2) {
                ...
                this.playTradeSound();
            } else if (i == 0 || i == 1 ? !this.moveItemStackTo(itemStack2, 3, 39, false) : (i >= 3 && i < 30 ? !this.moveItemStackTo(itemStack2, 30, 39, false) : i >= 30 && i < 39 && !this.moveItemStackTo(itemStack2, 3, 30, false))) {
                return ItemStack.EMPTY;
            }
    ...
    public void tryMoveItems(int i) {
        ...
        if (!(itemStack2 = this.tradeContainer.getItem(1)).isEmpty()) {
            if (!this.moveItemStackTo(itemStack2, 3, 39, true)) {
                return;
            }
