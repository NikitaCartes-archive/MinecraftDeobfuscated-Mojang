...
extends ThrowableItemProjectile {
    ...
    public Snowball(Level level, LivingEntity livingEntity) {
        super((EntityType<? extends ThrowableItemProjectile>)EntityType.SNOWBALL, livingEntity, level);
    }

    public Snowball(Level level, double d, double e, double f) {
        super((EntityType<? extends ThrowableItemProjectile>)EntityType.SNOWBALL, d, e, f, level);
    }
