...
extends Monster {
    ...
    public static boolean checkSilverfishSpawnRules(EntityType<Silverfish> entityType, LevelAccessor levelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
        if (Silverfish.checkAnyLightMonsterSpawnRules(entityType, levelAccessor, mobSpawnType, blockPos, randomSource)) {
    ...
    extends RandomStrollGoal {
        ...
        public boolean canUse() {
            ...
            if (this.mob.level.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && randomSource.nextInt(SilverfishMergeWithStoneGoal.reducedTickDelay(10)) == 0) {
