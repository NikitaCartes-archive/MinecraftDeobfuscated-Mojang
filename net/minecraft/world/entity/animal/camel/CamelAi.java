...
public class CamelAi {
    ...
    private static void initCoreActivity(Brain<Camel> brain) {
        brain.addActivity(Activity.CORE, 0, ImmutableList.of(new Swim(0.8f), new CamelPanic(4.0f), new LookAtTargetSink(45, 90), new MoveToTargetSink(), new CountDownCooldownTicks(MemoryModuleType.TEMPTATION_COOLDOWN_TICKS), new CountDownCooldownTicks(MemoryModuleType.GAZE_COOLDOWN_TICKS)));
    }
    ...
    extends AnimalPanic {
        ...
        protected void start(ServerLevel serverLevel, PathfinderMob pathfinderMob, long l) {
            if (pathfinderMob instanceof Camel) {
                Camel camel = (Camel)pathfinderMob;
                camel.standUpPanic();
            }
