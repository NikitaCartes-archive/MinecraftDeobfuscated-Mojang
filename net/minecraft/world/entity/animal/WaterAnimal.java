...
extends PathfinderMob {
    ...
    public static boolean checkUndergroundWaterCreatureSpawnRules(EntityType<? extends LivingEntity> entityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, Random random) {
        return blockPos.getY() < serverLevelAccessor.getSeaLevel() && blockPos.getY() < serverLevelAccessor.getHeight(Heightmap.Types.OCEAN_FLOOR, blockPos.getX(), blockPos.getZ()) && WaterAnimal.isDarkEnoughToSpawn(serverLevelAccessor, blockPos) && WaterAnimal.isBaseStoneBelow(blockPos, serverLevelAccessor);
    }
