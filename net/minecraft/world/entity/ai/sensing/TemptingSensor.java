...
extends Sensor<PathfinderMob> {
    ...
    private static final TargetingConditions TEMPT_TARGETING = new TargetingConditions().range(10.0).allowInvulnerable().allowSameTeam().allowNonAttackable().allowUnseeable();
