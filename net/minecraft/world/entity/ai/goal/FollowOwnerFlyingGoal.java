...
extends FollowOwnerGoal {
    ...
    protected boolean isTeleportFriendlyBlock(BlockPos blockPos) {
        ...
        return (blockState.entityCanStandOn(this.level, blockPos, this.tamable) || blockState.is(BlockTags.LEAVES)) && this.level.isEmptyBlock(blockPos.above()) && this.level.isEmptyBlock(blockPos.above(2));
    }
}
