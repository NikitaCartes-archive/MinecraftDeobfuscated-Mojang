...
extends Behavior<E> {
    ...
    private static Map<MemoryModuleType<?>, MemoryStatus> mergeMaps(Map<MemoryModuleType<?>, MemoryStatus> map, Map<MemoryModuleType<?>, MemoryStatus> map2) {
        HashMap<MemoryModuleType<?>, MemoryStatus> map3 = Maps.newHashMap();
        map3.putAll(map);
        map3.putAll(map2);
        return map3;
    }

    public RunIf(Predicate<E> predicate, Behavior<? super E> behavior, boolean bl) {
    ...
    public RunIf(Map<MemoryModuleType<?>, MemoryStatus> map, Behavior<? super E> behavior) {
