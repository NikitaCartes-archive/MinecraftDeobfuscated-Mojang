...
extends Behavior<LivingEntity> {
    ...
    public StartCelebratingIfTargetDead(int i) {
        super(ImmutableMap.of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT, MemoryModuleType.ANGRY_AT, MemoryStatus.REGISTERED, MemoryModuleType.CELEBRATE_LOCATION, MemoryStatus.VALUE_ABSENT));
    ...
    protected void start(ServerLevel serverLevel, LivingEntity livingEntity, long l) {
        ...
        livingEntity.getBrain().setMemoryWithExpiry(MemoryModuleType.CELEBRATE_LOCATION, blockPos, l, this.celebrateDuration);
    }
