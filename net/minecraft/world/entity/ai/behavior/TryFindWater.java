...
extends Behavior<PathfinderMob> {
    ...
    protected void start(ServerLevel serverLevel, PathfinderMob pathfinderMob, long l) {
        ...
        Iterable<BlockPos> iterable = BlockPos.withinManhattan(pathfinderMob.blockPosition(), this.range, this.range, this.range);
        for (BlockPos blockPos2 : iterable) {
            if (!pathfinderMob.level.getFluidState(blockPos2).is(FluidTags.WATER)) continue;
