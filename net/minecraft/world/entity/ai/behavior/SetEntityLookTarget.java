...
extends Behavior<LivingEntity> {
    ...
    public SetEntityLookTarget(Tag<EntityType<?>> tag, float f) {
        this((LivingEntity livingEntity) -> livingEntity.getType().is(tag), f);
    }
    ...
    protected boolean checkExtraStartConditions(ServerLevel serverLevel, LivingEntity livingEntity) {
        return livingEntity.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get().stream().anyMatch(this.predicate);
    }
