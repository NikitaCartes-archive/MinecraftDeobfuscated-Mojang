...
public class AttributeInstance {
    ...
    private final Map<UUID, AttributeModifier> modifierById = new Object2ObjectArrayMap<UUID, AttributeModifier>();
    private final Set<AttributeModifier> permanentModifiers = new ObjectArraySet<AttributeModifier>();
    ...
    public CompoundTag save() {
        ...
        compoundTag.putString("Name", Registry.ATTRIBUTES.getKey(this.attribute).toString());
