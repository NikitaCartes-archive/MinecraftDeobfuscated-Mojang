...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<PigZombie> NEAREST_VISIBLE_ZOMBIFIED_PIGLIN = MemoryModuleType.register("nearest_visible_zombified_piglin");
    ...
    public static final MemoryModuleType<BlockPos> NEAREST_WARPED_FUNGI = MemoryModuleType.register("nearest_visible_warped_fungi");
