...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<SerializableLong> LAST_SLEPT = MemoryModuleType.register("last_slept", SerializableLong.CODEC);
    public static final MemoryModuleType<SerializableLong> LAST_WOKEN = MemoryModuleType.register("last_woken", SerializableLong.CODEC);
    public static final MemoryModuleType<SerializableLong> LAST_WORKED_AT_POI = MemoryModuleType.register("last_worked_at_poi", SerializableLong.CODEC);
    ...
    public static final MemoryModuleType<SerializableUUID> ANGRY_AT = MemoryModuleType.register("angry_at", SerializableUUID.CODEC);
    ...
    public static final MemoryModuleType<List<Piglin>> NEAREST_ADULT_PIGLINS = MemoryModuleType.register("nearest_adult_piglins");
