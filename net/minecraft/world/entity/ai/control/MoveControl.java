...
public class MoveControl {
    ...
    private boolean isWalkable(float f, float g) {
        ...
        return pathNavigation == null || (nodeEvaluator = pathNavigation.getNodeEvaluator()) == null || nodeEvaluator.getBlockPathType(this.mob.level, Mth.floor(this.mob.getX() + (double)f), this.mob.getBlockY(), Mth.floor(this.mob.getZ() + (double)g)) == BlockPathTypes.WALKABLE;
    }
