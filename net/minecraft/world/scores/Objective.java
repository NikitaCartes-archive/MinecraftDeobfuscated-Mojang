...
public class Objective {
    ...
    public Component getFormattedDisplayName() {
        return ComponentUtils.wrapInSquareBrackets(this.displayName.deepCopy().withStyle(style -> style.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(this.getName())))));
    }
