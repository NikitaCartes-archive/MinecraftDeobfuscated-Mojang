...
extends DiggerItem {
    ...
    protected static final Map<Block, BlockState> FLATTENABLES = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Blocks.DIRT_PATH.defaultBlockState(), Blocks.DIRT, Blocks.DIRT_PATH.defaultBlockState(), Blocks.PODZOL, Blocks.DIRT_PATH.defaultBlockState(), Blocks.COARSE_DIRT, Blocks.DIRT_PATH.defaultBlockState(), Blocks.MYCELIUM, Blocks.DIRT_PATH.defaultBlockState()));
