...
extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (!list.isEmpty()) {
            ...
            return new InteractionResultHolder<ItemStack>(InteractionResult.SUCCESS, this.turnBottleIntoItem(itemStack, player, new ItemStack(Items.DRAGON_BREATH)));
        }
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (level.getFluidState(blockPos).is(FluidTags.WATER)) {
                ...
                return new InteractionResultHolder<ItemStack>(InteractionResult.SUCCESS, this.turnBottleIntoItem(itemStack, player, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WATER)));
            }
        }
        return new InteractionResultHolder<ItemStack>(InteractionResult.PASS, itemStack);
    }
