...
extends BlockItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        BlockHitResult blockHitResult = PlaceOnWaterBlockItem.getPlayerPOVHitResult(level, player, ClipContext.Fluid.SOURCE_ONLY);
        ...
        return new InteractionResultHolder<ItemStack>(interactionResult, player.getItemInHand(interactionHand));
    }
}
