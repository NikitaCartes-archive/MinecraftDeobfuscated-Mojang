...
extends DiggerItem {
    ...
    private static final Object2IntMap<Block> MIN_LEVEL_FOR_DROPS = Util.make(new Object2IntOpenHashMap(), object2IntOpenHashMap -> {
        ...
        for (Block block : ImmutableList.of(Blocks.DIAMOND_BLOCK, Blocks.DIAMOND_ORE, Blocks.DEEPSLATE_DIAMOND_ORE, Blocks.EMERALD_ORE, Blocks.DEEPSLATE_EMERALD_ORE, Blocks.EMERALD_BLOCK, Blocks.GOLD_BLOCK, Blocks.GOLD_ORE, Blocks.DEEPSLATE_GOLD_ORE, Blocks.REDSTONE_ORE, Blocks.DEEPSLATE_REDSTONE_ORE, Blocks.AMETHYST_BLOCK, new Block[]{Blocks.AMETHYST_CLUSTER, Blocks.SMALL_AMETHYST_BUD, Blocks.MEDIUM_AMETHYST_BUD, Blocks.LARGE_AMETHYST_BUD})) {
