...
public class NoiseRouterData {
    ...
    public static NoiseRouter createNoiseRouter(NoiseSettings noiseSettings, boolean bl, boolean bl2, long l, Registry<NormalNoise.NoiseParameters> registry, WorldgenRandom.Algorithm algorithm) {
        DensityFunction densityFunction64;
        ...
        DensityFunction densityFunction43;
        DensityFunction densityFunction42;
        ...
        DensityFunction densityFunction4 = DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.AQUIFER_FLUID_LEVEL_SPREAD), 0.7142857142857143);
        ...
        DensityFunction densityFunction10 = DensityFunctions.rangeChoice(densityFunction9, Double.NEGATIVE_INFINITY, 0.03, DensityFunctions.constant(Double.NEGATIVE_INFINITY), densityFunction9);
        ...
        DensityFunction densityFunction12 = DensityFunctions.weirdScaledSampler(densityFunction11, Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_2D), QuantizedSpaghettiRarity::getSphaghettiRarity2D, 3.0);
        DensityFunction densityFunction13 = DensityFunctions.mappedNoise(Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_2D_ELEVATION), 0.0, noiseSettings.getMinCellY(), 8.0);
        DensityFunction densityFunction14 = DensityFunctions.cacheOnce(DensityFunctions.mappedNoise(Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_2D_THICKNESS), 2.0, 1.0, -0.6, -1.3));
        ...
        DensityFunction densityFunction19 = DensityFunctions.cacheOnce(DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_3D_RARITY), 2.0, 1.0));
        DensityFunction densityFunction20 = DensityFunctions.mappedNoise(Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_3D_THICKNESS), -0.065, -0.088);
        DensityFunction densityFunction21 = DensityFunctions.weirdScaledSampler(densityFunction19, Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_3D_1), QuantizedSpaghettiRarity::getSpaghettiRarity3D, 2.0);
        DensityFunction densityFunction22 = DensityFunctions.weirdScaledSampler(densityFunction19, Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_3D_2), QuantizedSpaghettiRarity::getSpaghettiRarity3D, 2.0);
        ...
        DensityFunction densityFunction25 = DensityFunctions.mappedNoise(Noises.instantiate(registry, positionalRandomFactory, Noises.SPAGHETTI_ROUGHNESS_MODULATOR), 0.0, -0.1);
        DensityFunction densityFunction26 = DensityFunctions.cacheOnce(DensityFunctions.mul(densityFunction25, DensityFunctions.add(densityFunction24.abs(), DensityFunctions.constant(-0.4))));
        ...
        DensityFunction densityFunction28 = DensityFunctions.add(DensityFunctions.add(densityFunction27, DensityFunctions.constant(0.37)), DensityFunctions.yClampedGradient(-10, 30, 0.3, 0.0));
        DensityFunction densityFunction29 = DensityFunctions.cacheOnce(DensityFunctions.min(densityFunction28, DensityFunctions.add(densityFunction26, densityFunction23)));
        ...
        DensityFunction densityFunction33 = DensityFunctions.yClampedGradient(i, j, i, j);
        ...
        DensityFunction densityFunction34 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.ORE_VEININESS), 1.5, 1.5), m, n, 0);
        float g = 4.0f;
        DensityFunction densityFunction35 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.ORE_VEIN_A), 4.0, 4.0), m, n, 0).abs();
        DensityFunction densityFunction36 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.ORE_VEIN_B), 4.0, 4.0), m, n, 0).abs();
        ...
        if (bl2) {
            densityFunction39 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.NOODLE), 1.0, 1.0), o, p, -1);
            DensityFunction densityFunction40 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.mappedNoise(Noises.instantiate(registry, positionalRandomFactory, Noises.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), o, p, 0);
            double h = 2.6666666666666665;
            DensityFunction densityFunction41 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), o, p, 0);
            densityFunction42 = NoiseRouterData.yLimitedInterpolatable(densityFunction33, DensityFunctions.noise(Noises.instantiate(registry, positionalRandomFactory, Noises.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), o, p, 0);
            densityFunction43 = DensityFunctions.mul(DensityFunctions.constant(1.5), DensityFunctions.max(densityFunction41.abs(), densityFunction42.abs()));
            densityFunction44 = DensityFunctions.rangeChoice(densityFunction39, Double.NEGATIVE_INFINITY, 0.0, DensityFunctions.constant(64.0), DensityFunctions.add(densityFunction40, densityFunction43));
        } else {
        ...
        if (algorithm != WorldgenRandom.Algorithm.LEGACY) {
            densityFunction39 = new BlendedNoise(positionalRandomFactory.fromHashOf(new ResourceLocation("terrain")), noiseSettings.noiseSamplingSettings(), noiseSettings.getCellWidth(), noiseSettings.getCellHeight());
            ...
            densityFunction39 = new BlendedNoise(algorithm.newInstance(l), noiseSettings.noiseSamplingSettings(), noiseSettings.getCellWidth(), noiseSettings.getCellHeight());
            ...
            normalNoise3 = NormalNoise.create(positionalRandomFactory.fromHashOf(Noises.SHIFT.location()), new NormalNoise.NoiseParameters(0, 0.0, new double[0]));
        }
        densityFunction42 = DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(normalNoise3)));
        densityFunction43 = DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(normalNoise3)));
        ...
        DensityFunction densityFunction47 = DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction42, densityFunction43, 0.25, Noises.instantiate(registry, positionalRandomFactory, bl3 ? Noises.CONTINENTALNESS_LARGE : Noises.CONTINENTALNESS)));
        DensityFunction densityFunction48 = DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction42, densityFunction43, 0.25, Noises.instantiate(registry, positionalRandomFactory, bl3 ? Noises.EROSION_LARGE : Noises.EROSION)));
        DensityFunction densityFunction49 = DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction42, densityFunction43, 0.25, Noises.instantiate(registry, positionalRandomFactory, Noises.RIDGE)));
        TerrainShaper terrainShaper = noiseSettings.terrainShaper();
        DensityFunction densityFunction50 = NoiseRouterData.splineWithBlending(densityFunction47, densityFunction48, densityFunction49, terrainShaper::offset, -0.81, 2.5, DensityFunctions.blendOffset());
        DensityFunction densityFunction51 = NoiseRouterData.splineWithBlending(densityFunction47, densityFunction48, densityFunction49, terrainShaper::factor, 0.0, 8.0, BLENDING_FACTOR);
        DensityFunction densityFunction52 = NoiseRouterData.splineWithBlending(densityFunction47, densityFunction48, densityFunction49, terrainShaper::jaggedness, 0.0, 1.28, BLENDING_JAGGEDNESS);
        ...
        if (noiseSettings.islandNoiseOverride()) {
            ...
            densityFunction56 = NoiseRouterData.noiseGradientDensity(densityFunction53, densityFunction51, densityFunction55);
            densityFunction57 = NoiseRouterData.noiseGradientDensity(densityFunction53, DensityFunctions.cache2d(densityFunction51), DensityFunctions.zero());
        }
        boolean bl4 = !bl;
        DensityFunction densityFunction58 = DensityFunctions.cacheOnce(DensityFunctions.add(densityFunction56, densityFunction39));
        DensityFunction densityFunction59 = DensityFunctions.add(DensityFunctions.add(DensityFunctions.constant(0.27), densityFunction32).clamp(-1.0, 1.0), DensityFunctions.add(DensityFunctions.constant(1.5), DensityFunctions.mul(DensityFunctions.constant(-0.64), densityFunction58)).clamp(0.0, 0.5));
        DensityFunction densityFunction60 = DensityFunctions.add(densityFunction31, densityFunction59);
        DensityFunction densityFunction61 = DensityFunctions.min(DensityFunctions.min(densityFunction60, densityFunction29), DensityFunctions.add(densityFunction18, densityFunction26));
        ...
        if (bl4) {
            ...
            densityFunction64 = DensityFunctions.min(densityFunction58, DensityFunctions.mul(DensityFunctions.constant(5.0), densityFunction29));
        ...
        densityFunction64 = DensityFunctions.slide(noiseSettings, densityFunction63);
        ...
        return new NoiseRouter(densityFunction, densityFunction2, densityFunction4, densityFunction3, positionalRandomFactory2, positionalRandomFactory3, densityFunction45, densityFunction46, densityFunction47, densityFunction48, densityFunction53, densityFunction49, densityFunction57, densityFunction67, densityFunction34, densityFunction37, densityFunction38, new OverworldBiomeBuilder().spawnTarget());
    }

    private static DensityFunction splineWithBlending(DensityFunction densityFunction, DensityFunction densityFunction2, DensityFunction densityFunction3, ToFloatFunction<TerrainShaper.Point> toFloatFunction, double d, double e, DensityFunction densityFunction4) {
