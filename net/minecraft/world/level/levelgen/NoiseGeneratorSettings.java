...
public final class NoiseGeneratorSettings {
    public static final Codec<NoiseGeneratorSettings> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)StructureSettings.CODEC.fieldOf("structures")).forGetter(NoiseGeneratorSettings::structureSettings), ((MapCodec)NoiseSettings.CODEC.fieldOf("noise")).forGetter(NoiseGeneratorSettings::noiseSettings), ((MapCodec)BlockState.CODEC.fieldOf("default_block")).forGetter(NoiseGeneratorSettings::getDefaultBlock), ((MapCodec)BlockState.CODEC.fieldOf("default_fluid")).forGetter(NoiseGeneratorSettings::getDefaultFluid), ((MapCodec)Codec.INT.fieldOf("bedrock_roof_position")).forGetter(NoiseGeneratorSettings::getBedrockRoofPosition), ((MapCodec)Codec.INT.fieldOf("bedrock_floor_position")).forGetter(NoiseGeneratorSettings::getBedrockFloorPosition), ((MapCodec)Codec.INT.fieldOf("sea_level")).forGetter(NoiseGeneratorSettings::seaLevel), ((MapCodec)Codec.INT.fieldOf("min_surface_level")).forGetter(NoiseGeneratorSettings::getMinSurfaceLevel), ((MapCodec)Codec.BOOL.fieldOf("disable_mob_generation")).forGetter(NoiseGeneratorSettings::disableMobGeneration), ((MapCodec)Codec.BOOL.fieldOf("aquifers_enabled")).forGetter(NoiseGeneratorSettings::isAquifersEnabled), ((MapCodec)Codec.BOOL.fieldOf("noise_caves_enabled")).forGetter(NoiseGeneratorSettings::isNoiseCavesEnabled), ((MapCodec)Codec.BOOL.fieldOf("deepslate_enabled")).forGetter(NoiseGeneratorSettings::isDeepslateEnabled), ((MapCodec)Codec.BOOL.fieldOf("ore_veins_enabled")).forGetter(NoiseGeneratorSettings::isOreVeinsEnabled)).apply((Applicative<NoiseGeneratorSettings, ?>)instance, NoiseGeneratorSettings::new));
    ...
    private NoiseGeneratorSettings(StructureSettings structureSettings, NoiseSettings noiseSettings, BlockState blockState, BlockState blockState2, int i, int j, int k, int l, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5) {
    ...
    private static NoiseGeneratorSettings endLikePreset(StructureSettings structureSettings, BlockState blockState, BlockState blockState2, boolean bl, boolean bl2, boolean bl3) {
        return new NoiseGeneratorSettings(structureSettings, NoiseSettings.create(bl3 ? 0 : 0, bl3 ? 256 : 128, new NoiseSamplingSettings(2.0, 1.0, 80.0, 160.0), new NoiseSlideSettings(-3000, 64, -46), new NoiseSlideSettings(-30, 7, 1), 2, 1, 0.0, 0.0, true, false, bl2, false), blockState, blockState2, Integer.MIN_VALUE, Integer.MIN_VALUE, bl3 ? 0 : 0, bl3 ? 0 : 0, bl, false, false, false, false);
    }
    ...
    private static NoiseGeneratorSettings overworld(StructureSettings structureSettings, boolean bl) {
        ...
        return new NoiseGeneratorSettings(structureSettings, NoiseSettings.create(0, 256, new NoiseSamplingSettings(0.9999999814507745, 0.9999999814507745, 80.0, 160.0), new NoiseSlideSettings(-10, 3, 0), new NoiseSlideSettings(15, 3, 0), 1, 2, 1.0, -0.46875, true, true, false, bl), Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), Integer.MIN_VALUE, 0, 63, 0, false, false, false, false, false);
    }

    static {
        NoiseGeneratorSettings.register(AMPLIFIED, NoiseGeneratorSettings.overworld(new StructureSettings(true), true));
        NoiseGeneratorSettings.register(NETHER, NoiseGeneratorSettings.netherLikePreset(new StructureSettings(false), Blocks.NETHERRACK.defaultBlockState(), Blocks.LAVA.defaultBlockState(), false));
        NoiseGeneratorSettings.register(END, NoiseGeneratorSettings.endLikePreset(new StructureSettings(false), Blocks.END_STONE.defaultBlockState(), Blocks.AIR.defaultBlockState(), true, true, false));
        NoiseGeneratorSettings.register(CAVES, NoiseGeneratorSettings.netherLikePreset(new StructureSettings(true), Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), true));
        NoiseGeneratorSettings.register(FLOATING_ISLANDS, NoiseGeneratorSettings.endLikePreset(new StructureSettings(true), Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, true));
    }
}
