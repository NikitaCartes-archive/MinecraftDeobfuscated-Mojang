...
extends ChunkGenerator {
    public static final Codec<FlatLevelSource> CODEC = ((MapCodec)FlatLevelGeneratorSettings.CODEC.fieldOf("settings")).xmap(FlatLevelSource::new, FlatLevelSource::settings).codec();
