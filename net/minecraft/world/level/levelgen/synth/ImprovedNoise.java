...
public final class ImprovedNoise {
    ...
    public double sampleAndLerp(int i, int j, int k, double d, double e, double f, double g, double h, double l) {
        ...
        int q = this.p(p) + k;
        int r = this.p(p + 1) + k;
        double s = ImprovedNoise.gradDot(this.p(n), d, e, f);
        double t = ImprovedNoise.gradDot(this.p(q), d - 1.0, e, f);
        double u = ImprovedNoise.gradDot(this.p(o), d, e - 1.0, f);
        double v = ImprovedNoise.gradDot(this.p(r), d - 1.0, e - 1.0, f);
        double w = ImprovedNoise.gradDot(this.p(n + 1), d, e, f - 1.0);
        double x = ImprovedNoise.gradDot(this.p(q + 1), d - 1.0, e, f - 1.0);
        double y = ImprovedNoise.gradDot(this.p(o + 1), d, e - 1.0, f - 1.0);
        double z = ImprovedNoise.gradDot(this.p(r + 1), d - 1.0, e - 1.0, f - 1.0);
