...
public class WorldGenSettings {
    ...
    private WorldGenSettings(long l, boolean bl, boolean bl2, LinkedHashMap<ResourceKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> linkedHashMap, Optional<String> optional) {
        this.seed = l;
    ...
    public static LinkedHashMap<ResourceKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> withOverworld(LinkedHashMap<ResourceKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> linkedHashMap, ChunkGenerator chunkGenerator) {
        ...
        for (Map.Entry<ResourceKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> entry : linkedHashMap.entrySet()) {
            if (Objects.equals(entry.getKey(), DimensionType.OVERWORLD_LOCATION)) continue;
    ...
    public WorldGenSettings withSeed(boolean bl, OptionalLong optionalLong) {
        ...
        if (optionalLong.isPresent()) {
            ...
            for (Map.Entry<ResourceKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> entry : this.dimensions.entrySet()) {
