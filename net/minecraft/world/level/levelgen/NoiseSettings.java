...
public class NoiseSettings {
    public static final Codec<NoiseSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codecs.intRange(0, 256).fieldOf("height")).forGetter(NoiseSettings::height), ((MapCodec)NoiseSamplingSettings.CODEC.fieldOf("sampling")).forGetter(NoiseSettings::noiseSamplingSettings), ((MapCodec)NoiseSlideSettings.CODEC.fieldOf("top_slide")).forGetter(NoiseSettings::topSlideSettings), ((MapCodec)NoiseSlideSettings.CODEC.fieldOf("bottom_slide")).forGetter(NoiseSettings::bottomSlideSettings), ((MapCodec)Codecs.intRange(1, 4).fieldOf("size_horizontal")).forGetter(NoiseSettings::noiseSizeHorizontal), ((MapCodec)Codecs.intRange(1, 4).fieldOf("size_vertical")).forGetter(NoiseSettings::noiseSizeVertical), ((MapCodec)Codec.DOUBLE.fieldOf("density_factor")).forGetter(NoiseSettings::densityFactor), ((MapCodec)Codec.DOUBLE.fieldOf("density_offset")).forGetter(NoiseSettings::densityOffset), ((MapCodec)Codec.BOOL.fieldOf("simplex_surface_noise")).forGetter(NoiseSettings::useSimplexSurfaceNoise), Codec.BOOL.optionalFieldOf("random_density_offset", false, Lifecycle.experimental()).forGetter(NoiseSettings::randomDensityOffset), Codec.BOOL.optionalFieldOf("island_noise_override", false, Lifecycle.experimental()).forGetter(NoiseSettings::islandNoiseOverride), Codec.BOOL.optionalFieldOf("amplified", false, Lifecycle.experimental()).forGetter(NoiseSettings::isAmplified)).apply((Applicative<NoiseSettings, ?>)instance, NoiseSettings::new));
    ...
    public NoiseSettings(int i, NoiseSamplingSettings noiseSamplingSettings, NoiseSlideSettings noiseSlideSettings, NoiseSlideSettings noiseSlideSettings2, int j, int k, double d, double e, boolean bl, boolean bl2, boolean bl3, boolean bl4) {
        this.height = i;
