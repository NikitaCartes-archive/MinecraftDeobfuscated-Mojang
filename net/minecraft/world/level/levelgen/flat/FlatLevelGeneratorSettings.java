...
extends ChunkGeneratorSettings {
    ...
    private static final ConfiguredFeature<?> MINESHAFT_COMPOSITE_FEATURE = Biome.makeComposite(Feature.MINESHAFT, new MineshaftConfiguration(0.004, MineshaftFeature.Type.NORMAL), FeatureDecorator.NOPE, DecoratorConfiguration.NONE);
    ...
    private static final ConfiguredFeature<?> PILLAGER_OUTPOST_COMPOSITE_FEATURE = Biome.makeComposite(Feature.PILLAGER_OUTPOST, new PillagerOutpostConfiguration(0.004), FeatureDecorator.NOPE, DecoratorConfiguration.NONE);
    ...
    public static FlatLevelGeneratorSettings fromString(String string) {
        ...
        flatLevelGeneratorSettings.updateLayers();
        Biome biome = iterator.hasNext() ? Registry.BIOME.get(new ResourceLocation(iterator.next())) : null;
        flatLevelGeneratorSettings.setBiome(biome == null ? Biomes.PLAINS : biome);
        if (iterator.hasNext()) {
            String[] strings;
