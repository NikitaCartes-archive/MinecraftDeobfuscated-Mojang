    ...
    public int getBaseHeight(int i, int j, Heightmap.Types types) {
        ...
        for (int p = this.chunkCountY - 1; p >= 0; --p) {
            ...
            for (int v = this.chunkHeight - 1; v >= 0; --v) {
                ...
                if (!(x > 0.0) && y >= o) continue;
                BlockState blockState = x > 0.0 ? this.defaultBlock : this.defaultFluid;
                if (!types.isOpaque().test(blockState)) continue;
                return y + 1;
            }
        }
        return 0;
                        ...
                        for (int ag = 0; ag < this.chunkWidth; ++ag) {
                            ...
                            for (int am = 0; am < this.chunkWidth; ++am) {
                                ...
                                while (objectListIterator2.hasNext()) {
                                    ...
                                    ar += NoiseBasedChunkGenerator.getContribution(av, as, at) * 0.4;
                                }
