...
extends Structure {
    public static final Codec<StrongholdStructure> CODEC = RecordCodecBuilder.create(instance -> StrongholdStructure.codec(instance).apply(instance, StrongholdStructure::new));
