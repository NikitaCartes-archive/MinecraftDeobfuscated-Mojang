...
extends SinglePieceStructure {
    public static final Codec<DesertPyramidStructure> CODEC = RecordCodecBuilder.create(instance -> DesertPyramidStructure.codec(instance).apply(instance, DesertPyramidStructure::new));
