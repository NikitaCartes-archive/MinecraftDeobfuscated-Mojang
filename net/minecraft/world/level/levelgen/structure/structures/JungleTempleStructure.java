...
extends SinglePieceStructure {
    public static final Codec<JungleTempleStructure> CODEC = RecordCodecBuilder.create(instance -> JungleTempleStructure.codec(instance).apply(instance, JungleTempleStructure::new));
