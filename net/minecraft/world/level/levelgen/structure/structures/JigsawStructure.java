...
extends Structure {
    public static final Codec<JigsawStructure> CODEC = RecordCodecBuilder.create(instance -> JigsawStructure.jigsawCodec(instance).apply((Applicative<RecordCodecBuilder.Mu<JigsawStructure>, ?>)instance, JigsawStructure::new));
