...
extends Structure {
    ...
    public static final Codec<NetherFortressStructure> CODEC = RecordCodecBuilder.create(instance -> NetherFortressStructure.codec(instance).apply(instance, NetherFortressStructure::new));
