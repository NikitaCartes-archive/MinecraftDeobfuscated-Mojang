...
extends Structure {
    public static final Codec<WoodlandMansionStructure> CODEC = RecordCodecBuilder.create(instance -> WoodlandMansionStructure.codec(instance).apply(instance, WoodlandMansionStructure::new));
