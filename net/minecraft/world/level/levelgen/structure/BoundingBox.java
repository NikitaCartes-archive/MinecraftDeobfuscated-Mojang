...
public class BoundingBox {
    public static final Codec<BoundingBox> CODEC = Codec.INT_STREAM.comapFlatMap(intStream -> Util.fixedSize(intStream, 6).map(is -> new BoundingBox(is[0], is[1], is[2], is[3], is[4], is[5])), boundingBox -> IntStream.of(boundingBox.x0, boundingBox.y0, boundingBox.z0, boundingBox.x1, boundingBox.y1, boundingBox.z1)).stable();
    public int x0;
    public int y0;
    public int z0;
    public int x1;
    ...
    public static BoundingBox createProper(Vec3i vec3i, Vec3i vec3i2) {
        return BoundingBox.createProper(vec3i.getX(), vec3i.getY(), vec3i.getZ(), vec3i2.getX(), vec3i2.getY(), vec3i2.getZ());
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof BoundingBox) {
            ...
            return this.x0 == boundingBox.x0 && this.y0 == boundingBox.y0 && this.z0 == boundingBox.z0 && this.x1 == boundingBox.x1 && this.y1 == boundingBox.y1 && this.z1 == boundingBox.z1;
        }
        return false;
    }
