...
extends StructureProcessor {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader levelReader, BlockPos blockPos, BlockPos blockPos2, StructureTemplate.StructureBlockInfo structureBlockInfo, StructureTemplate.StructureBlockInfo structureBlockInfo2, StructurePlaceSettings structurePlaceSettings) {
        ...
        if (blockState.hasProperty(StairBlock.FACING)) {
            blockState2 = (BlockState)blockState2.setValue(StairBlock.FACING, blockState.getValue(StairBlock.FACING));
        }
        if (blockState.hasProperty(StairBlock.HALF)) {
            blockState2 = (BlockState)blockState2.setValue(StairBlock.HALF, blockState.getValue(StairBlock.HALF));
        }
