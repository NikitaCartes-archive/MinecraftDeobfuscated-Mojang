...
extends ScatteredFeaturePiece {
    ...
    public boolean postProcess(LevelAccessor levelAccessor, ChunkGenerator<?> chunkGenerator, Random random, BoundingBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
        ...
        for (i = 1; i <= 9; ++i) {
            this.generateBox(levelAccessor, boundingBox, i, i, i, this.width - 1 - i, i, this.depth - 1 - i, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false);
            this.generateBox(levelAccessor, boundingBox, i + 1, i, i + 1, this.width - 2 - i, i, this.depth - 2 - i, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false);
        }
        ...
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            this.hasPlacedChest[direction.get2DDataValue()] = this.createChest(levelAccessor, boundingBox, random, 10 + m, -11, 10 + n, BuiltInLootTables.DESERT_PYRAMID);
        }
        return true;
    }
}
