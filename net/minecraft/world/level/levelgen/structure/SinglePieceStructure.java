...
extends Structure {
    ...
    protected SinglePieceStructure(PieceConstructor pieceConstructor, int i, int j, HolderSet<Biome> holderSet, Map<MobCategory, StructureSpawnOverride> map, GenerationStep.Decoration decoration, boolean bl) {
