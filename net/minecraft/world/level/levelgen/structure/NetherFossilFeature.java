...
extends RandomScatteredFeature<NoneFeatureConfiguration> {
    ...
    extends StructureStart {
        ...
        public void generatePieces(ChunkGenerator<?> chunkGenerator, StructureManager structureManager, int i, int j, Biome biome) {
            int k = i * 16;
            int l = j * 16;
            NetherFossilPieces.addPieces(structureManager, this.pieces, this.random, new BlockPos(k + this.random.nextInt(16), chunkGenerator.getSeaLevel(), l + this.random.nextInt(16)));
