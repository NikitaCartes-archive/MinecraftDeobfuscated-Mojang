...
extends NoiseAffectingStructureFeature<RangeDecoratorConfiguration> {
    public NetherFossilFeature(Codec<RangeDecoratorConfiguration> codec) {
        super(codec, NetherFossilFeature::generatePieces);
    }

    private static void generatePieces(StructurePiecesBuilder structurePiecesBuilder, RangeDecoratorConfiguration rangeDecoratorConfiguration, PieceGenerator.Context context) {
