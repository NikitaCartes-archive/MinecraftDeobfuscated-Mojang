...
public abstract class StructureStart {
    public static final StructureStart INVALID_START = new StructureStart((StructureFeature)Feature.MINESHAFT, 0, 0, Biomes.PLAINS, BoundingBox.getUnknownBox(), 0, 0L){
    ...
    public void postProcess(LevelAccessor levelAccessor, Random random, BoundingBox boundingBox, ChunkPos chunkPos) {
        ...
        synchronized (list) {
            ...
            while (iterator.hasNext()) {
                ...
                if (!structurePiece.getBoundingBox().intersects(boundingBox) || structurePiece.postProcess(levelAccessor, random, boundingBox, chunkPos)) continue;
                iterator.remove();
            }
