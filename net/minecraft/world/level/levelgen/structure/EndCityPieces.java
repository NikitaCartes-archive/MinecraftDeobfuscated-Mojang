...
public class EndCityPieces {
    ...
    static final SectionGenerator HOUSE_TOWER_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureManager structureManager, int i, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, Random random) {
            ...
            if (j == 0) {
                ...
                EndCityPieces.recursiveChildren(structureManager, TOWER_GENERATOR, i + 1, endCityPiece2, null, list, random);
            } else if (j == 2) {
                endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
        ...
        public boolean generate(StructureManager structureManager, int i, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, Random random) {
            ...
            if (endCityPiece3 != null) {
                for (Tuple<Rotation, BlockPos> tuple : TOWER_BRIDGES) {
                    ...
                    EndCityPiece endCityPiece4 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece3, tuple.getB(), "bridge_end", rotation.getRotated(tuple.getA()), true));
                    EndCityPieces.recursiveChildren(structureManager, TOWER_BRIDGE_GENERATOR, i + 1, endCityPiece4, null, list, random);
                }
                ...
                return EndCityPieces.recursiveChildren(structureManager, FAT_TOWER_GENERATOR, i + 1, endCityPiece2, null, list, random);
            }
            return true;
        }
    };
        ...
        public boolean generate(StructureManager structureManager, int i, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, Random random) {
            ...
            for (int l = 0; l < j; ++l) {
                if (random.nextBoolean()) {
                    endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(0, k, -4), "bridge_piece", rotation, true));
                    k = 0;
                    continue;
                }
                endCityPiece2 = random.nextBoolean() ? EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(0, k, -4), "bridge_steep_stairs", rotation, true)) : EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(0, k, -8), "bridge_gentle_stairs", rotation, true));
                k = 4;
            }
            if (this.shipCreated || random.nextInt(10 - i) != 0) {
                if (!EndCityPieces.recursiveChildren(structureManager, HOUSE_TOWER_GENERATOR, i + 1, endCityPiece2, new BlockPos(-3, k + 1, -11), list, random)) {
                    return false;
                }
            } else {
                EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(-8 + random.nextInt(8), k, -70 + random.nextInt(10)), "ship", rotation, true));
                this.shipCreated = true;
            }
            endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(4, k, 0), "bridge_end", rotation.getRotated(Rotation.CLOCKWISE_180), true));
            endCityPiece2.genDepth = -1;
            return true;
        }
    };
        ...
        public boolean generate(StructureManager structureManager, int i, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, Random random) {
            ...
            for (int j = 0; j < 2 && random.nextInt(3) != 0; ++j) {
                ...
                for (Tuple<Rotation, BlockPos> tuple : FAT_TOWER_BRIDGES) {
                    if (!random.nextBoolean()) continue;
                    EndCityPiece endCityPiece3 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureManager, endCityPiece2, tuple.getB(), "bridge_end", rotation.getRotated(tuple.getA()), true));
                    EndCityPieces.recursiveChildren(structureManager, TOWER_BRIDGE_GENERATOR, i + 1, endCityPiece3, null, list, random);
                }
            }
    ...
    static EndCityPiece addPiece(StructureManager structureManager, EndCityPiece endCityPiece, BlockPos blockPos, String string, Rotation rotation, boolean bl) {
    ...
    static boolean recursiveChildren(StructureManager structureManager, SectionGenerator sectionGenerator, int i, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, Random random) {
        if (i > 8) {
            return false;
        }
