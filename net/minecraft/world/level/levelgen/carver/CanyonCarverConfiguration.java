...
extends CarverConfiguration {
    public static final Codec<CanyonCarverConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).forGetter(canyonCarverConfiguration -> Float.valueOf(canyonCarverConfiguration.probability)), CarverDebugSettings.CODEC.optionalFieldOf("debug_settings", CarverDebugSettings.DEFAULT).forGetter(CarverConfiguration::getDebugSettings), ((MapCodec)VerticalAnchor.CODEC.fieldOf("bottom_inclusive")).forGetter(CanyonCarverConfiguration::getBottomInclusive), ((MapCodec)VerticalAnchor.CODEC.fieldOf("top_inclusive")).forGetter(CanyonCarverConfiguration::getTopInclusive), ((MapCodec)UniformInt.CODEC.fieldOf("y_scale")).forGetter(CanyonCarverConfiguration::getYScale), ((MapCodec)FloatProvider.codec(0.0f, 1.0f).fieldOf("distance_factor")).forGetter(CanyonCarverConfiguration::getDistanceFactor), ((MapCodec)FloatProvider.CODEC.fieldOf("vertical_rotation")).forGetter(CanyonCarverConfiguration::getVerticalRotation), ((MapCodec)FloatProvider.CODEC.fieldOf("thickness")).forGetter(CanyonCarverConfiguration::getThickness), ((MapCodec)Codec.intRange(0, Integer.MAX_VALUE).fieldOf("width_smoothness")).forGetter(CanyonCarverConfiguration::getWidthSmoothness), ((MapCodec)FloatProvider.CODEC.fieldOf("horizontal_radius_factor")).forGetter(CanyonCarverConfiguration::getHorizontalRadiusFactor), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_default_factor")).forGetter(CanyonCarverConfiguration::getVerticalRadiusDefaultFactor), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_center_factor")).forGetter(CanyonCarverConfiguration::getVerticalRadiusCenterFactor)).apply((Applicative<CanyonCarverConfiguration, ?>)instance, CanyonCarverConfiguration::new));
