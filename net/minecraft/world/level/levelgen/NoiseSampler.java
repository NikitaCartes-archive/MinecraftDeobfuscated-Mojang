...
implements Climate.Sampler {
    ...
    public NoiseSampler(int i, int j, int k, NoiseSettings noiseSettings, NoiseOctaves noiseOctaves, boolean bl, long l, WorldgenRandom.Algorithm algorithm) {
        ...
        this.veininess = NoiseSampler.yLimitedInterpolatableNoise(n, o, 0, 1.5, randomSource5.fork(), -8, 1.0);
        this.veinA = NoiseSampler.yLimitedInterpolatableNoise(n, o, 0, 4.0, randomSource5.fork(), -7, 1.0);
        this.veinB = NoiseSampler.yLimitedInterpolatableNoise(n, o, 0, 4.0, randomSource5.fork(), -7, 1.0);
        ...
        this.noodleToggle = NoiseSampler.yLimitedInterpolatableNoise(p, q, -1, 1.0, randomSource6.fork(), -8, 1.0);
    ...
    private static NoiseChunk.InterpolatableNoise yLimitedInterpolatableNoise(int i, int j, int k, double d, RandomSource randomSource, int l2, double ... ds) {
        NormalNoise normalNoise = NormalNoise.create(randomSource, l2, ds);
