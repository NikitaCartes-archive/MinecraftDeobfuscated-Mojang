...
public class DecoratorNoiseCountFactor
implements DecoratorConfiguration {
    ...
    public DecoratorNoiseCountFactor(int i, double d, double e, Heightmap.Types types) {
    ...
    public static DecoratorNoiseCountFactor deserialize(Dynamic<?> dynamic) {
        ...
        return new DecoratorNoiseCountFactor(i, d, e, types);
    }
}
