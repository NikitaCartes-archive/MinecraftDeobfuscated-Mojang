...
public class ConfiguredDecorator<DC extends DecoratorConfiguration> {
    ...
    public <FC extends FeatureConfiguration, F extends Feature<FC>> boolean place(LevelAccessor levelAccessor, StructureFeatureManager structureFeatureManager, ChunkGenerator<? extends ChunkGeneratorSettings> chunkGenerator, Random random, BlockPos blockPos, ConfiguredFeature<FC, F> configuredFeature) {
        return this.decorator.placeFeature(levelAccessor, structureFeatureManager, chunkGenerator, random, blockPos, this.config, configuredFeature);
    }
