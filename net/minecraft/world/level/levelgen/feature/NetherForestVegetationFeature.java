...
extends Feature<BlockPileConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<BlockPileConfiguration> featurePlaceContext) {
        return NetherForestVegetationFeature.place(featurePlaceContext.level(), featurePlaceContext.random(), featurePlaceContext.origin(), featurePlaceContext.config(), 8, 4);
    }
