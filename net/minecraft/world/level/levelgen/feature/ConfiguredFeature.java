...
implements Decoratable<ConfiguredFeature<?, ?>> {
    public static final MapCodec<ConfiguredFeature<?, ?>> DIRECT_CODEC = Registry.FEATURE.dispatchMap(configuredFeature -> configuredFeature.feature, Feature::configuredCodec);
