...
implements Decoratable<ConfiguredFeature<?, ?>> {
    public static final MapCodec<ConfiguredFeature<?, ?>> DIRECT_CODEC = Registry.FEATURE.dispatchMap("name", configuredFeature -> configuredFeature.feature, Feature::configuredCodec).orElseGet(ConfiguredFeature::nope);
