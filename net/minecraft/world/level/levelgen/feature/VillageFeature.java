...
extends StructureFeature<JigsawConfiguration> {
    ...
    extends BeardedStructureStart<JigsawConfiguration> {
        ...
        @Override
        public void generatePieces(ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int j, Biome biome, JigsawConfiguration jigsawConfiguration) {
