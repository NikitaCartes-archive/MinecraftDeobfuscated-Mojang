...
extends Feature<RandomRandomFeatureConfiguration> {
    ...
    @Override
    public boolean place(WorldGenLevel worldGenLevel, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, RandomRandomFeatureConfiguration randomRandomFeatureConfiguration) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            configuredFeature.place(worldGenLevel, chunkGenerator, random, blockPos);
        }
        return true;
    }
}
