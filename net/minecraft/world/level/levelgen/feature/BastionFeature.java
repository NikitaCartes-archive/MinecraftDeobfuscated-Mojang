...
extends StructureFeature<MultiJigsawConfiguration> {
    ...
    extends BeardedStructureStart<MultiJigsawConfiguration> {
        ...
        @Override
        public void generatePieces(ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int j, Biome biome, MultiJigsawConfiguration multiJigsawConfiguration) {
