...
public abstract class Feature<FC extends FeatureConfiguration> {
    ...
    public static final Feature<BlockBlobConfiguration> FOREST_ROCK = Feature.register("forest_rock", new BlockBlobFeature(BlockBlobConfiguration.CODEC));
    public static final Feature<DiskConfiguration> DISK = Feature.register("disk", new DiskReplaceFeature(DiskConfiguration.CODEC));
    public static final Feature<FeatureRadiusConfiguration> ICE_PATCH = Feature.register("ice_patch", new IcePatchFeature(FeatureRadiusConfiguration.CODEC));
    ...
    public static final Feature<SeagrassFeatureConfiguration> SEAGRASS = Feature.register("seagrass", new SeagrassFeature(SeagrassFeatureConfiguration.CODEC));
    ...
    public static final Feature<CountFeatureConfiguration> SEA_PICKLE = Feature.register("sea_pickle", new SeaPickleFeature(CountFeatureConfiguration.CODEC));
    ...
    public static final Feature<ReplaceSpheroidConfiguration> REPLACE_BLOBS = Feature.register("netherrack_replace_blobs", new ReplaceBlobsFeature(ReplaceSpheroidConfiguration.CODEC));
    ...
    public static final Feature<RandomRandomFeatureConfiguration> RANDOM_RANDOM_SELECTOR = Feature.register("random_random_selector", new RandomRandomFeature(RandomRandomFeatureConfiguration.CODEC));
    ...
    public Feature(Codec<FC> codec) {
        this.configuredCodec = ((MapCodec)codec.fieldOf("config")).xmap(featureConfiguration -> new ConfiguredFeature<FeatureConfiguration, Feature>(this, (FeatureConfiguration)featureConfiguration), configuredFeature -> configuredFeature.config).codec();
    }
