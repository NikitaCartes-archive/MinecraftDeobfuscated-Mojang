...
implements FeatureConfiguration {
    ...
    public <F extends FeatureConfiguration, D extends DecoratorConfiguration> DecoratedFeatureConfiguration(Feature<F> feature, F featureConfiguration, FeatureDecorator<D> featureDecorator, D decoratorConfiguration) {
        this(new ConfiguredFeature<F>(feature, featureConfiguration), new ConfiguredDecorator<D>(featureDecorator, decoratorConfiguration));
    }
