...
extends TrunkPlacer {
    ...
    public static final Codec<CherryTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> CherryTrunkPlacer.trunkPlacerParts(instance).and(instance.group(((MapCodec)IntProvider.codec(1, 3).fieldOf("branch_count")).forGetter(cherryTrunkPlacer -> cherryTrunkPlacer.branchCount), ((MapCodec)IntProvider.codec(2, 16).fieldOf("branch_horizontal_length")).forGetter(cherryTrunkPlacer -> cherryTrunkPlacer.branchHorizontalLength), ((MapCodec)IntProvider.codec(-16, 0, BRANCH_START_CODEC).fieldOf("branch_start_offset_from_top")).forGetter(cherryTrunkPlacer -> cherryTrunkPlacer.branchStartOffsetFromTop), ((MapCodec)IntProvider.codec(-16, 16).fieldOf("branch_end_offset_from_top")).forGetter(cherryTrunkPlacer -> cherryTrunkPlacer.branchEndOffsetFromTop))).apply((Applicative<CherryTrunkPlacer, ?>)instance, CherryTrunkPlacer::new));
