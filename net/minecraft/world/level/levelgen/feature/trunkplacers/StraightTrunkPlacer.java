...
extends TrunkPlacer {
    public static final Codec<StraightTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> StraightTrunkPlacer.trunkPlacerParts(instance).apply(instance, StraightTrunkPlacer::new));
