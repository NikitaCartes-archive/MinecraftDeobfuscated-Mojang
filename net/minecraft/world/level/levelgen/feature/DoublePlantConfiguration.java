...
public class DoublePlantConfiguration
implements FeatureConfiguration {
    public final BlockState state;

    public DoublePlantConfiguration(BlockState blockState) {
    ...
    public static <T> DoublePlantConfiguration deserialize(Dynamic<T> dynamic) {
        BlockState blockState = dynamic.get("state").map(BlockState::deserialize).orElse(Blocks.AIR.defaultBlockState());
        return new DoublePlantConfiguration(blockState);
    }
}
