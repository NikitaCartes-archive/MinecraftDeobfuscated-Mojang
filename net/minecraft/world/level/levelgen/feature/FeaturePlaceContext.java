...
public class FeaturePlaceContext<FC extends FeatureConfiguration> {
    ...
    public FeaturePlaceContext(Optional<ConfiguredFeature<?, ?>> optional, WorldGenLevel worldGenLevel, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, FC featureConfiguration) {
