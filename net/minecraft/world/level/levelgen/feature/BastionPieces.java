...
import net.minecraft.world.level.levelgen.feature.BastionBridgePools;
import net.minecraft.world.level.levelgen.feature.BastionHoglinStablePools;
import net.minecraft.world.level.levelgen.feature.BastionHousingUnitsPools;
import net.minecraft.world.level.levelgen.feature.BastionSharedPools;
import net.minecraft.world.level.levelgen.feature.BastionTreasureRoomPools;
...
public class BastionPieces {
    public static final ImmutableMap<String, Integer> POOLS = ImmutableMap.builder().put("bastion/units/base", 60).put("bastion/hoglin_stable/origin", 60).put("bastion/treasure/starters", 60).put("bastion/bridge/start", 60).build();
    ...
    public static class BastionPiece
    extends PoolElementStructurePiece {
        public BastionPiece(StructureManager structureManager, StructurePoolElement structurePoolElement, BlockPos blockPos, int i, Rotation rotation, BoundingBox boundingBox) {
