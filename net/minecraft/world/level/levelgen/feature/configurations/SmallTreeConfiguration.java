...
extends TreeConfiguration {
    ...
    protected SmallTreeConfiguration(BlockStateProvider blockStateProvider, BlockStateProvider blockStateProvider2, FoliagePlacer foliagePlacer, List<TreeDecorator> list, int i, int j, int k, int l, int m, int n, int o, int p, int q, int r, boolean bl) {
    ...
    extends TreeConfiguration.TreeConfigurationBuilder {
        ...
        @Override
        public SmallTreeConfigurationBuilder baseHeight(int i) {
            this.baseHeight = i;
            return this;
        }

        public SmallTreeConfigurationBuilder heightRandA(int i) {
            this.heightRandA = i;
            return this;
        }

        public SmallTreeConfigurationBuilder heightRandB(int i) {
            this.heightRandB = i;
            return this;
        }

        public SmallTreeConfigurationBuilder trunkHeight(int i) {
            this.trunkHeight = i;
            return this;
        }

        public SmallTreeConfigurationBuilder trunkHeightRandom(int i) {
            this.trunkHeightRandom = i;
            return this;
        }

        public SmallTreeConfigurationBuilder trunkTopOffset(int i) {
            this.trunkTopOffset = i;
            return this;
        }

        public SmallTreeConfigurationBuilder trunkTopOffsetRandom(int i) {
            this.trunkTopOffsetRandom = i;
            return this;
        }

        public SmallTreeConfigurationBuilder foliageHeight(int i) {
            this.foliageHeight = i;
            return this;
        }

        public SmallTreeConfigurationBuilder foliageHeightRandom(int i) {
        ...
        @Override
        public /* synthetic */ TreeConfiguration.TreeConfigurationBuilder baseHeight(int i) {
