...
extends TreeConfiguration {
    ...
    extends TreeConfiguration.TreeConfigurationBuilder {
        ...
        public MegaTreeConfigurationBuilder decorators(List<TreeDecorator> list) {
            this.decorators = list;
            return this;
        }

        @Override
        public MegaTreeConfigurationBuilder baseHeight(int i) {
            this.baseHeight = i;
            return this;
        }

        public MegaTreeConfigurationBuilder heightInterval(int i) {
