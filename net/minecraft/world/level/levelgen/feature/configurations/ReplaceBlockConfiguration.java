...
implements FeatureConfiguration {
    public static final Codec<ReplaceBlockConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.list(OreConfiguration.TargetBlockState.CODEC).fieldOf("targets")).forGetter(replaceBlockConfiguration -> replaceBlockConfiguration.targetStates)).apply((Applicative<ReplaceBlockConfiguration, ?>)instance, ReplaceBlockConfiguration::new));
