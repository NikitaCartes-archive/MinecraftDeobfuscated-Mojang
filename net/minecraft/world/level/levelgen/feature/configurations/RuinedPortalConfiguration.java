...
implements FeatureConfiguration {
    ...
    public <T> Dynamic<T> serialize(DynamicOps<T> dynamicOps) {
        return new Dynamic<T>(dynamicOps, dynamicOps.createMap(ImmutableMap.of(dynamicOps.createString("portal_type"), dynamicOps.createString(this.portalType.getName()))));
    }
