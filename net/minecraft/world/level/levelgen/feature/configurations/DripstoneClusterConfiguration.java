...
implements FeatureConfiguration {
    ...
    public DripstoneClusterConfiguration(int i, UniformInt uniformInt, UniformInt uniformInt2, int j, int k, UniformInt uniformInt3, FloatProvider floatProvider, FloatProvider floatProvider2, float f, int l, int m) {
