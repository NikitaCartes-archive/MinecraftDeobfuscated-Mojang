...
public class ReplaceSpheroidConfiguration
implements FeatureConfiguration {
    public static final Codec<ReplaceSpheroidConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockState.CODEC.fieldOf("target")).forGetter(replaceSpheroidConfiguration -> replaceSpheroidConfiguration.targetState), ((MapCodec)BlockState.CODEC.fieldOf("state")).forGetter(replaceSpheroidConfiguration -> replaceSpheroidConfiguration.replaceState), ((MapCodec)Vec3i.CODEC.fieldOf("minimum_reach")).forGetter(replaceSpheroidConfiguration -> replaceSpheroidConfiguration.minimumReach), ((MapCodec)Vec3i.CODEC.fieldOf("maximum_reach")).forGetter(replaceSpheroidConfiguration -> replaceSpheroidConfiguration.maximumReach)).apply((Applicative<ReplaceSpheroidConfiguration, ?>)instance, ReplaceSpheroidConfiguration::new));
    ...
    public static class Builder {
        ...
        public Builder targetBlockState(BlockState blockState) {
            this.target = blockState;
            return this;
        }

        public Builder replaceWithBlockState(BlockState blockState) {
            this.state = blockState;
            return this;
        }

        public Builder minimumReach(Vec3i vec3i) {
            this.minimumReach = vec3i;
            return this;
        }

        public Builder maximumReach(Vec3i vec3i) {
