...
implements FeatureConfiguration {
    ...
    public RootSystemConfiguration(Supplier<PlacedFeature> supplier, int i, int j, ResourceLocation resourceLocation, BlockStateProvider blockStateProvider, int k, int l, int m, int n, BlockStateProvider blockStateProvider2, int o, int p) {
