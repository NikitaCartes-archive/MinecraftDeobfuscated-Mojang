...
implements FeatureConfiguration {
    ...
    public VegetationPatchConfiguration(ResourceLocation resourceLocation, BlockStateProvider blockStateProvider, Supplier<PlacedFeature> supplier, CaveSurface caveSurface, IntProvider intProvider, float f, int i, float g, IntProvider intProvider2, float h) {
