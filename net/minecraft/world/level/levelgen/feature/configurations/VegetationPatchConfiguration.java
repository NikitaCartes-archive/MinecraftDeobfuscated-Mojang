...
implements FeatureConfiguration {
    ...
    public VegetationPatchConfiguration(ResourceLocation resourceLocation, BlockStateProvider blockStateProvider, Supplier<ConfiguredFeature<?, ?>> supplier, CaveSurface caveSurface, UniformInt uniformInt, float f, int i, float g, UniformInt uniformInt2, float h) {
