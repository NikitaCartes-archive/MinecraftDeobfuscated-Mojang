...
extends StructureFeature<BuriedTreasureConfiguration> {
    public BuriedTreasureFeature(Codec<BuriedTreasureConfiguration> codec) {
        super(codec);
    }

    @Override
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeSource biomeSource, long l, WorldgenRandom worldgenRandom, int i, int j, Biome biome, ChunkPos chunkPos, BuriedTreasureConfiguration buriedTreasureConfiguration) {
    ...
    extends StructureStart<BuriedTreasureConfiguration> {
        ...
        @Override
        public void generatePieces(ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int j, Biome biome, BuriedTreasureConfiguration buriedTreasureConfiguration) {
            int k = i * 16;
            int l = j * 16;
