...
extends Feature<SpikeConfiguration> {
    ...
    @Override
    public boolean place(LevelAccessor levelAccessor, ChunkGenerator<? extends ChunkGeneratorSettings> chunkGenerator, Random random, BlockPos blockPos, SpikeConfiguration spikeConfiguration) {
    ...
    private void placeSpike(LevelAccessor levelAccessor, Random random, SpikeConfiguration spikeConfiguration, EndSpike endSpike) {
        int i = endSpike.getRadius();
        for (BlockPos blockPos : BlockPos.betweenClosed(new BlockPos(endSpike.getCenterX() - i, 0, endSpike.getCenterZ() - i), new BlockPos(endSpike.getCenterX() + i, endSpike.getHeight() + 10, endSpike.getCenterZ() + i))) {
    ...
    public static class EndSpike {
        ...
        public EndSpike(int i, int j, int k, int l, boolean bl) {
            ...
            this.height = l;
            this.guarded = bl;
            this.topBoundingBox = new AABB(i - k, 0.0, j - k, i + k, 256.0, j + k);
        }
