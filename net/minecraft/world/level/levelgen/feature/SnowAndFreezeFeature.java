    ...
    public boolean place(LevelAccessor levelAccessor, ChunkGenerator<? extends ChunkGeneratorSettings> chunkGenerator, Random random, BlockPos blockPos, NoneFeatureConfiguration noneFeatureConfiguration) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                if (!biome.shouldSnow(levelAccessor, mutableBlockPos)) continue;
                ...
                levelAccessor.setBlock(mutableBlockPos2, (BlockState)blockState.setValue(SnowyDirtBlock.SNOWY, true), 2);
            }
        }
        return true;
    }
