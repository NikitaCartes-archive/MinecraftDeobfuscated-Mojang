...
extends Feature<CountFeatureConfiguration> {
    public SeaPickleFeature(Codec<CountFeatureConfiguration> codec) {
        super(codec);
    }

    @Override
    public boolean place(WorldGenLevel worldGenLevel, StructureFeatureManager structureFeatureManager, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, CountFeatureConfiguration countFeatureConfiguration) {
        int i = 0;
