...
extends Feature<CountFeatureConfiguration> {
    ...
    @Override
    public boolean place(WorldGenLevel worldGenLevel, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, CountFeatureConfiguration countFeatureConfiguration) {
        int i = 0;
