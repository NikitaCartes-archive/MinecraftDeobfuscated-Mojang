...
extends RandomScatteredFeature<ShipwreckConfiguration> {
    ...
    protected int getSpacing(ChunkGenerator<?> chunkGenerator) {
        return ((ChunkGeneratorSettings)chunkGenerator.getSettings()).getShipwreckSpacing();
    }

    @Override
    protected int getSeparation(ChunkGenerator<?> chunkGenerator) {
        return ((ChunkGeneratorSettings)chunkGenerator.getSettings()).getShipwreckSeparation();
    }
