...
public class FoliagePlacerType<P extends FoliagePlacer> {
    ...
    public static final FoliagePlacerType<FancyFoliagePlacer> FANCY_FOLIAGE_PLACER = FoliagePlacerType.register("fancy_foliage_placer", FancyFoliagePlacer::new);
    public static final FoliagePlacerType<MegaJungleFoliagePlacer> MEGA_JUNGLE_FOLIAGE_PLACER = FoliagePlacerType.register("jungle_foliage_placer", MegaJungleFoliagePlacer::new);
