...
extends Feature<MultifaceGrowthConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<MultifaceGrowthConfiguration> featurePlaceContext) {
        ...
        List<Direction> list = MultifaceGrowthFeature.getShuffledDirections(multifaceGrowthConfiguration, randomSource);
        ...
        block0: for (Direction direction : list) {
            ...
            List<Direction> list2 = MultifaceGrowthFeature.getShuffledDirectionsExcept(multifaceGrowthConfiguration, randomSource, direction.getOpposite());
    ...
    public static List<Direction> getShuffledDirectionsExcept(MultifaceGrowthConfiguration multifaceGrowthConfiguration, RandomSource randomSource, Direction direction) {
        return Util.shuffledCopy(multifaceGrowthConfiguration.validDirections.stream().filter(direction2 -> direction2 != direction).collect(Collectors.toList()), randomSource);
    }
