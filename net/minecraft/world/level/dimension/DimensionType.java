...
implements Serializable {
    public static final DimensionType OVERWORLD = DimensionType.register("overworld", new DimensionType(1, "", "", NormalDimension::new, true, false, false, FuzzyOffsetConstantColumnBiomeZoomer.INSTANCE));
    public static final DimensionType NETHER = DimensionType.register("the_nether", new DimensionType(0, "_nether", "DIM-1", NetherDimension::new, false, true, true, FuzzyOffsetBiomeZoomer.INSTANCE));
    public static final DimensionType THE_END = DimensionType.register("the_end", new DimensionType(2, "_end", "DIM1", TheEndDimension::new, false, false, false, FuzzyOffsetBiomeZoomer.INSTANCE));
    ...
    protected DimensionType(int i, String string, String string2, BiFunction<Level, DimensionType, ? extends Dimension> biFunction, boolean bl, boolean bl2, boolean bl3, BiomeZoomer biomeZoomer) {
        this.id = i;
