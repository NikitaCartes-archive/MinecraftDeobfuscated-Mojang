...
extends Dimension {
    ...
    public ChunkGenerator<? extends ChunkGeneratorSettings> createRandomLevelGenerator() {
        ...
        if (levelType == LevelType.BUFFET) {
            ...
            if (jsonObject2 != null && jsonObject2.has("type") && jsonObject2.has("options")) {
                ...
                if (BiomeSourceType.VANILLA_LAYERED == biomeSourceType4) {
                    OverworldBiomeSourceSettings overworldBiomeSourceSettings = biomeSourceType2.createSettings().setGeneratorSettings(new OverworldGeneratorSettings()).setLevelData(this.level.getLevelData());
        ...
        OverworldBiomeSourceSettings overworldBiomeSourceSettings2 = biomeSourceType2.createSettings().setLevelData(this.level.getLevelData()).setGeneratorSettings(overworldGeneratorSettings2);
