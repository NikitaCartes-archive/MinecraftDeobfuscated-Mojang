...
public record VibrationInfo(GameEvent gameEvent, float distance, Vec3 pos, @Nullable UUID uuid, @Nullable UUID projectileOwnerUuid, @Nullable Entity entity) {
    public static final Codec<VibrationInfo> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Registry.GAME_EVENT.byNameCodec().fieldOf("game_event")).forGetter(VibrationInfo::gameEvent), ((MapCodec)Codec.floatRange(0.0f, Float.MAX_VALUE).fieldOf("distance")).forGetter(VibrationInfo::distance), ((MapCodec)Vec3.CODEC.fieldOf("pos")).forGetter(VibrationInfo::pos), ExtraCodecs.UUID.optionalFieldOf("source").forGetter(vibrationInfo -> Optional.ofNullable(vibrationInfo.uuid())), ExtraCodecs.UUID.optionalFieldOf("projectile_owner").forGetter(vibrationInfo -> Optional.ofNullable(vibrationInfo.projectileOwnerUuid()))).apply((Applicative<VibrationInfo, ?>)instance, (gameEvent, float_, vec3, optional, optional2) -> new VibrationInfo((GameEvent)gameEvent, float_.floatValue(), (Vec3)vec3, optional.orElse(null), optional2.orElse(null))));
