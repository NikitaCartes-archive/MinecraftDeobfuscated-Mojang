...
WorldData {
    ...
    public PrimaryLevelData(CompoundTag compoundTag, DataFixer dataFixer, int i, @Nullable CompoundTag compoundTag2) {
        ...
        if (compoundTag.contains("generatorName", 8)) {
            ...
            Dynamic<CompoundTag> dynamic2 = PrimaryLevelData.datafixGeneratorOptions((LevelType)levelType, dynamic, i, dataFixer);
    ...
    public LevelData getLevelData(DimensionType dimensionType) {
        return dimensionType == DimensionType.OVERWORLD ? this : new DerivedLevelData(dimensionType, this, this);
    }

    @Override
    public LevelSettings getLevelSettings() {
        LevelSettings levelSettings = new LevelSettings(this.levelName, this.seed, this.gameType, this.generateMapFeatures, this.hardcore, this.difficulty, this.generatorProvider, this.gameRules.copy());
