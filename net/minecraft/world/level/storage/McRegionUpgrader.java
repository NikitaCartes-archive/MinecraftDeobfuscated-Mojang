...
public class McRegionUpgrader {
    ...
    static boolean convertLevel(LevelStorageSource.LevelStorageAccess levelStorageAccess, ProgressListener progressListener) {
        ...
        RegistryReadOps<Tag> registryReadOps = RegistryReadOps.create(NbtOps.INSTANCE, ResourceManager.Empty.INSTANCE, (RegistryAccess)registryHolder);
        ...
        McRegionUpgrader.convertRegions(registryHolder, new File(file3, "region"), list3, new FixedBiomeSource(registry.getOrThrow(Biomes.THE_END)), list.size() + list2.size(), i, progressListener);
