...
public class LootContextParamSets {
    ...
    public static final LootContextParamSet FISHING = LootContextParamSets.register("fishing", builder -> builder.required(LootContextParams.BLOCK_POS).required(LootContextParams.TOOL).optional(LootContextParams.THIS_ENTITY));
