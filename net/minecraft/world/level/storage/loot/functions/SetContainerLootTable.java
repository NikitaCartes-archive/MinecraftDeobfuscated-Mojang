...
extends LootItemConditionalFunction {
    ...
    public static LootItemConditionalFunction.Builder<?> withLootTable(BlockEntityType<?> blockEntityType, ResourceLocation resourceLocation) {
        return SetContainerLootTable.simpleBuilder(lootItemConditions -> new SetContainerLootTable((LootItemCondition[])lootItemConditions, resourceLocation, 0L, blockEntityType));
    }
    ...
    public static LootItemConditionalFunction.Builder<?> withLootTable(BlockEntityType<?> blockEntityType, ResourceLocation resourceLocation, long l) {
        return SetContainerLootTable.simpleBuilder(lootItemConditions -> new SetContainerLootTable((LootItemCondition[])lootItemConditions, resourceLocation, l, blockEntityType));
    }
    ...
    extends LootItemConditionalFunction.Serializer<SetContainerLootTable> {
        ...
        public SetContainerLootTable deserialize(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootItemCondition[] lootItemConditions) {
            ...
            BlockEntityType<?> blockEntityType = BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(resourceLocation2).orElseThrow(() -> new JsonSyntaxException("Unknown block entity type id '" + resourceLocation2 + "'"));
