...
extends LootItemConditionalFunction {
    ...
    extends LootItemConditionalFunction.Serializer<SetContainerLootTable> {
        ...
        public SetContainerLootTable deserialize(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootItemCondition[] lootItemConditions) {
            ...
            BlockEntityType<?> blockEntityType = Registry.BLOCK_ENTITY_TYPE.getOptional(resourceLocation2).orElseThrow(() -> new JsonSyntaxException("Unknown block entity type id '" + resourceLocation2 + "'"));
