...
public class OldChunkStorage {
    ...
    public static void convertToAnvilFormat(RegistryAccess.RegistryHolder registryHolder, OldLevelChunk oldLevelChunk, CompoundTag compoundTag, BiomeSource biomeSource) {
        ...
        compoundTag.putIntArray("Biomes", new ChunkBiomeContainer(registryHolder.registryOrThrow(Registry.BIOME_REGISTRY), OLD_LEVEL_HEIGHT, new ChunkPos(oldLevelChunk.x, oldLevelChunk.z), biomeSource).writeBiomes());
