...
public class LevelType {
    ...
    public static final LevelType CUSTOMIZED = new LevelType(4, "customized", "normal", 0, ChunkGeneratorProvider::createNormal).setCustomOptions(true).setSelectableByUser(false);
    ...
    private LevelType(int i, String string, String string2, int j, BiFunction<LevelType, Dynamic<?>, ChunkGeneratorProvider> biFunction) {
        ...
        this.version = j;
        this.provider = dynamic -> (ChunkGeneratorProvider)biFunction.apply(this, (Dynamic<?>)dynamic);
        this.defaultProvider = new LazyLoadedValue<ChunkGeneratorProvider>(() -> (ChunkGeneratorProvider)biFunction.apply(this, EMPTY_SETTINGS));
    ...
    public ChunkGeneratorProvider createProvider(Dynamic<?> dynamic) {
        return this.provider.apply(dynamic);
    }
