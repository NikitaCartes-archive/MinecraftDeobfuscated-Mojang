...
public final class ForestFlowerBiome
extends Biome {
    public ForestFlowerBiome() {
        ...
        this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ForestFlowerBiome.makeComposite(Feature.FOREST_FLOWER, FeatureConfiguration.NONE, FeatureDecorator.COUNT_HEIGHTMAP_32, new DecoratorFrequency(100)));
