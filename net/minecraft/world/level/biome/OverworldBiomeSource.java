...
extends BiomeSource {
    public static final Codec<OverworldBiomeSource> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.LONG.fieldOf("seed")).stable().forGetter(overworldBiomeSource -> overworldBiomeSource.seed), Codec.BOOL.optionalFieldOf("legacy_biome_init_layer", false, Lifecycle.stable()).forGetter(overworldBiomeSource -> overworldBiomeSource.legacyBiomeInitLayer), ((MapCodec)Codec.BOOL.fieldOf("large_biomes")).orElse(false).stable().forGetter(overworldBiomeSource -> overworldBiomeSource.largeBiomes), RegistryLookupCodec.create(Registry.BIOME_REGISTRY).forGetter(overworldBiomeSource -> overworldBiomeSource.biomes)).apply((Applicative<OverworldBiomeSource, ?>)instance, instance.stable(OverworldBiomeSource::new)));
