...
public class BiomeDefaultFeatures {
    ...
    public static final SmallTreeConfiguration JUNGLE_TREE_CONFIG = new SmallTreeConfiguration.SmallTreeConfigurationBuilder(new SimpleStateProvider(JUNGLE_LOG), new SimpleStateProvider(JUNGLE_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(8).foliageHeight(3).decorators(ImmutableList.of(new CocoaDecorator(0.2f), new TrunkVineDecorator(), new LeaveVineDecorator())).ignoreVines().build();
    public static final SmallTreeConfiguration JUNGLE_TREE_NOVINE_CONFIG = new SmallTreeConfiguration.SmallTreeConfigurationBuilder(new SimpleStateProvider(JUNGLE_LOG), new SimpleStateProvider(JUNGLE_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(8).foliageHeight(3).ignoreVines().build();
    ...
    public static final SmallTreeConfiguration FANCY_TREE_WITH_BEES_0002_CONFIG = new SmallTreeConfiguration.SmallTreeConfigurationBuilder(new SimpleStateProvider(OAK_LOG), new SimpleStateProvider(OAK_LEAVES), new BlobFoliagePlacer(0, 0)).decorators(ImmutableList.of(new BeehiveDecorator(0.002f))).build();
    ...
    public static final SmallTreeConfiguration NORMAL_TREE_WITH_BEES_002_CONFIG = new SmallTreeConfiguration.SmallTreeConfigurationBuilder(new SimpleStateProvider(OAK_LOG), new SimpleStateProvider(OAK_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(2).foliageHeight(3).ignoreVines().decorators(ImmutableList.of(new BeehiveDecorator(0.02f))).build();
    public static final SmallTreeConfiguration FANCY_TREE_WITH_BEES_002_CONFIG = new SmallTreeConfiguration.SmallTreeConfigurationBuilder(new SimpleStateProvider(OAK_LOG), new SimpleStateProvider(OAK_LEAVES), new BlobFoliagePlacer(0, 0)).decorators(ImmutableList.of(new BeehiveDecorator(0.02f))).build();
    ...
    public static final RandomPatchConfiguration FIRE_CONFIG = new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(FIRE), new SimpleBlockPlacer()).tries(64).whitelist(ImmutableSet.of(NETHERRACK.getBlock())).noProjection().build();
    ...
    public static final BlockPileConfiguration CRIMSON_FOREST_CONFIG = new BlockPileConfiguration(new WeightedStateProvider().add(Blocks.CRIMSON_ROOTS.defaultBlockState(), 87).add(Blocks.CRIMSON_FUNGI.defaultBlockState(), 11).add(Blocks.WARPED_FUNGI.defaultBlockState(), 2));
    public static final BlockPileConfiguration WARPED_FOREST_CONFIG = new BlockPileConfiguration(new WeightedStateProvider().add(Blocks.WARPED_ROOTS.defaultBlockState(), 85).add(Blocks.CRIMSON_ROOTS.defaultBlockState(), 1).add(Blocks.WARPED_FUNGI.defaultBlockState(), 13).add(Blocks.CRIMSON_FUNGI.defaultBlockState(), 1));
    ...
    public static void addCrimsonForestVegetation(Biome biome) {
        biome.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Feature.HUGE_FUNGI.configured(HUGE_CRIMSON_FUNGI_CONFIG).decorated(FeatureDecorator.COUNT_HEIGHTMAP.configured(new FrequencyDecoratorConfiguration(8))));
    ...
    public static void addWarpedForestVegetation(Biome biome) {
        biome.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Feature.HUGE_FUNGI.configured(HUGE_WARPED_FUNGI_CONFIG).decorated(FeatureDecorator.COUNT_HEIGHTMAP.configured(new FrequencyDecoratorConfiguration(8))));
