...
extends Biome {
    public OceanBiome() {
        ...
        this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, OceanBiome.makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(48, 0.3), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
