...
extends Biome {
    public ColdOceanBiome() {
        ...
        this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ColdOceanBiome.makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(32, 0.3), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
