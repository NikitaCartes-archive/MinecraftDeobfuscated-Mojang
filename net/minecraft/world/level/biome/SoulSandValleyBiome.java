...
extends Biome {
    protected SoulSandValleyBiome() {
        ...
        this.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Feature.NETHER_FOSSIL.configured(FeatureConfiguration.NONE).decorated(FeatureDecorator.NOPE.configured(DecoratorConfiguration.NONE)));
