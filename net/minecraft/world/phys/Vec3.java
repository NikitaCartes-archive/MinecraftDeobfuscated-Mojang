...
public class Vec3
implements Position {
    public static final Codec<Vec3> CODEC = ExtraCodecs.DOUBLE_STREAM.comapFlatMap(doubleStream -> Util.fixedSize(doubleStream, 3).map(ds -> new Vec3(ds[0], ds[1], ds[2])), vec3 -> DoubleStream.of(vec3.x, vec3.y, vec3.z)).stable();
