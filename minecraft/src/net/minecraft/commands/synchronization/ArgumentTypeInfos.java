...
public class ArgumentTypeInfos {
	...
	public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> registry) {
		...
		register(registry, "particle", ParticleArgument.class, SingletonArgumentInfo.contextFree(ParticleArgument::particle));
		...
		register(registry, "mob_effect", MobEffectArgument.class, SingletonArgumentInfo.contextFree(MobEffectArgument::effect));
		...
		register(registry, "item_enchantment", ItemEnchantmentArgument.class, SingletonArgumentInfo.contextFree(ItemEnchantmentArgument::enchantment));
