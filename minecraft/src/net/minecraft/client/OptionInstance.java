...
public final class OptionInstance<T> {
	...
	public static final OptionInstance.Enum<Boolean> BOOLEAN_VALUES = new OptionInstance.Enum(ImmutableList.of((T)Boolean.TRUE, (T)Boolean.FALSE), Codec.BOOL);
	...
	public static OptionInstance<Boolean> createBoolean(
		...
		return new OptionInstance(string, tooltipSupplier, captionBasedToString, BOOLEAN_VALUES, (T)bl, consumer);
	}
	...
	interface CycleableValueSet<T> extends OptionInstance.ValueSet<T> {
		...
		default Function<OptionInstance<T>, AbstractWidget> createButton(
			...
			return optionInstance -> CycleButton.builder(optionInstance.toString)
	...
	public static enum UnitDouble implements OptionInstance.SliderableValueSet<Double> {
		...
		public Codec<Double> codec() {
			return ExtraCodecs.withAlternative(Codec.doubleRange(0.0, 1.0), Codec.BOOL, boolean_ -> boolean_ ? 1.0 : 0.0);
		}
	}
