...
public class ItemBlockRenderTypes {
	private static final Map<Block, RenderType> TYPE_BY_BLOCK = Util.make(Maps.<Block, RenderType>newHashMap(), hashMap -> {
		...
		hashMap.put(Blocks.CHERRY_TRAPDOOR, renderType3);
		...
		hashMap.put(Blocks.BAMBOO_TRAPDOOR, renderType3);
		...
		hashMap.put(Blocks.POTTED_CHERRY_SAPLING, renderType3);
		...
		hashMap.put(Blocks.POTTED_TORCHFLOWER, renderType3);
