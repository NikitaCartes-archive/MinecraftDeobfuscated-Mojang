...
public class BlockModel implements UnbakedModel {
	...
	public void resolveParents(Function<ResourceLocation, UnbakedModel> function) {
		...
		this.overrides.forEach(itemOverride -> {
			UnbakedModel unbakedModelxx = (UnbakedModel)function.apply(itemOverride.getModel());
			if (!Objects.equals(unbakedModelxx, this)) {
				unbakedModelxx.resolveParents(function);
			}
		});
	}
