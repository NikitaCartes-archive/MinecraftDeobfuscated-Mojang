...
public abstract class LivingEntityRenderer<T extends LivingEntity, S extends LivingEntityRenderState, M extends EntityModel<? super S>>
	...
	public void extractRenderState(T livingEntity, S livingEntityRenderState, float f) {
		...
		livingEntityRenderState.headItem = itemStack.copy();
		livingEntityRenderState.headItemModel = this.itemRenderer.resolveItemModel(itemStack, livingEntity, ItemDisplayContext.HEAD);
		livingEntityRenderState.mainArm = livingEntity.getMainArm();
		ItemStack itemStack2 = livingEntity.getItemHeldByArm(HumanoidArm.RIGHT);
		ItemStack itemStack3 = livingEntity.getItemHeldByArm(HumanoidArm.LEFT);
		livingEntityRenderState.rightHandItem = itemStack2.copy();
		livingEntityRenderState.leftHandItem = itemStack3.copy();
		livingEntityRenderState.rightHandItemModel = this.itemRenderer.resolveItemModel(itemStack2, livingEntity, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND);
		livingEntityRenderState.leftHandItemModel = this.itemRenderer.resolveItemModel(itemStack3, livingEntity, ItemDisplayContext.THIRD_PERSON_LEFT_HAND);
