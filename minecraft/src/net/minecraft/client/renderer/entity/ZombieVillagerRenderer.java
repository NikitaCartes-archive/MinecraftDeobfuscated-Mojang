	...
	public ZombieVillagerRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(
			new HumanoidArmorLayer<>(
				this,
				new ZombieVillagerModel(context.getLayer(ModelLayers.ZOMBIE_VILLAGER_INNER_ARMOR)),
				new ZombieVillagerModel(context.getLayer(ModelLayers.ZOMBIE_VILLAGER_OUTER_ARMOR))
			)
		);
