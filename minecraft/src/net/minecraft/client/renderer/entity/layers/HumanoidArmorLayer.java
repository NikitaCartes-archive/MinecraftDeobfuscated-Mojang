		...
		if (bl instanceof ArmorItem) {
			...
			if (armorItem.getEquipmentSlot() == equipmentSlot) {
				...
				for(ArmorMaterial.Layer layer : armorMaterial.layers()) {
					...
					this.renderModel(poseStack, multiBufferSource, i, humanoidModel, f, g, h, layer.texture(blx));
				}

				ArmorTrim armorTrim = itemStack.get(DataComponents.TRIM);
				if (armorTrim != null) {
					this.renderTrim(armorItem.getMaterial(), poseStack, multiBufferSource, i, armorTrim, humanoidModel, blx);
				}
