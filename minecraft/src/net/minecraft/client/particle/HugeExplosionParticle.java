...
public class HugeExplosionParticle extends TextureSheetParticle {
	...
	private HugeExplosionParticle(Level level, double d, double e, double f, double g, SpriteSet spriteSet) {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType simpleParticleType, Level level, double d, double e, double f, double g, double h, double i) {
			return new HugeExplosionParticle(level, d, e, f, g, this.sprites);
		}
	}
}
