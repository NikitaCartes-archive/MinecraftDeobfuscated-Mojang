...
public class CycleButton<T> extends AbstractButton {
	...
	public static CycleButton.Builder<Boolean> booleanBuilder(Component component, Component component2) {
		return new CycleButton.Builder(boolean_ -> boolean_ ? component : component2).withValues(BOOLEAN_OPTIONS);
	}

	public static CycleButton.Builder<Boolean> onOffBuilder() {
		return new CycleButton.Builder(boolean_ -> boolean_ ? CommonComponents.OPTION_ON : CommonComponents.OPTION_OFF).withValues(BOOLEAN_OPTIONS);
	}

	public static CycleButton.Builder<Boolean> onOffBuilder(boolean bl) {
		return onOffBuilder().withInitialValue((T)bl);
	}
