...
public class ErrorScreen extends Screen {
	...
	public void render(PoseStack poseStack, int i, int j, float f) {
		...
		this.drawCenteredString(poseStack, this.font, this.title, this.width / 2, 90, 16777215);
		this.drawCenteredString(poseStack, this.font, this.message, this.width / 2, 110, 16777215);
