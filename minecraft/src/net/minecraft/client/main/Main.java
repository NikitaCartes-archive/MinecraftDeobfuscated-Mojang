...
public class Main {
	...
	public static void main(String[] strings) {
		...
		OptionSpec<File> optionSpec = optionParser.accepts("jfrProfile").withOptionalArg().ofType(File.class);
		...
		if (optionSet.has(optionSpec)) {
			if (optionSet.hasArgument(optionSpec)) {
				JfrRecording.start(optionSpec.value(optionSet).toPath(), JfrRecording.Environment.CLIENT);
			} else {
