...
public class LayerDefinitions {
	...
	public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
		...
		builder.put(ModelLayers.BERET, BeretModel.createLayer());
		builder.put(ModelLayers.MUSTACHE, MustacheModel.createLayer());
		builder.put(ModelLayers.TAIL, TailModel.createLayer());
		builder.put(ModelLayers.CROWN, CrownModel.createLayer());
