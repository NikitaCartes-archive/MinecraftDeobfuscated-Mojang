...
public class MappedRegistry<T> implements WritableRegistry<T> {
	...
	public Holder.Reference<T> register(ResourceKey<T> resourceKey, T object, RegistrationInfo registrationInfo) {
		...
		if (this.unregisteredIntrusiveHolders != null) {
			reference = (Holder.Reference)this.unregisteredIntrusiveHolders.remove(object);
			if (reference == null) {
			...
			reference = (Holder.Reference)this.byKey.computeIfAbsent(resourceKey, resourceKeyx -> Holder.Reference.createStandAlone(this.holderOwner(), resourceKeyx));
		}
