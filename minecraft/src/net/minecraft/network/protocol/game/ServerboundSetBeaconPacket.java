...
public class ServerboundSetBeaconPacket implements Packet<ServerGamePacketListener> {
	...
	public ServerboundSetBeaconPacket(FriendlyByteBuf friendlyByteBuf) {
		this.primary = friendlyByteBuf.readOptional(friendlyByteBufx -> friendlyByteBufx.readById(Registry.MOB_EFFECT));
		this.secondary = friendlyByteBuf.readOptional(friendlyByteBufx -> friendlyByteBufx.readById(Registry.MOB_EFFECT));
	}

	@Override
	public void write(FriendlyByteBuf friendlyByteBuf) {
		friendlyByteBuf.writeOptional(this.primary, (friendlyByteBufx, mobEffect) -> friendlyByteBufx.writeId(Registry.MOB_EFFECT, mobEffect));
		friendlyByteBuf.writeOptional(this.secondary, (friendlyByteBufx, mobEffect) -> friendlyByteBufx.writeId(Registry.MOB_EFFECT, mobEffect));
	}
