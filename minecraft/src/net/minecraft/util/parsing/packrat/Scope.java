...
public final class Scope {
	...
	public <T> T getOrThrow(Atom<T> atom) {
		return (T)Objects.requireNonNull(this.<T>get(atom));
	}

	public <T> T getOrDefault(Atom<T> atom, T object) {
		return (T)Objects.requireNonNullElse(this.<T>get(atom), object);
	}
	...
	public final <T> T getAnyOrThrow(Atom<T>... atoms) {
		return (T)Objects.requireNonNull(this.<T>getAny(atoms));
	}
