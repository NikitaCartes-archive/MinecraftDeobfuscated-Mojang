...
public class DataFixers {
	...
	private static void addFixers(DataFixerBuilder dataFixerBuilder) {
		...
		Schema schema211 = dataFixerBuilder.addSchema(3818, V3818::new);
		dataFixerBuilder.addFixer(new BeehiveFieldRenameFix(schema211));
		dataFixerBuilder.addFixer(new EmptyItemInHotbarFix(schema211));
		Schema schema212 = dataFixerBuilder.addSchema(3818, 1, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new BannerPatternFormatFix(schema212));
		Schema schema213 = dataFixerBuilder.addSchema(3818, 2, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new TippedArrowPotionToItemFix(schema213));
		Schema schema214 = dataFixerBuilder.addSchema(3818, 3, V3818_3::new);
		dataFixerBuilder.addFixer(new WriteAndReadFix(schema214, "Inject data component types", References.DATA_COMPONENTS));
		Schema schema215 = dataFixerBuilder.addSchema(3818, 4, V3818_4::new);
		dataFixerBuilder.addFixer(new ParticleUnflatteningFix(schema215));
		Schema schema216 = dataFixerBuilder.addSchema(3818, 5, V3818_5::new);
		dataFixerBuilder.addFixer(new ItemStackComponentizationFix(schema216));
		Schema schema217 = dataFixerBuilder.addSchema(3818, 6, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AreaEffectCloudPotionFix(schema217));
		...
		Schema schema219 = dataFixerBuilder.addSchema(3825, V3825::new);
		dataFixerBuilder.addFixer(new ItemStackCustomNameToOverrideComponentFix(schema219));
		dataFixerBuilder.addFixer(new BannerEntityCustomNameToOverrideComponentFix(schema219));
		dataFixerBuilder.addFixer(new TrialSpawnerConfigFix(schema219));
