...
public class DataFixers {
	...
	public static CompletableFuture<?> optimize(Set<TypeReference> set) {
		if (set.isEmpty()) {
			...
			return DATA_FIXER.optimize(set, executor);
		}
	}
	...
	private static void addFixers(DataFixerBuilder dataFixerBuilder) {
		...
		dataFixerBuilder.addFixer(new VillagerSetCanPickUpLootFix(schema2));
		...
		dataFixerBuilder.addFixer(new EntityZombieSplitFix(schema21));
		...
		dataFixerBuilder.addFixer(new VillagerTradeFix(schema44));
		...
		Schema schema206 = dataFixerBuilder.addSchema(3808, 2, V3808_2::new);
		dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema206, "minecraft:trader_llama", "DecorItem", false));
		Schema schema207 = dataFixerBuilder.addSchema(3809, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema207));
		Schema schema208 = dataFixerBuilder.addSchema(3812, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FixWolfHealth(schema208));
		Schema schema209 = dataFixerBuilder.addSchema(3813, SAME_NAMESPACED);
		...
		Schema schema212 = dataFixerBuilder.addSchema(3818, V3818::new);
		dataFixerBuilder.addFixer(new BeehiveFieldRenameFix(schema212));
		dataFixerBuilder.addFixer(new EmptyItemInHotbarFix(schema212));
		Schema schema213 = dataFixerBuilder.addSchema(3818, 1, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new BannerPatternFormatFix(schema213));
		Schema schema214 = dataFixerBuilder.addSchema(3818, 2, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new TippedArrowPotionToItemFix(schema214));
		Schema schema215 = dataFixerBuilder.addSchema(3818, 3, V3818_3::new);
		dataFixerBuilder.addFixer(new WriteAndReadFix(schema215, "Inject data component types", References.DATA_COMPONENTS));
		Schema schema216 = dataFixerBuilder.addSchema(3818, 4, V3818_4::new);
		dataFixerBuilder.addFixer(new ParticleUnflatteningFix(schema216));
		Schema schema217 = dataFixerBuilder.addSchema(3818, 5, V3818_5::new);
		dataFixerBuilder.addFixer(new ItemStackComponentizationFix(schema217));
		Schema schema218 = dataFixerBuilder.addSchema(3818, 6, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AreaEffectCloudPotionFix(schema218));
		Schema schema219 = dataFixerBuilder.addSchema(3820, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new PlayerHeadBlockProfileFix(schema219));
		dataFixerBuilder.addFixer(new LodestoneCompassComponentFix(schema219));
		Schema schema220 = dataFixerBuilder.addSchema(3825, V3825::new);
		dataFixerBuilder.addFixer(new ItemStackCustomNameToOverrideComponentFix(schema220));
		dataFixerBuilder.addFixer(new BannerEntityCustomNameToOverrideComponentFix(schema220));
		dataFixerBuilder.addFixer(new TrialSpawnerConfigFix(schema220));
		dataFixerBuilder.addFixer(new AddNewChoices(schema220, "Added Ominous Item Spawner", References.ENTITY));
		Schema schema221 = dataFixerBuilder.addSchema(3828, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EmptyItemInVillagerTradeFix(schema221));
		Schema schema222 = dataFixerBuilder.addSchema(3833, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new RemoveEmptyItemInBrushableBlockFix(schema222));
		Schema schema223 = dataFixerBuilder.addSchema(3938, V3938::new);
		...
		Schema schema230 = dataFixerBuilder.addSchema(4059, V4059::new);
