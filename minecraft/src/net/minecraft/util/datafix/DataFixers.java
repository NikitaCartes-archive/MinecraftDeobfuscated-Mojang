	...
	private static void addFixers(DataFixerBuilder dataFixerBuilder) {
		...
		dataFixerBuilder.addFixer(
			new CriteriaRenameFix(
				schema162, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> (String)immutableMap4.getOrDefault(string, string)
			)
		);
		...
		Schema schema218 = dataFixerBuilder.addSchema(3822, V3822::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema218, "Added Breeze Rod and Mace", References.ENTITY));
	}
