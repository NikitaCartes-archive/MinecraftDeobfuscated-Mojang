...
public class SharedConstants {
	...
	@Deprecated
	public static final int WORLD_VERSION = 3457;
	@Deprecated
	public static final String SERIES = "main";
	@Deprecated
	public static final String VERSION_STRING = "1.20-pre4";
	@Deprecated
	public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 763;
	@Deprecated
	public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 137;
