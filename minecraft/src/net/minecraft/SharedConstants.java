...
public class SharedConstants {
	...
	@Deprecated
	public static final int WORLD_VERSION = 2855;
	@Deprecated
	public static final String SERIES = "main";
	@Deprecated
	public static final String VERSION_STRING = "1.18-pre8";
	@Deprecated
	public static final String RELEASE_TARGET = "1.18";
	@Deprecated
	public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 757;
	@Deprecated
	public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 56;
