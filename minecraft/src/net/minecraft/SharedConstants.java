...
public class SharedConstants {
	...
	@Deprecated
	public static final int WORLD_VERSION = 3101;
	@Deprecated
	public static final String SERIES = "main";
	@Deprecated
	public static final String VERSION_STRING = "1.19-pre4";
	@Deprecated
	public static final String RELEASE_TARGET = "1.19";
	@Deprecated
	public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 759;
	@Deprecated
	public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 88;
