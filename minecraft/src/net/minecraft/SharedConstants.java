...
public class SharedConstants {
	...
	@Deprecated
	public static final int WORLD_VERSION = 3687;
	@Deprecated
	public static final String SERIES = "main";
	@Deprecated
	public static final String VERSION_STRING = "23w43b";
	@Deprecated
	public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 765;
	@Deprecated
	public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 160;
	...
	@Deprecated
	public static final int DATA_PACK_FORMAT = 22;
	@Deprecated
