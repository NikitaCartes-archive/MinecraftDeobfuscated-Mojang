...
public class AnvilMenu extends ItemCombinerMenu {
	...
	public void createResult() {
		...
		if (!itemStack.isEmpty() && EnchantmentHelper.canStoreEnchantments(itemStack)) {
			...
			l += (long)((Integer)itemStack.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue()
				+ (long)((Integer)itemStack3.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue();
			...
			if (!itemStack2.isEmpty()) {
				int k = itemStack2.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0));
				if (k < itemStack3.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))) {
					k = itemStack3.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0));
				}
