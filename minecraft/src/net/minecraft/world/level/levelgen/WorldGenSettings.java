		...
		switch (string5) {
			...
			case "amplified":
				return new WorldGenSettings(
					...
					bl,
					false,
					withOverworld(mappedRegistry, new NoiseBasedChunkGenerator(new OverworldBiomeSource(l, false, false), l, () -> NoiseGeneratorSettings.AMPLIFIED))
				);
			case "largebiomes":
				return new WorldGenSettings(
					l,
					bl,
					false,
					withOverworld(mappedRegistry, new NoiseBasedChunkGenerator(new OverworldBiomeSource(l, false, true), l, () -> NoiseGeneratorSettings.OVERWORLD))
				);
			default:
