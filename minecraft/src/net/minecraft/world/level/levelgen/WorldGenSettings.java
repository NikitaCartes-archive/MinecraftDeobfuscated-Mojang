		...
		switch (string5) {
			...
			case "amplified":
				return new WorldGenSettings(
					...
					false,
					withOverworld(
						mappedRegistry, new NoiseBasedChunkGenerator(new OverworldBiomeSource(l, false, false), l, NoiseGeneratorSettings.Preset.AMPLIFIED.settings())
					)
				);
			case "largebiomes":
				return new WorldGenSettings(
					...
					false,
					withOverworld(
						mappedRegistry, new NoiseBasedChunkGenerator(new OverworldBiomeSource(l, false, true), l, NoiseGeneratorSettings.Preset.OVERWORLD.settings())
					)
				);
			default:
