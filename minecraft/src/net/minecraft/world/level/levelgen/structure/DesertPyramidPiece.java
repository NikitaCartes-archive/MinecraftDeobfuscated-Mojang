...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
	...
	public boolean postProcess(LevelAccessor levelAccessor, Random random, BoundingBox boundingBox, ChunkPos chunkPos) {
		this.generateBox(
			levelAccessor, boundingBox, 0, -4, 0, this.width - 1, 0, this.depth - 1, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		...
		for (int i = 0; i < this.width; i++) {
			for (int j = 0; j < this.depth; j++) {
				int k = -5;
				this.fillColumnDown(levelAccessor, Blocks.SANDSTONE.defaultBlockState(), i, -5, j, boundingBox);
			}
		}
		...
		this.placeBlock(levelAccessor, blockState, 2, 10, 0, boundingBox);
		this.placeBlock(levelAccessor, blockState2, 2, 10, 4, boundingBox);
		this.placeBlock(levelAccessor, blockState3, 0, 10, 2, boundingBox);
		this.placeBlock(levelAccessor, blockState4, 4, 10, 2, boundingBox);
		this.generateBox(
			levelAccessor, boundingBox, this.width - 5, 0, 0, this.width - 1, 9, 4, Blocks.SANDSTONE.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
		);
		this.generateBox(
			levelAccessor, boundingBox, this.width - 4, 10, 1, this.width - 2, 10, 3, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		this.placeBlock(levelAccessor, blockState, this.width - 3, 10, 0, boundingBox);
		this.placeBlock(levelAccessor, blockState2, this.width - 3, 10, 4, boundingBox);
		this.placeBlock(levelAccessor, blockState3, this.width - 5, 10, 2, boundingBox);
		this.placeBlock(levelAccessor, blockState4, this.width - 1, 10, 2, boundingBox);
		...
		this.generateBox(
			levelAccessor, boundingBox, 5, 4, 5, this.width - 6, 4, this.depth - 6, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		...
		this.generateBox(
			levelAccessor, boundingBox, this.width - 5, 1, 5, this.width - 2, 4, 11, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		...
		this.generateBox(
			levelAccessor, boundingBox, this.width - 7, 7, 9, this.width - 7, 7, 11, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		...
		this.generateBox(
			levelAccessor, boundingBox, this.width - 3, 4, 4, this.width - 3, 6, 4, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
		);
		this.placeBlock(levelAccessor, blockState, 2, 4, 5, boundingBox);
		this.placeBlock(levelAccessor, blockState, 2, 3, 4, boundingBox);
		this.placeBlock(levelAccessor, blockState, this.width - 3, 4, 5, boundingBox);
		this.placeBlock(levelAccessor, blockState, this.width - 3, 3, 4, boundingBox);
		...
		this.generateBox(
			levelAccessor, boundingBox, this.width - 3, 1, 3, this.width - 2, 2, 3, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		...
		this.placeBlock(levelAccessor, blockState4, 2, 1, 2, boundingBox);
		this.placeBlock(levelAccessor, blockState3, this.width - 3, 1, 2, boundingBox);
		...
		this.generateBox(
			levelAccessor, boundingBox, this.width - 5, 3, 5, this.width - 5, 3, 17, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
		);
		this.generateBox(levelAccessor, boundingBox, 3, 1, 5, 4, 2, 16, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false);
		this.generateBox(
			levelAccessor, boundingBox, this.width - 6, 1, 5, this.width - 5, 2, 16, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
		);

		for (int l = 5; l <= 17; l += 2) {
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), 4, 1, l, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), 4, 2, l, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), this.width - 5, 1, l, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), this.width - 5, 2, l, boundingBox);
		}
		...
		for (int l = 0; l <= this.width - 1; l += this.width - 1) {
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 2, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 2, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 2, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 3, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 3, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 3, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 4, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), l, 4, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 4, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 5, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 5, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 5, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 6, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), l, 6, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 6, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 7, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 7, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 7, 3, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 8, 1, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 8, 2, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 8, 3, boundingBox);
		}

		for (int l = 2; l <= this.width - 3; l += this.width - 3 - 2) {
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l - 1, 2, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 2, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l + 1, 2, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l - 1, 3, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 3, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l + 1, 3, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l - 1, 4, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), l, 4, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l + 1, 4, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l - 1, 5, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 5, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l + 1, 5, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l - 1, 6, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CHISELED_SANDSTONE.defaultBlockState(), l, 6, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l + 1, 6, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l - 1, 7, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l, 7, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.ORANGE_TERRACOTTA.defaultBlockState(), l + 1, 7, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l - 1, 8, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l, 8, 0, boundingBox);
			this.placeBlock(levelAccessor, Blocks.CUT_SANDSTONE.defaultBlockState(), l + 1, 8, 0, boundingBox);
		}
		...
		this.generateBox(
			levelAccessor, boundingBox, 8, -14, 8, 12, -11, 12, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
		);
		this.generateBox(
			levelAccessor, boundingBox, 8, -10, 8, 12, -10, 12, Blocks.CHISELED_SANDSTONE.defaultBlockState(), Blocks.CHISELED_SANDSTONE.defaultBlockState(), false
		);
		...
		for (Direction direction : Direction.Plane.HORIZONTAL) {
			if (!this.hasPlacedChest[direction.get2DDataValue()]) {
				...
				this.hasPlacedChest[direction.get2DDataValue()] = this.createChest(
					levelAccessor, boundingBox, random, 10 + m, -11, 10 + n, BuiltInLootTables.DESERT_PYRAMID
				);
			}
		}
