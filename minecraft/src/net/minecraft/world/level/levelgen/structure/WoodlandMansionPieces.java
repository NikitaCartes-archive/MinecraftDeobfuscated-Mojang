...
public class WoodlandMansionPieces {
	public static void generateMansion(
		StructureManager structureManager, BlockPos blockPos, Rotation rotation, List<WoodlandMansionPieces.WoodlandMansionPiece> list, Random random
	) {
		WoodlandMansionPieces.MansionGrid mansionGrid = new WoodlandMansionPieces.MansionGrid(random);
		WoodlandMansionPieces.MansionPiecePlacer mansionPiecePlacer = new WoodlandMansionPieces.MansionPiecePlacer(structureManager, random);
	...
	static class MansionPiecePlacer {
					...
					for (int n = 0; n < simpleGrid4.width; n++) {
						if (simpleGrid4.get(n, m) == 1) {
							...
							if (simpleGrid4.get(n, m - 1) == 1 || (simpleGrid3.get(n, m - 1) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, "carpet_north", blockPos3.relative(rotation.rotate(Direction.EAST), 1).above(), rotation
									)
								);
							}
							...
							if (simpleGrid4.get(n, m + 1) == 1 || (simpleGrid3.get(n, m + 1) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, string, blockPos3.relative(rotation.rotate(Direction.SOUTH), 5).relative(rotation.rotate(Direction.WEST), 1), rotation
									)
								);
							}
							...
							if (simpleGrid4.get(n - 1, m) == 1 || (simpleGrid3.get(n - 1, m) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, string2, blockPos3.relative(rotation.rotate(Direction.WEST), 1).relative(rotation.rotate(Direction.NORTH), 1), rotation
									)
								);
							}
						}
					...
					for (int p = 0; p < simpleGrid4.width; p++) {
						...
						if (simpleGrid4.get(p, o) == 2 || bl2) {
							...
							if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid4, p - 1, o) && !mansionGrid.isRoomId(simpleGrid4, p - 1, o, lx, s)) {
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction2 == Direction.WEST ? string4 : string3, blockPos4, rotation));
							}

							if (simpleGrid4.get(p + 1, o) == 1 && !bl2) {
								BlockPos blockPos5 = blockPos4.relative(rotation.rotate(Direction.EAST), 8);
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction2 == Direction.EAST ? string4 : string3, blockPos5, rotation));
							}
							...
							if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid4, p, o + 1) && !mansionGrid.isRoomId(simpleGrid4, p, o + 1, lx, s)) {
								...
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, direction2 == Direction.SOUTH ? string4 : string3, blockPos5, rotation.getRotated(Rotation.CLOCKWISE_90)
									)
								);
							}
							...
							if (simpleGrid4.get(p, o - 1) == 1 && !bl2) {
								...
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, direction2 == Direction.NORTH ? string4 : string3, blockPos5, rotation.getRotated(Rotation.CLOCKWISE_90)
									)
								);
							}
			...
			for (int i = 0; i < simpleGrid.height; i++) {
				for (int j = 0; j < simpleGrid.width; j++) {
					...
					if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i) && !bl) {
						list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof", blockPos2.above(3), rotation));
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i)) {
							...
							list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)));
						}
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i - 1)) {
							...
							list.add(
								new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
							);
						}
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
							...
							list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90)));
						}
					}
				}
			}
					...
					for (int jx = 0; jx < simpleGrid.width; jx++) {
						...
						if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i) && bl) {
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx + 1, i)) {
								...
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockPos3, rotation));
							}

							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx - 1, i)) {
								BlockPos blockPos3 = var17.relative(rotation.rotate(Direction.WEST), 1);
								blockPos3 = blockPos3.relative(rotation.rotate(Direction.SOUTH), 6);
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)));
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i - 1)) {
								...
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
								);
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i + 1)) {
								...
								blockPos3 = blockPos3.relative(rotation.rotate(Direction.SOUTH), 7);
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90)));
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx + 1, i)) {
								if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i - 1)) {
									...
									list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockPos3, rotation));
								}
								...
								if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i + 1)) {
									...
									blockPos3 = blockPos3.relative(rotation.rotate(Direction.SOUTH), 7);
									list.add(
										new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90))
									);
								}
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx - 1, i)) {
								if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i - 1)) {
									...
									list.add(
										new WoodlandMansionPieces.WoodlandMansionPiece(
											this.structureManager, "small_wall_corner", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
										)
									);
								}
								...
								if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jx, i + 1)) {
									...
									list.add(
										new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180))
									);
								}
							}
						}
					...
					if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx, i) && !bl) {
						if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx + 1, i)) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx, i + 1)) {
								...
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockPos4, rotation));
								...
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockPos4, rotation));
							}

							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx, i - 1)) {
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
								);
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx + 1, i - 1)) {
								...
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_90))
								);
							}
						}
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx - 1, i)) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx, i + 1)) {
								...
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_90)));
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx - 1, i + 1)) {
								...
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureManager, "roof_inner_corner", blockPos4, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
									)
								);
							}

							if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx, i - 1)) {
								list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockPos3x, rotation.getRotated(Rotation.CLOCKWISE_180)));
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, jxx - 1, i - 1)) {
								BlockPos blockPos4 = blockPos3x.relative(rotation.rotate(Direction.SOUTH), 1);
								list.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_180))
								);
							}
						}
					}
		...
		private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> list, WoodlandMansionPieces.PlacementData placementData) {
			...
			list.add(
				new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "entrance", placementData.position.relative(direction, 9), placementData.rotation)
			);
		...
		private void traverseWallPiece(List<WoodlandMansionPieces.WoodlandMansionPiece> list, WoodlandMansionPieces.PlacementData placementData) {
			list.add(
				new WoodlandMansionPieces.WoodlandMansionPiece(
					this.structureManager, placementData.wallType, placementData.position.relative(placementData.rotation.rotate(Direction.EAST), 7), placementData.rotation
				)
			);
		...
		private void addRoom1x1(
			...
			list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, string, blockPos3, rotation2));
		}
		...
		private void addRoom1x2(
			...
			if (direction2 == Direction.EAST && direction == Direction.SOUTH) {
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation, Mirror.LEFT_RIGHT
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_180)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation, Mirror.FRONT_BACK
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, floorRoomCollection.get1x2FrontEntrance(this.random, bl), blockPos2, rotation)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2FrontEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_180)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2FrontEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2FrontEntrance(this.random, bl), blockPos2, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureManager, floorRoomCollection.get1x2Secret(this.random), blockPos2, rotation.getRotated(Rotation.CLOCKWISE_90)
					)
				);
			} else if (direction2 == Direction.UP && direction == Direction.SOUTH) {
				BlockPos blockPos2 = blockPos.relative(rotation.rotate(Direction.EAST), 1);
				blockPos2 = blockPos2.relative(rotation.rotate(Direction.NORTH), 0);
				list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, floorRoomCollection.get1x2Secret(this.random), blockPos2, rotation));
			}
		}
		...
		private void addRoom2x2(
			...
			list.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, floorRoomCollection.get2x2(this.random), blockPos2, rotation2, mirror));
		}
		...
		private void addRoom2x2Secret(
			...
			BlockPos blockPos2 = blockPos.relative(rotation.rotate(Direction.EAST), 1);
			list.add(
				new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, floorRoomCollection.get2x2Secret(this.random), blockPos2, rotation, Mirror.NONE)
			);
		}
	}
	...
	public static class WoodlandMansionPiece extends TemplateStructurePiece {
		...
		public WoodlandMansionPiece(StructureManager structureManager, String string, BlockPos blockPos, Rotation rotation, Mirror mirror) {
			super(StructurePieceType.WOODLAND_MANSION_PIECE, 0, structureManager, makeLocation(string), string, makeSettings(mirror, rotation), blockPos);
		}
