...
public class SetFireworksFunction extends LootItemConditionalFunction {
		...
		instance -> commonFields(instance)
				.and(
					instance.group(
						...
						ListOperation.Type.OPERATION_MAP_CODEC.forGetter(setFireworksFunction -> setFireworksFunction.explosionsOperation),
	...
	private Fireworks apply(Fireworks fireworks) {
		...
		return new Fireworks(this.flightDuration.orElseGet(fireworks::flightDuration), list);
	}
