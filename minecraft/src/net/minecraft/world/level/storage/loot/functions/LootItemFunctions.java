...
public class LootItemFunctions {
	...
	private static LootItemFunctionType register(String string, MapCodec<? extends LootItemFunction> mapCodec) {
	...
	public static BiFunction<ItemStack, LootContext, ItemStack> compose(List<? extends BiFunction<ItemStack, LootContext, ItemStack>> list) {
		...
		return switch(list2.size()) {
			...
			case 2 -> {
				BiFunction<ItemStack, LootContext, ItemStack> biFunction = (BiFunction)list2.get(0);
				BiFunction<ItemStack, LootContext, ItemStack> biFunction2 = (BiFunction)list2.get(1);
			...
			for(BiFunction<ItemStack, LootContext, ItemStack> biFunctionxx : list2) {
				itemStack = (ItemStack)biFunctionxx.apply(itemStack, lootContext);
			}
