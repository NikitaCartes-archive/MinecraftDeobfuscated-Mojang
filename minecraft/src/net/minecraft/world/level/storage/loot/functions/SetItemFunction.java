...
public class SetItemFunction extends LootItemConditionalFunction {
	public static final MapCodec<SetItemFunction> CODEC = RecordCodecBuilder.mapCodec(
		instance -> commonFields(instance)
				.and(RegistryFixedCodec.create(Registries.ITEM).fieldOf("item").forGetter(setItemFunction -> setItemFunction.item))
	...
	public ItemStack run(ItemStack itemStack, LootContext lootContext) {
		return itemStack.transmuteCopy(this.item.value(), itemStack.getCount());
	}
}
