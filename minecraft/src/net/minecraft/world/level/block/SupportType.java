...
public enum SupportType {
	...
	CENTER {
		...
		private static final List<TagKey<Block>> OVERRIDE_TO_SUPPORT = Lists.<TagKey<Block>>newArrayList(
			BlockTags.CEILING_HANGING_SIGNS, BlockTags.WALL_HANGING_SIGNS
		);
