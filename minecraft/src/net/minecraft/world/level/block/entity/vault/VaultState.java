...
public enum VaultState implements StringRepresentable {
	...
	public VaultState tickAndGetNext(
		...
		switch(this) {
			case INACTIVE:
				var10000 = updateStateForConnectedPlayers(serverLevel, blockPos, vaultConfig, vaultServerData, vaultSharedData, vaultConfig.activationRange());
				break;
			case ACTIVE:
				var10000 = updateStateForConnectedPlayers(serverLevel, blockPos, vaultConfig, vaultServerData, vaultSharedData, vaultConfig.deactivationRange());
				break;
			case UNLOCKING:
