...
public class SculkSensorBlockEntity extends BlockEntity implements VibrationListener.VibrationListenerConfig {
	...
	public SculkSensorBlockEntity(BlockPos blockPos, BlockState blockState) {
		...
		this.listener = new VibrationListener(
			new BlockPositionSource(this.worldPosition), ((SculkSensorBlock)blockState.getBlock()).getListenerRange(), this, null, 0, 0
		);
	}
	...
	public void onSignalReceive(
		...
		if (SculkSensorBlock.canActivate(blockState)) {
			...
			SculkSensorBlock.activate(entity, serverLevel, this.worldPosition, blockState, getRedstoneStrengthForDistance(i, gameEventListener.getListenerRadius()));
		}
	}
