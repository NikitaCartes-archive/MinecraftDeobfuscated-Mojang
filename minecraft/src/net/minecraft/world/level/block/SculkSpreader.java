...
public class SculkSpreader {
	...
	public void load(CompoundTag compoundTag) {
		if (compoundTag.contains("cursors", 9)) {
			this.cursors.clear();
			List<SculkSpreader.ChargeCursor> list = (List)SculkSpreader.ChargeCursor.CODEC
				.listOf()
	...
	public static class ChargeCursor {
		...
		private static SculkBehaviour getBlockBehaviour(BlockState blockState) {
			...
			return var2 instanceof SculkBehaviour sculkBehaviour ? sculkBehaviour : SculkBehaviour.DEFAULT;
		}
