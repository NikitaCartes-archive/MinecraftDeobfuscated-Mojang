			...
			Feature.RANDOM_SELECTOR
				.configured(
					new RandomFeatureConfiguration(
						ImmutableList.of(
							Feature.TREE.configured(BiomeDefaultFeatures.BIRCH_TREE_WITH_BEES_002_CONFIG).weighted(0.2F),
							Feature.TREE.configured(BiomeDefaultFeatures.FANCY_TREE_WITH_BEES_002_CONFIG).weighted(0.1F)
						),
