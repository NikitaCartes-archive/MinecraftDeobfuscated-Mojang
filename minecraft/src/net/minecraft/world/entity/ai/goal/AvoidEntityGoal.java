...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
	...
	public AvoidEntityGoal(
		...
		this.avoidEntityTargeting = new TargetingConditions().range((double)f).selector(predicate2.and(predicate));
	}
	...
	public boolean canUse() {
		...
		if (this.toAvoid == null) {
			...
			Vec3 vec3 = RandomPos.getPosAvoid(this.mob, 16, 7, new Vec3(this.toAvoid.x, this.toAvoid.y, this.toAvoid.z));
			if (vec3 == null) {
				return false;
