...
public class Breeze extends Monster {
	...
	public boolean withinOuterCircleRange(Vec3 vec3) {
		Vec3 vec32 = this.blockPosition().getCenter();
		return vec3.closerThan(vec32, 20.0, 10.0) && !vec3.closerThan(vec32, 8.0, 10.0);
	}

	public boolean withinMiddleCircleRange(Vec3 vec3) {
		Vec3 vec32 = this.blockPosition().getCenter();
		return vec3.closerThan(vec32, 8.0, 10.0) && !vec3.closerThan(vec32, 4.0, 10.0);
	}
