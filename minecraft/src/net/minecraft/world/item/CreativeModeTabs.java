...
public class CreativeModeTabs {
	...
	private static final CreativeModeTab INGREDIENTS = CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3)
		...
		.displayItems((itemDisplayParameters, output) -> {
			...
			output.accept(Items.ANGLER_POTTERY_SHARD);
			output.accept(Items.ARCHER_POTTERY_SHARD);
			output.accept(Items.ARMS_UP_POTTERY_SHARD);
			output.accept(Items.BLADE_POTTERY_SHARD);
			output.accept(Items.BREWER_POTTERY_SHARD);
			output.accept(Items.BURN_POTTERY_SHARD);
			output.accept(Items.DANGER_POTTERY_SHARD);
			output.accept(Items.EXPLORER_POTTERY_SHARD);
			output.accept(Items.FRIEND_POTTERY_SHARD);
			output.accept(Items.HEART_POTTERY_SHARD);
			output.accept(Items.HEARTBREAK_POTTERY_SHARD);
			output.accept(Items.HOWL_POTTERY_SHARD);
			output.accept(Items.MINER_POTTERY_SHARD);
			output.accept(Items.MOURNER_POTTERY_SHARD);
			output.accept(Items.PLENTY_POTTERY_SHARD);
			output.accept(Items.PRIZE_POTTERY_SHARD);
			output.accept(Items.SHEAF_POTTERY_SHARD);
			output.accept(Items.SHELTER_POTTERY_SHARD);
			output.accept(Items.SKULL_POTTERY_SHARD);
			output.accept(Items.SNORT_POTTERY_SHARD);
	...
	private static List<CreativeModeTab> checkTabs(CreativeModeTab... creativeModeTabs) {
		...
		return List.of(creativeModeTabs);
	}
	...
	private static void generateEnchantmentBookTypesOnlyMaxLevel(
		CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, Set<EnchantmentCategory> set, CreativeModeTab.TabVisibility tabVisibility
	) {
		holderLookup.listElements()
			.map(Holder::value)
			.filter(enchantment -> set.contains(enchantment.category))
