...
public final class BundleContents implements TooltipComponent {
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			return this.weight == bundleContents.weight && ItemStack.listMatches(this.items, bundleContents.items);
		}
	}
	...
	public static class Mutable {
		...
		public int tryInsert(ItemStack itemStack) {
			if (!itemStack.isEmpty() && itemStack.getItem().canFitInsideContainerItems()) {
				...
				if (i == 0) {
					...
					this.weight += BundleContents.getWeight(itemStack) * i;
		...
		public ItemStack removeOne() {
			if (this.items.isEmpty()) {
				...
				this.weight -= BundleContents.getWeight(itemStack) * itemStack.getCount();
				return itemStack;
			}
		}
