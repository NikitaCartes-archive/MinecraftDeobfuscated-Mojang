...
public interface Condition extends Supplier<JsonElement> {
	...
	public static enum Operation {
		...
		private Operation(final String string2) {
			this.id = string2;
		}
	}
	...
	public static class TerminalCondition implements Condition {
		...
		@SafeVarargs
		public final <T extends Comparable<T>> Condition.TerminalCondition negatedTerm(Property<T> property, T comparable, T... comparables) {
			this.putValue(property, "!" + getTerm(property, comparable, comparables));
			return this;
		}
