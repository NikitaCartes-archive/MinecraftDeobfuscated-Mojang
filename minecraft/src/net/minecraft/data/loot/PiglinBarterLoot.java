			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.IRON_NUGGET).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(10.0F, 36.0F))))
						.add(LootItem.lootTableItem(Items.ENDER_PEARL).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F))))
						...
						.add(LootItem.lootTableItem(Items.NETHER_BRICK).setWeight(40).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 8.0F))))
						.add(LootItem.lootTableItem(Items.SPECTRAL_ARROW).setWeight(40).apply(SetItemCountFunction.setCount(RandomValueBounds.between(6.0F, 12.0F))))
						...
						.add(LootItem.lootTableItem(Items.BLACKSTONE).setWeight(40).apply(SetItemCountFunction.setCount(RandomValueBounds.between(8.0F, 16.0F))))
				)
		);
	}
}
