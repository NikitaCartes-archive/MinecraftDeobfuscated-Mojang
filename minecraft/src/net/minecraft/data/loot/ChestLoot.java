			...
			LootTable.lootTable()
				...
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.SPECTRAL_ARROW).apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 18.0F))))
						.add(LootItem.lootTableItem(Blocks.GILDED_BLACKSTONE).apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 10.0F))))
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantIntValue.exactly(1))
						.add(
							LootItem.lootTableItem(Items.NETHERITE_SHOVEL)
								.setWeight(10)
						...
						.add(LootItem.lootTableItem(Items.ANCIENT_DEBRIS).setWeight(10).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Items.SADDLE).setWeight(15).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Blocks.GOLD_BLOCK).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F))))
						.add(
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.ANCIENT_DEBRIS).setWeight(5).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Items.NETHERITE_SCRAP).setWeight(5).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Items.SPECTRAL_ARROW).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 20.0F))))
						.add(LootItem.lootTableItem(Items.PIGLIN_BANNER_PATTERN).setWeight(10).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Items.MUSIC_DISC_PIGSTEP).setWeight(10).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(EmptyLootItem.emptyItem().setWeight(10))
				)
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantIntValue.exactly(2))
						.add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.SOUL_SPEED)))
						.add(
							LootItem.lootTableItem(Items.GOLDEN_BOOTS)
								.apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1)))
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.NETHERITE_SCRAP).setWeight(10).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))
						.add(LootItem.lootTableItem(Blocks.ANCIENT_DEBRIS).setWeight(5).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2))))
						.add(
							LootItem.lootTableItem(Items.NETHERITE_SWORD)
								.setWeight(10)
						...
						.add(
							LootItem.lootTableItem(Items.NETHERITE_HELMET)
								.setWeight(6)
								.apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F)))
								.apply(EnchantRandomlyFunction.randomApplicableEnchantment())
						)
						.add(
							LootItem.lootTableItem(Items.NETHERITE_LEGGINGS)
								.setWeight(6)
								.apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F)))
								.apply(EnchantRandomlyFunction.randomApplicableEnchantment())
						)
						.add(
							LootItem.lootTableItem(Items.NETHERITE_BOOTS)
								.setWeight(6)
								.apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F)))
								.apply(EnchantRandomlyFunction.randomApplicableEnchantment())
						)
						.add(LootItem.lootTableItem(Items.NETHERITE_SWORD).setWeight(6).apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F))))
						.add(LootItem.lootTableItem(Items.NETHERITE_CHESTPLATE).setWeight(5).apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F))))
						.add(LootItem.lootTableItem(Items.NETHERITE_HELMET).setWeight(5).apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F))))
						.add(LootItem.lootTableItem(Items.NETHERITE_BOOTS).setWeight(5).apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F))))
						.add(LootItem.lootTableItem(Items.NETHERITE_LEGGINGS).setWeight(5).apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.2F, 0.65F))))
