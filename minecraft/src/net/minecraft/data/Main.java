...
public class Main {
	...
	public static DataGenerator createStandardGenerator(
		...
		dataGenerator.addProvider(bl2, new BannerPatternTagsProvider(dataGenerator));
		...
		dataGenerator.addProvider(bl2, new InstrumentTagsProvider(dataGenerator));
		dataGenerator.addProvider(bl2, new PaintingVariantTagsProvider(dataGenerator));
		dataGenerator.addProvider(bl2, new PoiTypeTagsProvider(dataGenerator));
