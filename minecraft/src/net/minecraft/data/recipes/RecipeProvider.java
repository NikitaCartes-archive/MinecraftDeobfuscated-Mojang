...
public class RecipeProvider implements DataProvider {
	...
	private static void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapelessRecipeBuilder.shapeless(Items.COPPER_INGOT, 4)
			...
			.save(consumer, getFromName(Items.COPPER_INGOT, Blocks.COPPER_BLOCK));
		ShapelessRecipeBuilder.shapeless(Items.COPPER_INGOT, 4)
			.requires(Blocks.WAXED_COPPER_BLOCK)
			.group(getBlockName(Items.COPPER_INGOT))
			.unlockedBy(getHasName(Blocks.WAXED_COPPER_BLOCK), has(Blocks.WAXED_COPPER_BLOCK))
			.save(consumer, getFromName(Items.COPPER_INGOT, Blocks.WAXED_COPPER_BLOCK));
		...
		ShapelessRecipeBuilder.shapeless(Blocks.MOSSY_COBBLESTONE)
			...
			.save(consumer, getFromName(Blocks.MOSSY_COBBLESTONE, Blocks.VINE));
		ShapelessRecipeBuilder.shapeless(Blocks.MOSSY_STONE_BRICKS)
			...
			.save(consumer, getFromName(Blocks.MOSSY_STONE_BRICKS, Blocks.VINE));
		ShapelessRecipeBuilder.shapeless(Blocks.MOSSY_COBBLESTONE)
			.requires(Blocks.COBBLESTONE)
			.requires(Blocks.MOSS_BLOCK)
			.unlockedBy("has_moss_block", has(Blocks.MOSS_BLOCK))
			.save(consumer, getFromName(Blocks.MOSSY_COBBLESTONE, Blocks.MOSS_BLOCK));
		ShapelessRecipeBuilder.shapeless(Blocks.MOSSY_STONE_BRICKS)
			.requires(Blocks.STONE_BRICKS)
			.requires(Blocks.MOSS_BLOCK)
			.unlockedBy("has_mossy_cobblestone", has(Blocks.MOSSY_COBBLESTONE))
			.save(consumer, getFromName(Blocks.MOSSY_STONE_BRICKS, Blocks.MOSS_BLOCK));
		...
		((BiMap)HoneycombItem.WAXABLES.get())
			.forEach(
				(block, block2) -> ShapelessRecipeBuilder.shapeless(block2)
						...
						.save(consumer, getFromName(block2, Items.HONEYCOMB))
			);
	}
