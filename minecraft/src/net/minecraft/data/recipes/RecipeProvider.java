...
public class RecipeProvider implements DataProvider {
	...
	private static final Map<BlockFamily.Variant, BiFunction<ItemLike, ItemLike, RecipeBuilder>> shapeBuilders = ImmutableMap.<BlockFamily.Variant, BiFunction<ItemLike, ItemLike, RecipeBuilder>>builder()
		...
		.put(BlockFamily.Variant.SLAB, (itemLike, itemLike2) -> slabBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.STAIRS, (itemLike, itemLike2) -> stairBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.PRESSURE_PLATE, (itemLike, itemLike2) -> pressurePlateBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.POLISHED, (itemLike, itemLike2) -> polishedBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.TRAPDOOR, (itemLike, itemLike2) -> trapdoorBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.WALL, (itemLike, itemLike2) -> wallBuilder(itemLike, Ingredient.of(itemLike2)))
		.build();
	...
	private static void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		BlockFamilies.getAllFamilies().filter(BlockFamily::shouldGenerateRecipe).forEach(blockFamily -> generateRecipes(consumer, blockFamily));
		...
		chiseledBuilder(Blocks.CHISELED_QUARTZ_BLOCK, Ingredient.of(Blocks.QUARTZ_SLAB))
			...
			.save(consumer);
		chiseledBuilder(Blocks.CHISELED_STONE_BRICKS, Ingredient.of(Blocks.STONE_BRICK_SLAB)).unlockedBy("has_tag", has(ItemTags.STONE_BRICKS)).save(consumer);
		...
		ShapelessRecipeBuilder.shapeless(Items.WAXED_WEATHERED_CUT_COPPER)
			...
			.save(consumer, "waxed_weathered_cut_copper_from_honeycomb");
		ShapelessRecipeBuilder.shapeless(Items.WAXED_EXPOSED_CUT_COPPER)
			...
			.save(consumer, "waxed_exposed_cut_copper_from_honeycomb");
		...
		ShapelessRecipeBuilder.shapeless(Items.WAXED_WEATHERED_CUT_COPPER_STAIRS)
			...
			.save(consumer, "waxed_weathered_cut_copper_stairs_from_honeycomb");
		ShapelessRecipeBuilder.shapeless(Items.WAXED_EXPOSED_CUT_COPPER_STAIRS)
			...
			.save(consumer, "waxed_exposed_cut_copper_stairs_from_honeycomb");
		...
		ShapelessRecipeBuilder.shapeless(Items.WAXED_WEATHERED_CUT_COPPER_SLAB)
			...
			.save(consumer, "waxed_weathered_cut_copper_slab_from_honeycomb");
		ShapelessRecipeBuilder.shapeless(Items.WAXED_EXPOSED_CUT_COPPER_SLAB)
			...
			.save(consumer, "waxed_exposed_cut_copper_slab_from_honeycomb");
		...
		stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER, Blocks.EXPOSED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER_STAIRS, Blocks.EXPOSED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.EXPOSED_CUT_COPPER_SLAB, Blocks.EXPOSED_COPPER, 2);
		stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER, Blocks.WEATHERED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER_STAIRS, Blocks.WEATHERED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.WEATHERED_CUT_COPPER_SLAB, Blocks.WEATHERED_COPPER, 2);
		stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER, Blocks.OXIDIZED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER_STAIRS, Blocks.OXIDIZED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.OXIDIZED_CUT_COPPER_SLAB, Blocks.OXIDIZED_COPPER, 2);
		stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER, Blocks.WAXED_COPPER_BLOCK);
		stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER_STAIRS, Blocks.WAXED_COPPER_BLOCK);
		stonecutterResultFromBase(consumer, Blocks.WAXED_CUT_COPPER_SLAB, Blocks.WAXED_COPPER_BLOCK, 2);
		stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER, Blocks.WAXED_EXPOSED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS, Blocks.WAXED_EXPOSED_COPPER);
		stonecutterResultFromBase(consumer, Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, Blocks.WAXED_EXPOSED_COPPER, 2);
		...
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_SLAB, Blocks.GRIMSTONE, 2);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_STAIRS, Blocks.GRIMSTONE);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_WALL, Blocks.GRIMSTONE);
		stonecutterResultFromBase(consumer, Blocks.CHISELED_GRIMSTONE, Blocks.GRIMSTONE);
		stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_SLAB, Blocks.POLISHED_GRIMSTONE, 2);
		stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_STAIRS, Blocks.POLISHED_GRIMSTONE);
		stonecutterResultFromBase(consumer, Blocks.POLISHED_GRIMSTONE_WALL, Blocks.POLISHED_GRIMSTONE);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_SLAB, Blocks.GRIMSTONE_TILES, 2);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_STAIRS, Blocks.GRIMSTONE_TILES);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_TILE_WALL, Blocks.GRIMSTONE_TILES);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_SLAB, Blocks.GRIMSTONE_BRICKS, 2);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_STAIRS, Blocks.GRIMSTONE_BRICKS);
		stonecutterResultFromBase(consumer, Blocks.GRIMSTONE_BRICK_WALL, Blocks.GRIMSTONE_BRICKS);
	...
	public static RecipeBuilder wallBuilder(ItemLike itemLike, Ingredient ingredient) {
		return ShapedRecipeBuilder.shaped(itemLike, 6).define('#', ingredient).pattern("###").pattern("###");
	}
	...
	public static RecipeBuilder polishedBuilder(ItemLike itemLike, Ingredient ingredient) {
		return ShapedRecipeBuilder.shaped(itemLike, 4).define('S', ingredient).pattern("SS").pattern("SS");
	}
	...
	public static void chiseled(Consumer<FinishedRecipe> consumer, ItemLike itemLike, ItemLike itemLike2) {
		chiseledBuilder(itemLike, Ingredient.of(itemLike2)).unlockedBy(getHasName(itemLike2), has(itemLike2)).save(consumer);
	}

	public static ShapedRecipeBuilder chiseledBuilder(ItemLike itemLike, Ingredient ingredient) {
		return ShapedRecipeBuilder.shaped(itemLike).define('#', ingredient).pattern("#").pattern("#");
	}
	...
	private static void stonecutterResultFromBase(Consumer<FinishedRecipe> consumer, ItemLike itemLike, ItemLike itemLike2, int i) {
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(itemLike2), itemLike, i)
			.unlocks(getHasName(itemLike2), has(itemLike2))
			.save(consumer, getFromName(itemLike, itemLike2) + "_stonecutting");
	}
	...
	private static void generateRecipes(Consumer<FinishedRecipe> consumer, BlockFamily blockFamily) {
		blockFamily.getShapes().forEach((variant, block) -> {
			BiFunction<ItemLike, ItemLike, RecipeBuilder> biFunction = (BiFunction<ItemLike, ItemLike, RecipeBuilder>)shapeBuilders.get(variant);
			if (biFunction != null) {
	...
	private static Block getBaseBlock(BlockFamily blockFamily, BlockFamily.Variant variant) {
		return variant == BlockFamily.Variant.CHISELED ? blockFamily.get(BlockFamily.Variant.SLAB) : blockFamily.getBaseBlock();
	}
	...
	private static String getHasName(ItemLike itemLike) {
		return "has_" + getBlockName(itemLike);
	}

	private static String getFromName(ItemLike itemLike, ItemLike itemLike2) {
		return getBlockName(itemLike) + "_from_" + getBlockName(itemLike2);
	}
