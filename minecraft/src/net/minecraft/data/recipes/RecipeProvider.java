...
public class RecipeProvider implements DataProvider {
	...
	private static void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		nineBlockStorageRecipesRecipesWithCustomUnpacking(
			consumer, Items.NETHERITE_INGOT, Items.NETHERITE_BLOCK, "netherite_ingot_from_netherite_block", "netherite_ingot"
		);
	...
	private static void oneToOneConversionRecipe(Consumer<FinishedRecipe> consumer, ItemLike itemLike, ItemLike itemLike2, @Nullable String string, int i) {
		ShapelessRecipeBuilder.shapeless(itemLike, i)
			.requires(itemLike2)
			.group(string)
	...
	private static void simpleCookingRecipe(
		Consumer<FinishedRecipe> consumer, String string, SimpleCookingSerializer<?> simpleCookingSerializer, int i, ItemLike itemLike, ItemLike itemLike2, float f
	) {
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(itemLike), itemLike2, f, i, simpleCookingSerializer)
			.unlockedBy(getHasName(itemLike), has(itemLike))
