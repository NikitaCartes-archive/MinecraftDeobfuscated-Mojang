...
public abstract class RecipeProvider implements DataProvider {
	...
	private static final Map<BlockFamily.Variant, BiFunction<ItemLike, ItemLike, RecipeBuilder>> SHAPE_BUILDERS = ImmutableMap.builder()
		.put(BlockFamily.Variant.BUTTON, (BiFunction)(itemLike, itemLike2) -> buttonBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.CHISELED, (BiFunction)(itemLike, itemLike2) -> chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.CUT, (BiFunction)(itemLike, itemLike2) -> cutBuilder(RecipeCategory.BUILDING_BLOCKS, itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.DOOR, (BiFunction)(itemLike, itemLike2) -> doorBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.CUSTOM_FENCE, (BiFunction)(itemLike, itemLike2) -> fenceBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.FENCE, (BiFunction)(itemLike, itemLike2) -> fenceBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.CUSTOM_FENCE_GATE, (BiFunction)(itemLike, itemLike2) -> fenceGateBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.FENCE_GATE, (BiFunction)(itemLike, itemLike2) -> fenceGateBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.SIGN, (BiFunction)(itemLike, itemLike2) -> signBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.SLAB, (BiFunction)(itemLike, itemLike2) -> slabBuilder(RecipeCategory.BUILDING_BLOCKS, itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.STAIRS, (BiFunction)(itemLike, itemLike2) -> stairBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(
			BlockFamily.Variant.PRESSURE_PLATE, (BiFunction)(itemLike, itemLike2) -> pressurePlateBuilder(RecipeCategory.REDSTONE, itemLike, Ingredient.of(itemLike2))
		)
		.put(BlockFamily.Variant.POLISHED, (BiFunction)(itemLike, itemLike2) -> polishedBuilder(RecipeCategory.BUILDING_BLOCKS, itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.TRAPDOOR, (BiFunction)(itemLike, itemLike2) -> trapdoorBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.WALL, (BiFunction)(itemLike, itemLike2) -> wallBuilder(RecipeCategory.DECORATIONS, itemLike, Ingredient.of(itemLike2)))
		.build();
	...
	protected static void grate(RecipeOutput recipeOutput, Block block, Block block2) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, block, 4)
			...
			.pattern("M M")
			.pattern(" M ")
			.unlockedBy(getHasName(block2), has(block2))
			.save(recipeOutput);
	}
			...
			.forEach(
				(variant, block) -> {
					if (block.requiredFeatures().isSubsetOf(featureFlagSet)) {
						BiFunction<ItemLike, ItemLike, RecipeBuilder> biFunction = (BiFunction)SHAPE_BUILDERS.get(variant);
	...
	private static Criterion<InventoryChangeTrigger.TriggerInstance> inventoryTrigger(ItemPredicate.Builder... builders) {
		return inventoryTrigger((ItemPredicate[])Arrays.stream(builders).map(ItemPredicate.Builder::build).toArray(i -> new ItemPredicate[i]));
	}
