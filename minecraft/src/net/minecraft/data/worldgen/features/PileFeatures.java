...
public class PileFeatures {
	...
	public static final ConfiguredFeature<?, ?> PILE_PUMPKIN = FeatureUtils.register(
		"pile_pumpkin",
		Feature.BLOCK_PILE
			.configured(
				new BlockPileConfiguration(
