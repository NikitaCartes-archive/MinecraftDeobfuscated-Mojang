...
public class MiscOverworldFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
		...
		FeatureUtils.register(bootstrapContext, POTATO_CLOUD, Feature.CLOUD, new BlockStateConfiguration(Blocks.FLOATATO.defaultBlockState()));
		...
		FeatureUtils.register(
			...
			new DiskConfiguration(
				...
				BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.TERREDEPOMME, Blocks.PEELGRASS_BLOCK, Blocks.CORRUPTED_PEELGRASS_BLOCK)),
				UniformInt.of(2, 5),
				2
			)
		);
		...
		FeatureUtils.register(bootstrapContext, HASH_WELL, Feature.HASH_WELL);
		FeatureUtils.register(
			bootstrapContext,
