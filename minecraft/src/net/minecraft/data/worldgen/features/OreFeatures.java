...
public class OreFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
		...
		RuleTest ruleTest4 = new BlockMatchTest(Blocks.POTONE);
		RuleTest ruleTest5 = new BlockMatchTest(Blocks.NETHERRACK);
		RuleTest ruleTest6 = new BlockMatchTest(Blocks.POTONE);
		RuleTest ruleTest7 = new TagMatchTest(BlockTags.BASE_STONE_NETHER);
		List<OreConfiguration.TargetBlockState> list = List.of(
			OreConfiguration.target(ruleTest2, Blocks.IRON_ORE.defaultBlockState()),
			OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_IRON_ORE.defaultBlockState()),
			OreConfiguration.target(ruleTest4, Blocks.POTONE_IRON_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list2 = List.of(
			OreConfiguration.target(ruleTest2, Blocks.POISONOUS_POTATO_ORE.defaultBlockState()),
			OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_POISONOUS_POTATO_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list3 = List.of(
			OreConfiguration.target(ruleTest2, Blocks.GOLD_ORE.defaultBlockState()),
			OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_GOLD_ORE.defaultBlockState()),
			OreConfiguration.target(ruleTest4, Blocks.POTONE_GOLD_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list4 = List.of(
			...
			OreConfiguration.target(ruleTest4, Blocks.POTONE_DIAMOND_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list5 = List.of(
			...
			OreConfiguration.target(ruleTest4, Blocks.POTONE_LAPIS_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list6 = List.of(
			...
			OreConfiguration.target(ruleTest4, Blocks.POTONE_COPPER_ORE.defaultBlockState())
		);
		List<OreConfiguration.TargetBlockState> list7 = List.of(
		...
		FeatureUtils.register(bootstrapContext, ORE_MAGMA, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
		FeatureUtils.register(bootstrapContext, ORE_SOUL_SAND, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.SOUL_SAND.defaultBlockState(), 12));
		FeatureUtils.register(bootstrapContext, ORE_NETHER_GOLD, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10));
		FeatureUtils.register(bootstrapContext, ORE_QUARTZ, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
		FeatureUtils.register(bootstrapContext, ORE_GRAVEL_NETHER, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.GRAVEL.defaultBlockState(), 33));
		FeatureUtils.register(bootstrapContext, ORE_BLACKSTONE, Feature.ORE, new OreConfiguration(ruleTest5, Blocks.BLACKSTONE.defaultBlockState(), 33));
		FeatureUtils.register(bootstrapContext, ORE_TATERSTONE, Feature.ORE, new OreConfiguration(ruleTest6, Blocks.TATERSTONE.defaultBlockState(), 33));
		FeatureUtils.register(bootstrapContext, ORE_AMBER, Feature.ORE, new OreConfiguration(ruleTest6, Blocks.RESIN_ORE.defaultBlockState(), 6));
		...
		FeatureUtils.register(bootstrapContext, ORE_GRAVTATER, Feature.ORE, new OreConfiguration(ruleTest, Blocks.GRAVTATER.defaultBlockState(), 33));
		...
		FeatureUtils.register(bootstrapContext, ORE_COAL, Feature.ORE, new OreConfiguration(list7, 17));
		FeatureUtils.register(bootstrapContext, ORE_COAL_BURIED, Feature.ORE, new OreConfiguration(list7, 17, 0.5F));
		...
		FeatureUtils.register(bootstrapContext, ORE_POISONOUS_POTATO, Feature.ORE, new OreConfiguration(list2, 9));
		FeatureUtils.register(bootstrapContext, ORE_GOLD, Feature.ORE, new OreConfiguration(list3, 9));
		FeatureUtils.register(bootstrapContext, ORE_GOLD_BURIED, Feature.ORE, new OreConfiguration(list3, 9, 0.5F));
		FeatureUtils.register(
			...
			new OreConfiguration(
				List.of(
					...
					OreConfiguration.target(ruleTest4, Blocks.POTONE_REDSTONE_ORE.defaultBlockState())
				),
				8
			)
		);
		FeatureUtils.register(bootstrapContext, ORE_DIAMOND_SMALL, Feature.ORE, new OreConfiguration(list4, 4, 0.5F));
		FeatureUtils.register(bootstrapContext, ORE_DIAMOND_LARGE, Feature.ORE, new OreConfiguration(list4, 12, 0.7F));
		FeatureUtils.register(bootstrapContext, ORE_DIAMOND_BURIED, Feature.ORE, new OreConfiguration(list4, 8, 1.0F));
		FeatureUtils.register(bootstrapContext, ORE_DIAMOND_MEDIUM, Feature.ORE, new OreConfiguration(list4, 8, 0.5F));
		FeatureUtils.register(bootstrapContext, ORE_LAPIS, Feature.ORE, new OreConfiguration(list5, 7));
		FeatureUtils.register(bootstrapContext, ORE_LAPIS_BURIED, Feature.ORE, new OreConfiguration(list5, 7, 1.0F));
		FeatureUtils.register(
			bootstrapContext,
			ORE_INFESTED,
			Feature.ORE,
		...
		FeatureUtils.register(
			bootstrapContext, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration(ruleTest7, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F)
		);
		FeatureUtils.register(
			bootstrapContext, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration(ruleTest7, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F)
		);
		FeatureUtils.register(bootstrapContext, ORE_COPPPER_SMALL, Feature.ORE, new OreConfiguration(list6, 10));
		FeatureUtils.register(bootstrapContext, ORE_COPPER_LARGE, Feature.ORE, new OreConfiguration(list6, 20));
