...
public class BiomeDefaultFeatures {
	...
	public static void addDripstone(BiomeGenerationSettings.Builder builder) {
		...
		builder.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, Features.POINTED_DRIPSTONE_FEATURE);
	}
	...
	public static void addFrozenSprings(BiomeGenerationSettings.Builder builder) {
		builder.addFeature(GenerationStep.Decoration.FLUID_SPRINGS, Features.SPRING_LAVA_FROZEN);
	}
