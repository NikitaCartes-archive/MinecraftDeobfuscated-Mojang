...
public class NetherBiomes {
	public static Biome netherWastes(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
	...
	public static Biome soulSandValley(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
		double d = 0.7;
		double e = 0.15;
		MobSpawnSettings mobSpawnSettings = new MobSpawnSettings.Builder()
	...
	public static Biome basaltDeltas(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
		MobSpawnSettings mobSpawnSettings = new MobSpawnSettings.Builder()
	...
	public static Biome crimsonForest(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
		MobSpawnSettings mobSpawnSettings = new MobSpawnSettings.Builder()
	...
	public static Biome warpedForest(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
		MobSpawnSettings mobSpawnSettings = new MobSpawnSettings.Builder()
			.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 1, 4, 4))
			.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.STRIDER, 60, 1, 2))
