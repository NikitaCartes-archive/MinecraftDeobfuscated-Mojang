...
public abstract class DistanceManager {
	...
	private SortedArraySet<Ticket<?>> getTickets(long l) {
		return (SortedArraySet<Ticket<?>>)this.tickets.computeIfAbsent(l, (Long2ObjectFunction)(lx -> SortedArraySet.create(4)));
	}
	...
	public void addPlayer(SectionPos sectionPos, ServerPlayer serverPlayer) {
		...
		long l = chunkPos.toLong();
		this.playersPerChunk.computeIfAbsent(l, (Long2ObjectFunction<? extends ObjectOpenHashSet<ServerPlayer>>)(lx -> new ObjectOpenHashSet())).add(serverPlayer);
	...
	protected String getTicketDebugString(long l) {
		SortedArraySet<Ticket<?>> sortedArraySet = (SortedArraySet)this.tickets.get(l);
	...
	class ChunkTicketTracker extends ChunkTracker {
		...
		protected int getLevelFromSource(long l) {
			SortedArraySet<Ticket<?>> sortedArraySet = (SortedArraySet)DistanceManager.this.tickets.get(l);
