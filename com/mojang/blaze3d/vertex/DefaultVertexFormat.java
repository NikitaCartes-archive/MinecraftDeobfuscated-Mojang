...
public class DefaultVertexFormat {
    ...
    public static final VertexFormat BLOCK = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_COLOR)).add(ELEMENT_UV0)).add(ELEMENT_UV2)).add(ELEMENT_NORMAL)).add(ELEMENT_PADDING)).build());
    public static final VertexFormat NEW_ENTITY = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_COLOR)).add(ELEMENT_UV0)).add(ELEMENT_UV1)).add(ELEMENT_UV2)).add(ELEMENT_NORMAL)).add(ELEMENT_PADDING)).build());
    @Deprecated
    ...
    @Deprecated
    public static final VertexFormat POSITION_TEX_COLOR = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_UV0)).add(ELEMENT_COLOR)).build());
    public static final VertexFormat POSITION_COLOR_TEX_LIGHTMAP = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_COLOR)).add(ELEMENT_UV0)).add(ELEMENT_UV2)).build());
    @Deprecated
    public static final VertexFormat POSITION_TEX_LIGHTMAP_COLOR = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_UV0)).add(ELEMENT_UV2)).add(ELEMENT_COLOR)).build());
    @Deprecated
    public static final VertexFormat POSITION_TEX_COLOR_NORMAL = new VertexFormat((ImmutableList<VertexFormatElement>)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(ELEMENT_POSITION)).add(ELEMENT_UV0)).add(ELEMENT_COLOR)).add(ELEMENT_NORMAL)).add(ELEMENT_PADDING)).build());
}
