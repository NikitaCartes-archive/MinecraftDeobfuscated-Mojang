...
public abstract class RowButton {
    ...
    public static void rowButtonMouseClicked(RealmsObjectSelectionList realmsObjectSelectionList, RealmListEntry realmListEntry, List<RowButton> list, int i, double d, double e) {
        int j;
