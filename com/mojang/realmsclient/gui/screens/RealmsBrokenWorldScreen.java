...
extends RealmsScreen {
    ...
    private void addButtons() {
        for (Map.Entry<Integer, RealmsWorldOptions> entry : this.serverData.slots.entrySet()) {
            ...
            this.addButton(new Button(this.getFramePositionX(i), RealmsBrokenWorldScreen.row(10), 80, 20, new TranslatableComponent("mco.brokenworld.reset"), button -> {
    ...
    private void fetchServerData(long l) {
        new Thread(() -> {
            ...
            try {
                ...
                this.minecraft.setScreen(new RealmsGenericErrorScreen(new TextComponent(realmsServiceException.getMessage()), this.lastScreen));
            }
        }).start();
    }
