...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - j / 2, RealmsParentalConsentScreen.row(11), j, 20, component3, button -> Util.getPlatform().openUri("https://aka.ms/MinecraftGDPR")));
        this.addButton(new Button(this.width / 2 - (i + 5), RealmsParentalConsentScreen.row(13), i, 20, component, button -> Util.getPlatform().openUri("https://aka.ms/UpdateMojangAccount")));
