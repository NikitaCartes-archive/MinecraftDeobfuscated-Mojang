...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addRenderableWidget(Button.builder(CommonComponents.GUI_DONE, button -> this.minecraft.setScreen(new RealmsMainScreen(this.lastScreen))).bounds(this.width / 2 - 50, this.height - 32, 100, 20).build());
    ...
    extends ObjectSelectionList.Entry<Entry> {
        ...
        private void renderPendingInvitationItem(PoseStack poseStack, PendingInvite pendingInvite, int i, int j, int k, int l) {
            ...
            RealmsUtil.renderPlayerFace(poseStack, i, j, 32, pendingInvite.worldOwnerUuid);
        }
