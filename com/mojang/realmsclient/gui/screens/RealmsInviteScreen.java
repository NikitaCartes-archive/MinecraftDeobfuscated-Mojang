...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 100, RealmsInviteScreen.row(10), 200, 20, new TranslatableComponent("mco.configure.world.buttons.invite"), button -> this.onInvite()));
